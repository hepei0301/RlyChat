...
(function(e) {
    ...
    var YTX_WBSS_KERNEL = {
      ...
      _onFilePathListener: function () {
        ...
        releaseRoomResource: function() {
            ...
            // 关闭 WebSocket 连接
            if (YTX_WBSS_KERNEL.websocket_handle_obj !== null) YTX_WBSS_KERNEL.disconnectWebScoketServer(true);
          ...
          console.log('===canvas_html_handle===', YTX_WBSS_KERNEL.canvas_html_handle.width, YTX_WBSS_KERNEL.canvas_html_handle.height);
          console.log('===canvas_context===', canvas_context);
          canvas_context.clearRect(0, 0, YTX_WBSS_KERNEL.canvas_html_handle.width, YTX_WBSS_KERNEL.canvas_html_handle.height);
            // 释放 RoomInfo 资源
            ...
            // 释放 DrawContext
            YTX_WBSS_KERNEL.drawContext.drawToolStatus = YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NONE;
        ...
        _parseCreateRoomResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            ...
            if (respCode == 0) {
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseCreateRoomResp(roomId=" + (roomId == null?"null":roomId) + ")=====");
                ...
                if(roomId != null && roomId > 0){
                    ...
                    if(roleIDs_array != null && authorities_array != null){
                        if(roleIDs_array.length == authorities_array.length && roleIDs_array.length > 0){
                            for(var i = 0; i < roleIDs_array.length; i++){
                                YTX_WBSS_KERNEL._role_authorities_array.push({roleID:roleIDs_array[i], authorities:authorities_array[i]});
                            }
                        }
                    }
                    ...
                    //保存文档信息
                    callbackDocDataArray.push({ "wbssDocId": docId, "wbssDocFileName": doc_name, "wbssDocTotalPage": doc_page_number, "wbssDocURL": doc_url });
                    var currentDocInfo = new YTX_WBSS_KERNEL.DocInfo(docId, doc_name, doc_page_number, doc_url, doc_timestamp);
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "=====_parseCreateRoomResp(respCode=" + respCode + ")=====");
        ...
        _parseJoinRoomResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            ...
            if (respCode == 0) {
                ...
                //进入房间成功
                YTX_WBSS_KERNEL.isLoginInRoomServer = true;
                YTX_WBSS_KERNEL.updateCurrentRoomId_DocId_PageIndex(jsonCurRoomId, jsonCurDocId, jsonCurPageIndex);
                ...
                for (var i in jsonDocDataArray) {
                    ...
                    if (jsonDocId == 0) {
                        ...
                        jsonDocURL = YTX_WBSS_KERNEL.currentLoginInRoomID.toString() + "-" + jsonDocId.toString();
                    }

                    // 检查PageIndex信息
                    if(jsonCurDocId == jsonDocId){
                        if(jsonCurPageIndex <= 0 || jsonCurPageIndex > jsonDocTotalPage){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "Check DocId= " + jsonCurDocId + " PageIndex Failed: index=" + jsonCurPageIndex + " total=" + jsonDocTotalPage + " PageIndex Force Set Zero!");
                            jsonCurPageIndex = 0;
                            YTX_WBSS_KERNEL.updateCurrentRoomId_DocId_PageIndex(jsonCurRoomId, jsonCurDocId, jsonCurPageIndex);
                        }
                    }
                    ...
                    //保存文档信息
                    callbackDocDataArray.push({ "wbssDocId": jsonDocId, "wbssDocFileName": jsonDocFileName, "wbssDocTotalPage": jsonDocTotalPage, "wbssDocURL": jsonDocURL });
                    var currentDocInfo = new YTX_WBSS_KERNEL.DocInfo(jsonDocId, jsonDocFileName, jsonDocTotalPage, jsonDocURL, jsonDocTimestamp);
                ...
                if(YTX_WBSS_KERNEL.requestSynchronizeOneRoomOneDocOnePageFile(YTX_WBSS_KERNEL.currentLoginInRoomID, YTX_WBSS_KERNEL.currentLoginInDocID, YTX_WBSS_KERNEL.currentLoginInPageIndex) == true){
                    isNeedUpdateDrawScreen = false;
                }

                // sync drawdata 同步划线
                var current_doc_info = YTX_WBSS_KERNEL.getDocInfo(YTX_WBSS_KERNEL.currentLoginInRoomID, YTX_WBSS_KERNEL.currentLoginInDocID, true);
                if(current_doc_info != null){
                    var current_doc_server_sync_draw_data_timestamp = current_doc_info.getServerSyncDocDrawDataTimeStamp();
                    if(current_doc_server_sync_draw_data_timestamp > 0){
                        isNeedUpdateDrawScreen = false;
                        YTX_WBSS_KERNEL.requestSyncDrawData(YTX_WBSS_KERNEL.currentLoginInRoomID,
                            YTX_WBSS_KERNEL.currentLoginInDocID, current_doc_server_sync_draw_data_timestamp);
                    }
                }
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "=====_parseJoinRoomResp()===== respCode=" + respCode);
        ...
        _parseLeaveRoomResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            var head = obj["head"];
            ...
            if (respCode == 0) {
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseLeaveRoomResp()===== respCode=" + respCode);
              // 退出释放房间资源
              YTX_WBSS_KERNEL.releaseRoomResource();
            }
            var resp = {};
        ...
        _parseDeleteRoomResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            var head = obj["head"];
            var room_id = head["roomID"];
            var respCode = head["respCode"];
            var respMsg = head["reason"];
            ...
            if (respCode == 0) {
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseDeleteRoomResp()===== respCode=" + respCode);
              YTX_WBSS_KERNEL.releaseRoomResource();
            }
        ...
        _parseKickoutResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseKickoutResp()=====");
        },
        _parseClearRoomResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseClearRoomResp()=====");
        },
        _parseShareDocResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
        ...
        _parseRemoveShareDocResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseRemoveShareDocResp()=====");
        },
        _parseGotoPageResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            ...
            if(head == null || roomId == null || respCode == null || reason == null || pageIndex == null || current_room_id == null || current_doc_id == null || current_doc_info == null ||
                (current_room_id != roomId) || pageIndex < min_page_index || pageIndex > max_page_index){
                var respError = {};
            ...
            // 设置当前页
            YTX_WBSS_KERNEL.updateCurrentRoomId_DocId_PageIndex(current_room_id, current_doc_id, pageIndex);
        ...
        _parseRemoveWbPageResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseRemoveWbPageResp()=====");
        },
        _parseWbssDrawResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseWbssDrawResp()=====");
        },
        _parseWbssDeleteDrawResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            ...
            if(head != null && respCode != null && request_msgExtData != null && respCode == 0){
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "=====_parseWbssDeleteDrawResp() code=" + respCode + "=====");
                var respError = {};
                respError.code = respCode;
                respError.msg = reason;
                if (request_onError != null){
        ...
        _parseDrawUndoResp: function(obj, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError) {
            ...
            var respCode = head["respCode"];
            var reason = head["reason"];
            if(head != null && type != null && roomID != null && respCode != null && reason != null && respCode == 0){
                if(request_onSuccess != null){
                    var respSuccess = {};
                    respSuccess.code = respCode;
                    respSuccess.msg = reason;
        ...
        _parseShareDocNotify: function(obj) {
            ...
            if(roomId != null && docId != null && pageId != null){
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseShareDocNotify(roomId=" + roomId + ",docId=" + docId + "," + pageId + ")=====");
        ...
        _parseGotoPageNotify: function(obj) {
            ...
            if(roomId != null && docId != null && pageId != null && docId >= 0 && pageId >= 1){
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_parseGotoPageNotify(roomId=" + roomId + ",docId=" + docId + "," + pageId + ")=====");
        ...
        _parseDrawNotify: function(obj) {
            ...
            if(page_info != null){
                if(YTX_WBSS_KERNEL.addServerDrawDataObject(room_id, doc_id, page_index, current_draw_data_object)){
                    // 保存数据成功，是否需要更新当前，页面
        ...
        _parseDrawDeleteNotify: function(obj) {
            ...
            if(YTX_WBSS_KERNEL.isLoginInRoomServer){
                ...
                if(type != null && head != null && docID != null && head_roomID != null && head_roomID == current_room_id){
                    ...
                    switch(type){
                        case YTX_WBSS_KERNEL.drawConextDelType.DRAW_DEL_TYPE_LINE:{
                            if(pageIndex != null){
                                ...
                                if(page_info != null){
                                    ...
                                    var drawId = obj["drawID"];
                                    if(drawId != null){
                                        if(YTX_WBSS_KERNEL.allRoomInfoMap[head_roomID].docInfoMap[docID].pageInfoArray[pageIndex-1].clearDrawDataElement(drawId) == true){
                                            if(head_roomID == current_room_id && docID == current_doc_id && pageIndex == current_page_index){
                                                // 当前页需要更新画布
                        ...
                        case YTX_WBSS_KERNEL.drawConextDelType.DRAW_DEL_TYPE_PAGE:{
                            if(pageIndex != null){
                                ...
                                var page_info = YTX_WBSS_KERNEL.getPageInfo(head_roomID, docID, pageIndex, true);
                                if(page_info != null){
                                    if(YTX_WBSS_KERNEL.allRoomInfoMap[head_roomID].docInfoMap[docID].pageInfoArray[pageIndex-1].clearAllDrawDataElement() == true){
                                        if(head_roomID == current_room_id && docID == current_doc_id && pageIndex == current_page_index){
                                            // 当前页需要更新画布
                                            isUpdateDrawScreen = true;
                                        }
                        ...
                        case YTX_WBSS_KERNEL.drawConextDelType.DRAW_DEL_TYPE_DOC:{
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "===== unknow YTX_WBSS_KERNEL.drawConextDelType.DRAW_DEL_TYPE_DOC =====");
                        }break;
                    }
        ...
        _parseDocConvertNotify: function(obj) {
            ...
            if (YTX_WBSS_KERNEL.isLoginInRoomServer == true) {
                ...
                if (result == 0 && docID > 0 && totalPage > 0) {
                    ...
                    // 当前房间信息
                    if(current_room_id == head_roomID && current_doc_id != null && current_page_index != null){
                        ...
                        if(recv_doc_info == null){
                            ...
                            var currentDocInfo = new YTX_WBSS_KERNEL.DocInfo(docID, filename, totalPage, jsonDocURL, 0);
                            YTX_WBSS_KERNEL.allRoomInfoMap[current_room_id].addDocInfo(docID, currentDocInfo);

                            // 获取文档信息
                            var doc_id_array = window.Object.keys(YTX_WBSS_KERNEL.allRoomInfoMap[current_room_id].docInfoMap);
                            for(var i = 0; i < doc_id_array.length; i++){
                                ...
                                if(doc_info != null){
                                    callbackDocDataArray.push({ "wbssDocId": doc_info.docId, "wbssDocFileName": decodeURI(doc_info.docName), "wbssDocTotalPage": doc_info.pageSize, "wbssDocURL": doc_info.docUrl });
                                }
                            }
                          YTX_WBSS_KERNEL.setFileToLocal({
        ...
        _parseDrawUndoNotify: function(obj) {
            ...
            var page_info = YTX_WBSS_KERNEL.getPageInfo(room_id, doc_id, page_index, true);
            if(page_info != null){
                if(YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].setDrawUndoStatus(drawId, type)){
                    // 同步绘图
                    YTX_WBSS_KERNEL.updateDrawScreen();
                }
            }
        ...
        getDocSize: function(_docId) {
            ...
            if (!currentRoomInfo) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "找不到房间(" + YTX_WBSS_KERNEL.currentLoginInRoomID + ")信息");
                return;
            }
            var di = currentRoomInfo.getDocInfo(docId);
            //YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "di=" + di);
            if (!di) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "找不到文档(" + YTX_WBSS_KERNEL.currentLoginInDocID + ")信息");
                return;
            }
        ...
        getPageImageInfo: function(imgWidth, imgHeight) {
            ...
            //YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "di=" + di);
            if (!currentDocInfo) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "找不到文档(" + current_doc_id + ")信息");
                return;
            }
        ...
        isSamePage: function(roomId, docId, pageId) {
            return (YTX_WBSS_KERNEL.getCurRoomId() == roomId && YTX_WBSS_KERNEL.getCurDocId() == docId && YTX_WBSS_KERNEL.getCurPageIndex() == pageId);
        },
        ...
        _log: function(lev, content) {
            if (!YTX_WBSS_KERNEL._logPrint) { //如果开关关闭，则不打印日志 直接返回
                return;
            }
        ...
        _requestRestServer: function(roomId, callback_wbss_room_start, onError) {
            ...
            var request_ajax_url =
                $.ajax({
                    ...
                    success: function(e) {
                        if (!e) {
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "error: connect rest failed, please check server ip and port" + e);
                            var resp = {};
                        ...
                        if (statusCode == 0) {
                            ...
                            if (wbss_websocket_room_server_url.length > 0 && wbss_file_server_url.length > 0) {
                                ...
                                YTX_WBSS_KERNEL._room_servers_websocket_url[0] = Base64.encode(wbss_websocket_room_server_url);
                                ...
                                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "error: respose room server or file server is null");
                                var resp = {};
      ...
      isOffLine: false, //是否是网络掉线
        ...
        connectWebScoketServer: function(callback_wbss_room_start, onError) {
            ...
            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_connectWebScoketServer【Start】=====");

            // 检查已连接
            var wbss_websocket_connect_url = Base64.decode(YTX_WBSS_KERNEL._room_servers_websocket_url[0]);
            if ((YTX_WBSS_KERNEL.websocket_url_string == wbss_websocket_connect_url) && (YTX_WBSS_KERNEL.websocket_handle_obj != null)) {
                if (YTX_WBSS_KERNEL.websocket_connectStatus == YTX_WBSS_KERNEL.websocket_enumConnectStatus.websocket_enumStatusConnected) {
                    // 复用已经连接的 Websocket 对象
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "Reuse connected Websocket object and connection !");
                  var resp = {};
                  resp.code = this._errcode._SUCCESS;
                  resp.msg = "already login server";
                  callback_wbss_room_start(resp);
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_connectWebScoketServer【End】=====");
                    return;
                } else if ((YTX_WBSS_KERNEL.websocket_connectStatus == YTX_WBSS_KERNEL.websocket_enumConnectStatus.websocket_enumStatusConnecting) ||
                    (YTX_WBSS_KERNEL.websocket_connectStatus == YTX_WBSS_KERNEL.websocket_enumConnectStatus.websocket_enumStatusReconnecting)) {
                    // 已有正在连接的处理，防止重复连接，吃掉此消息，直接返回
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "Other websocket handle is connecting， return now !");
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====_connectWebScoketServer【End】=====");
                    return;
                }
            }
            ...
            YTX_WBSS_KERNEL.websocket_connectStatus = YTX_WBSS_KERNEL.websocket_enumConnectStatus.websocket_enumStatusConnecting;

            // 超时检测对象，创建，连接超时定时器
            var connect_websocket_timeout_timer = window.setTimeout(function() {
                if (YTX_WBSS_KERNEL.websocket_connectStatus != YTX_WBSS_KERNEL.websocket_enumConnectStatus.websocket_enumStatusConnected) {
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "Connect to websocket " + full_wbss_websocket_connect_url + " time out");
                    ...
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "connect_websocket_timeout_timer is Dead!");
                }
            }, YTX_WBSS_KERNEL.websocket_connect_timeout_ms);

            // WebSocket OnOpen 事件
            YTX_WBSS_KERNEL.websocket_handle_obj.onopen = function(event) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "=====YTX_WBSS_KERNEL.websocket_handle_obj.onopen=====");
                ...
                // WebSocket 已连接状态
                YTX_WBSS_KERNEL.websocket_connectStatus = YTX_WBSS_KERNEL.websocket_enumConnectStatus.websocket_enumStatusConnected;
              ...
              //  注册心跳
              YTX_WBSS_KERNEL.intervalId = window.setInterval(YTX_WBSS_KERNEL.heartBeat, YTX_WBSS_KERNEL.heartBeatInterval._WIFI * 1000);
            ...
            YTX_WBSS_KERNEL.websocket_handle_obj.onclose = function(event) {
              ...
              // }
                ...
                // 关闭WebSocket事件处理
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "=====YTX_WBSS_KERNEL.websocket_handle_obj.onclose code=" + event.code + "=====");
            ...
            YTX_WBSS_KERNEL.websocket_handle_obj.onerror = function(event) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "=====YTX_WBSS_KERNEL.websocket_handle_obj.onerror errorCode=" + event.errorCode + "=====");
            };
        ...
        disconnectWebScoketServer: function(isCloseWebSocket) {
            ...
            if (YTX_WBSS_KERNEL.websocket_handle_obj != null) {
                if(isCloseWebSocket == true){
                    ...
                    try {
                        ...
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "YTX_WBSS_KERNEL.websocket_handle_obj.close Error e=" + e);
                    } finally {
          ...
          YTX_WBSS_KERNEL.releaseRoomResource();
            ...
            YTX_WBSS_KERNEL.websocket_connectStatus = YTX_WBSS_KERNEL.websocket_enumConnectStatus.websocket_enumStatusCloned;
        },
            ...
            if(msgType != null || onSuccess != null || onError != null){
                ...
                var current_timeout_headle = window.setTimeout(function() {
                    ...
                    if(request_id_obj != null){
                        ...
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "time out msgType=" + request_id_obj.msgType + " request_id_number=" + request_id_number);
                        if(onError != null){
        ...
        sendWebSocketMsg: function(send_json_string) {
            ...
            if (YTX_WBSS_KERNEL.websocket_handle_obj) YTX_WBSS_KERNEL.websocket_handle_obj.send(send_json_string);
        },
        ...
        onWebSocketRecvMsg: function(recv_json_string) {
            ...
            if (type == null || payload == null) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "receive msg Parse invalid" + ((statusCode != null)?("statusCode=" + statusCode):"") + " " +
            ...
            var request_id_obj = YTX_WBSS_KERNEL.websocket_sendMsgRequestIDMap[request_id_number];
            if (request_id_obj == null) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "receive a unrequest response, request_id_number:" + payload["head"]["reqID"]);
                return;
            }
            ...
            try {
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "Cannot read property timeout of undefined");
            }
            ...
            switch (type) {
                case YTX_WBSS_KERNEL._prototype.CreateRoomResp:
                    {
                        YTX_WBSS_KERNEL._parseCreateRoomResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.JoinRoomResp:
                    {
                        YTX_WBSS_KERNEL._parseJoinRoomResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.LeaveRoomResp:
                    {
                        YTX_WBSS_KERNEL._parseLeaveRoomResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.DeleteRoomResp:
                    {
                        YTX_WBSS_KERNEL._parseDeleteRoomResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.KickoutResp:
                    {
                        YTX_WBSS_KERNEL._parseKickoutResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.ClearRoomResp:
                    {
                        YTX_WBSS_KERNEL._parseClearRoomResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.ShareDocResp:
                    {
                        YTX_WBSS_KERNEL._parseShareDocResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.RemoveShareDocResp:
                    {
                        YTX_WBSS_KERNEL._parseRemoveShareDocResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.GotoPageResp:
                    {
                        YTX_WBSS_KERNEL._parseGotoPageResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.RemoveWbPageResp:
                    {
                        YTX_WBSS_KERNEL._parseRemoveWbPageResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.WbssDrawResp:
                    {
                        YTX_WBSS_KERNEL._parseWbssDrawResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.WbssDeleteDrawResp:
                    {
                        YTX_WBSS_KERNEL._parseWbssDeleteDrawResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                case YTX_WBSS_KERNEL._prototype.DrawUndoResp:
                    {
                        YTX_WBSS_KERNEL._parseDrawUndoResp(payload, request_id_number, request_msgType, request_msgExtData, request_onSuccess, request_onError);
                    }
                    break;
                default:
      ...
      reconnectToServer: function(callback) {
        YTX_WBSS_KERNEL.connectWebScoketServer(function () {
          if (YTX_WBSS_KERNEL.currentLoginInRoomID && YTX_WBSS_KERNEL.currentLoginInRoomID != -1) {
            ...
            var sendReqJoinRoomJsonStr = YTX_WBSS_KERNEL._protobuf._buildJoinRoom(joinRoomBuilder, function () {
        ...
        updateCurrentRoomId_DocId_PageIndex: function(room_id, doc_id, page_index) {
            ...
            if(YTX_WBSS_KERNEL.isShowDebugDocPageManager){
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "updateCurrentRoomId_DocId_PageIndex(room_id=" + room_id + " doc_id=" + doc_id + " page_index=" + page_index +
                    ") oldinfo=(" + YTX_WBSS_KERNEL.currentLoginInRoomID + "," + YTX_WBSS_KERNEL.currentLoginInDocID + "," + YTX_WBSS_KERNEL.currentLoginInPageIndex + ")");
            }
        ...
        getDocInfo: function(room_id, doc_id, isShowLog) {                                     ///< 获取文档信息
            var currentRoomInfo = YTX_WBSS_KERNEL.allRoomInfoMap[room_id];
            if(currentRoomInfo == null){
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getDocInfo 找不到房间(" + room_id + ")信息");
                }
                return null;
            }
            ...
            if(currentDocInfo == null){
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getDocInfo 找不到文档(" + doc_id + ")信息");
                }
                return null;
            }
        ...
        getPageInfo: function(room_id, doc_id, page_index, isShowLog) {                        ///< 获取页信息
            var currentRoomInfo = YTX_WBSS_KERNEL.allRoomInfoMap[room_id];
            if(currentRoomInfo == null){
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getPageInfo 找不到房间(" + room_id + ")信息");
                }
                return null;
            }
            ...
            if(currentDocInfo == null){
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getPageInfo 找不到文档(" + doc_id + ")信息");
                }
                return null;
            }
            ...
            if (currentPageInfo == null) {
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getPageInfo 找不到页(" + page_index + ")信息");
                }
                return null;
            }
        ...
        getCurrentRoomInfo: function(isShowLog) {
            ...
            if(currentRoomInfo == null){
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getCurrentRoomInfo 找不到房间(" + current_room_id + ")信息");
                }
                return null;
            }
        ...
        getCurrentDocInfo: function(isShowLog) {
            ...
            if(currentRoomInfo == null){
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getCurrentDocInfo 找不到房间(" + current_room_id + ")信息");
                }
                return null;
            }
            ...
            if(currentDocInfo == null){
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getCurrentDocInfo 找不到文档(" + current_doc_id + ")信息");
                }
                return null;
            }
        ...
        getCurrentPageInfo: function(isShowLog) {
            ...
            if(currentRoomInfo == null){
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getCurrentPageInfo 找不到房间(" + current_room_id + ")信息");
                }
                return null;
            }
            ...
            if(currentDocInfo == null){
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getCurrentPageInfo 找不到文档(" + current_doc_id + ")信息");
                }
                return null;
            }
            ...
            if (currentPageInfo == null) {
                if(isShowLog != null && isShowLog == true){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "getCurrentPageInfo 找不到页(" + current_page_index + ")信息");
                }
                return null;
            }
        ...
        isCurrentRoomId_DocId_PageIndex : function(room_id, doc_id, page_index){                    ///< 是否当前RoomID、DocID、PageIndex
            if(YTX_WBSS_KERNEL.isLoginInRoomServer && YTX_WBSS_KERNEL.currentLoginInRoomID > 0){
                if(room_id != null && doc_id != null && page_index != null){
                    if(room_id == YTX_WBSS_KERNEL.currentLoginInRoomID &&
        ...
        setImageInfo: function(room_id, doc_id, page_index, _image_width, _image_height) {
            var currentRoomInfo = YTX_WBSS_KERNEL.allRoomInfoMap[room_id];
            if(currentRoomInfo == null){
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "setImageInfo 找不到房间(" + room_id + ")信息");
                return false;
            }

            var currentDocInfo = currentRoomInfo.docInfoMap[doc_id];
            if(currentDocInfo == null){
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "setImageInfo 找不到文档(" + current_doc_id + ")信息");
                return false;
            }

            var currentPageInfo = currentDocInfo.pageInfoArray[page_index-1];
            if (currentPageInfo == null) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "setImageInfo 找不到页(" + current_page_index + ")信息");
                return false;
            }

            YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].setImageInfo(_image_width, _image_height);
            return true;
        },
        setDrawSpaceInfo: function(room_id, doc_id, page_index, _canvas_width, _canvas_height, _draw_space_ratio, _draw_space_ifSacle) {
            var currentRoomInfo = YTX_WBSS_KERNEL.allRoomInfoMap[room_id];
            if(currentRoomInfo == null){
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "setDrawSpaceInfo 找不到房间(" + room_id + ")信息");
                return false;
            }

            var currentDocInfo = currentRoomInfo.docInfoMap[doc_id];
            if(currentDocInfo == null){
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "setDrawSpaceInfo 找不到文档(" + current_doc_id + ")信息");
                return false;
            }

            var currentPageInfo = currentDocInfo.pageInfoArray[page_index-1];
            if (currentPageInfo == null) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "setDrawSpaceInfo 找不到页(" + current_page_index + ")信息");
                return false;
            }

            YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].setDrawSpaceInfo(_canvas_width, _canvas_height, _draw_space_ratio, _draw_space_ifSacle);
            return true;
        },
        addServerDrawDataObject: function(roomId, docId, pageId, draw_data_object) {
            ...
            if (!currentRoomInfo) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "addServerDrawDataObject 找不到房间(" + roomId + ")信息");
                return false;
            }
            var currentDocInfo = currentRoomInfo.docInfoMap[docId];
            if (currentDocInfo == null) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "addServerDrawDataObject 找不到文档(" + docId + ")信息");
                return false;
            }
            var currentPageInfo = currentDocInfo.pageInfoArray[pageId-1];
            if (currentPageInfo == null) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "addServerDrawDataObject 找不到页(" + pageId + ")信息");
                return false;
            }
            ...
            if(currentTimestamp != null){
                ...
                lastTimestamp = YTX_WBSS_KERNEL.allRoomInfoMap[roomId].docInfoMap[docId].getLocalSyncDocDrawDataTimeStamp();
                if(currentTimestamp > lastTimestamp){
                    YTX_WBSS_KERNEL.allRoomInfoMap[roomId].docInfoMap[docId].setLocalSyncDocDrawDataTimeStamp(currentTimestamp);
                }

                lastTimestamp = YTX_WBSS_KERNEL.allRoomInfoMap[roomId].docInfoMap[docId].getServerSyncDocDrawDataTimeStamp();
                if(currentTimestamp > lastTimestamp){
                    YTX_WBSS_KERNEL.allRoomInfoMap[roomId].docInfoMap[docId].setServerSyncDocDrawDataTimeStamp(currentTimestamp);
                }

                lastTimestamp = YTX_WBSS_KERNEL.allRoomInfoMap[roomId].docInfoMap[docId].pageInfoArray[pageId-1].getLocalSyncPageDrawDataTimeStamp();
                if(currentTimestamp > lastTimestamp){
                    YTX_WBSS_KERNEL.allRoomInfoMap[roomId].docInfoMap[docId].pageInfoArray[pageId-1].setLocalSyncPageDrawDataTimeStamp(currentTimestamp);
                }

                lastTimestamp = YTX_WBSS_KERNEL.allRoomInfoMap[roomId].docInfoMap[docId].pageInfoArray[pageId-1].getServerSyncPageDrawDataTimeStamp();
                if(currentTimestamp > lastTimestamp){
                    YTX_WBSS_KERNEL.allRoomInfoMap[roomId].docInfoMap[docId].pageInfoArray[pageId-1].setServerSyncPageDrawDataTimeStamp(currentTimestamp);
                }
            }
            ...
            // Sync Draw Data
            YTX_WBSS_KERNEL.allRoomInfoMap[roomId].docInfoMap[docId].pageInfoArray[pageId-1].addDrawDataElement(drawDataElement);
        ...
        DocInfo: function(curDocID, curDocName, curDocPageTotalNum, curDocUrl, curServerTimeStamp) {
            ...
            this.pageSize = (curDocPageTotalNum != null) ? curDocPageTotalNum : YTX_WBSS_KERNEL.DEFAULT_DOC_PAGE_NUMBER;
            ...
            this.getPageFileName = function(page_index) {           ///< 默认从1开始
        ...
        PageInfo: function(pageinfo_index, pageinfo_filename) {
                ...
                if(drawDataElement != null){
                    ...
                    for(var i = 0; i < this.drawDataElementArray.length; i++){
                      if(currentDrawId == (this.drawDataElementArray[i])._drawID){
                        //已有的DrawId添加信息的坐标信息
                        this.drawDataElementArray[i].appendDrawDataElement(drawDataElement, this.drawDataElementArray, i);
                        isOnlyUpdate = true;
                        break;
                      }
                    }
                    if(isOnlyUpdate == false && !(drawDataElement._isFinal && drawDataElement._shapeType == YTX_WBSS_API._shapeType.LASERPEN)){
            ...
            this.findDrawDataElement = function(mouse_pos_x, mouse_pos_y) {
                ...
                if(screen_coordinate_array.length > 0){
                    YTX_WBSS_KERNEL.CANVAS_MOD.screenToWorldCoors(world_coordinate_array, this, screen_coordinate_array);
                }
                if(world_coordinate_array.length > 0){
                    ...
                    screen_coordinate_offset_array.push({x:(this.last_draw_space_fromX + pix_line_size),y:(this.last_draw_space_fromY + pix_line_size)});
                    var world_coordinate_offset_array = [];
                    YTX_WBSS_KERNEL.CANVAS_MOD.screenToWorldCoors(world_coordinate_offset_array, this, screen_coordinate_offset_array);
                    if(world_coordinate_offset_array.length > 0){
                        ...
                        if(limit_left_x < limit_right_x && limit_bottom_y < limit_top_y){
                            // 遍历元素
                            for (var i = (this.drawDataElementArray.length - 1); i >= 0; i--) {      ///< 从尾部开始遍历
                                ...
                                if(draw_info != null && draw_info._coordinate_array != null && draw_info._isValid == true && draw_info._isUndo == false){
                                    if(draw_info._coordinate_array.length > 0){
                                        if(draw_info._shapeType == YTX_WBSS_API._shapeType.FREELINE){               ///< 自由线
                                            // 遍历坐标点
                                            for(var j = 0; j < (draw_info._coordinate_array.length - 1); j++){
                                                ...
                                                if(YTX_WBSS_KERNEL.MathLib.intersectLineRect(start_coor.x, start_coor.y,
                                                    end_coor.x, end_coor.y,
                                                    limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true){
                                                    return draw_info._drawID;
                                                }
                                            }
                                        }else if(draw_info._shapeType == YTX_WBSS_API._shapeType.LINE){               ///< 直线
                                            if(draw_info._coordinate_array.length == 2){
                                                if(YTX_WBSS_KERNEL.MathLib.intersectLineRect(draw_info._coordinate_array[0].x, draw_info._coordinate_array[0].y,
                                                    draw_info._coordinate_array[1].x, draw_info._coordinate_array[1].y,
                                                    limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true){
                                                    return draw_info._drawID;
                                                }
                                            }
                                        }else if(draw_info._shapeType == YTX_WBSS_API._shapeType.RECT){               ///< 矩形
                                            if(draw_info._coordinate_array.length == 2){
                                                ...
                                                if(YTX_WBSS_KERNEL.MathLib.intersectLineRect(x1, y1, x1, y2,
                                                    limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true){
                                                    return draw_info._drawID;
                                                }else if(YTX_WBSS_KERNEL.MathLib.intersectLineRect(x1, y1, x2, y1,
                                                    limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true){
                                                    return draw_info._drawID;
                                                }else if(YTX_WBSS_KERNEL.MathLib.intersectLineRect(x2, y1, x2, y2,
                                                    limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true){
                                                    return draw_info._drawID;
                                                }else if(YTX_WBSS_KERNEL.MathLib.intersectLineRect(x1, y2, x2, y2,
                                                    limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true){
                                                    return draw_info._drawID;
                                                }
                                            }
                                        }else if(draw_info._shapeType == YTX_WBSS_API._shapeType.TRIANGLE){               ///< 三角形
                                            if(draw_info._coordinate_array.length == 3){
                                                ...
                                                var x3 = 2 * x1 - x2;
                                                var y3 = y2;
                                                if(YTX_WBSS_KERNEL.MathLib.intersectLineRect(x1, y1, x2, y2,
                                                    limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true){
                                                    return draw_info._drawID;
                                                }else if(YTX_WBSS_KERNEL.MathLib.intersectLineRect(x2, y2, x3, y3,
                                                    limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true){
                                                    return draw_info._drawID;
                                                }else if(YTX_WBSS_KERNEL.MathLib.intersectLineRect(x3, y3, x1, y1,
                                                    limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true){
                                                    return draw_info._drawID;
                                                }
                                            }
                                        }else if(draw_info._shapeType == YTX_WBSS_API._shapeType.CIRCLE){               ///< 圆形
                                            if(draw_info._coordinate_array.length == 2){

                                                var circle_center_x = (draw_info._coordinate_array[0].x + draw_info._coordinate_array[1].x) / 2;
                                                var circle_center_y = (draw_info._coordinate_array[0].y + draw_info._coordinate_array[1].y) / 2;
                                                var circle_radius = YTX_WBSS_KERNEL.MathLib.twoPointsDistance({x:circle_center_x,y:circle_center_y},draw_info._coordinate_array[0]);
                                                ...
                                                if(YTX_WBSS_KERNEL.MathLib.intersectRectCircle(rect_left_top_pos, rect_right_top_pos, rect_left_bottom_pos, rect_right_bottom_pos,
                                                    {x:circle_center_x, y:circle_center_y}, circle_radius) == true){
                                                    return draw_info._drawID;
                                                }
                                            }
                                        }else{
                                            ...
                                            for(var j = 0; j < draw_info._coordinate_array.length; j++){
                                                ...
                                                if(coor != null && coor.x != null && coor.y != null){
                                                    if((coor.x >= limit_left_x) && (coor.x <= limit_right_x) && (coor.y >= limit_bottom_y) && (coor.y <= limit_top_y)){
                                                        return draw_info._drawID;
                                                    }
                                                }
                                            }
                            ...
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "findDrawDataElement limit rect space failed left_x=" + limit_left_x + " right_x=" + limit_right_x +
                                " top_y=" + limit_top_y + " bottom_y=" + limit_bottom_y);
                        }
                    }//if(world_coordinate_offset_array.length > 0)
            ...
            this.setDrawUndoStatus = function(drawId, type) {       ///< type 【0-false is 撤销】 【1-true is 恢复】
                for(var i = 0; i < this.drawDataElementArray.length; i++){
            ...
            this.setDrawSpaceInfo = function(_canvas_width, _canvas_height, _draw_space_ratio, _draw_space_ifSacle) {
                if(this.last_canvas_width != _canvas_width || this.last_canvas_height != _canvas_height ||
                    this.last_draw_space_ratio != _draw_space_ratio || this.last_draw_space_ifSacle != _draw_space_ifSacle){
                    ...
                    if(this.last_image_width > 0 && this.last_image_height > 0){
                        ...
                        if(img_draw_space_ratio != this.last_draw_space_ratio){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "setDrawSpaceInfo Force img_draw_space_ratio=" + img_draw_space_ratio +
                                " to last_draw_space_ratio=" + this.last_draw_space_ratio);
                    ...
                    if (this.last_draw_space_ratio <= 0) {
                        ...
                        if (canvas_ratio > this.last_draw_space_ratio) {
                            current_draw_space_height = this.last_canvas_height;
                            current_draw_space_width = Math.round(this.last_draw_space_ratio * current_draw_space_height);
                            current_fromX = Math.round((this.last_canvas_width - current_draw_space_width) * 0.5);
                            current_fromY = 0;
                        } else {
                            current_draw_space_width = this.last_canvas_width;
                            current_draw_space_height = Math.round(current_draw_space_width / this.last_draw_space_ratio);
                            current_fromX = 0;
                            current_fromY = Math.round((this.last_canvas_height - current_draw_space_height) * 0.5);
                        }
                    }
                    this.updateDrawSpaceRect(current_fromX, current_fromY, current_draw_space_width, current_draw_space_height);
                }
            };
        ...
        DrawDataElement: function(drawID, shapeType, lineSize, color, isFill, coordinate_array, drawAreaWidth, drawAreaHeight, isFinal, isUndo, textObj, timestamp) {
            this._drawID = drawID;
            ...
            this.appendDrawDataElement = function(drawDataElement, parentDrawDataElementArray, parentDrawDataElementIndex) {
                if(drawDataElement != null){
                    if((this._drawID == drawDataElement._drawID) && (this._shapeType == drawDataElement._shapeType)){
                        if(this._isFinal == true){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "appendDrawDataElement Failed drawId=" + this._drawID + " is Final Statue!");
                        }else{

                            // 更新坐标信息
                            if(drawDataElement._coordinate_array != null && drawDataElement._coordinate_array.length > 0){
                                switch(this._shapeType){
                                    case YTX_WBSS_API._shapeType.FREELINE:{
                                        // 添加坐标
                                        for (var i = 0; i < drawDataElement._coordinate_array.length; i++) {
                                            this._coordinate_array.push({ x: drawDataElement._coordinate_array[i].x, y: drawDataElement._coordinate_array[i].y });
                                        }
                                    }break;
                                    case YTX_WBSS_API._shapeType.LINE:{
                                        ...
                                        if(this._coordinate_array.length >= 2 && drawDataElement._coordinate_array.length == 2){
                                            ...
                                            if((this._coordinate_array[this_end_pos_index].x == drawDataElement._coordinate_array[0].x) &&
                                                (this._coordinate_array[this_end_pos_index].y == drawDataElement._coordinate_array[0].y))
                                            {
                                                // 加入数据的起始坐标等于当前数据的最后坐标，为连续线段模式，添加坐标
                                                for (var i = 1; i < drawDataElement._coordinate_array.length; i++) {    ///< 注意index需要从1开始
                                                    this._coordinate_array.push({ x: drawDataElement._coordinate_array[i].x, y: drawDataElement._coordinate_array[i].y });
                                                }
                                            }
                                            else if((this._coordinate_array.length == 2) &&
                                            ...
                                            {
                                                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "appendDrawDataElement straight line Failed Unknow CoorsInfo drawId=" + this._drawID + " is Final Statue!");
                                            }
                                        }//if(this._coordinate_array.length >= 2 && drawDataElement._coordinate_array.length == 2)
                                    }break;
                        ...
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "appendDrawDataElement input inVailed DrawId(" + this._drawID + ")(" +
                            drawDataElement._drawID + ") shapeType(" + this._shapeType + ")(" + drawDataElement._shapeType + ").");
                    }
                }//if(drawDataElement != null)
            };
        ...
        MathLib: {
            twoPointsDistance : function (posA, posB){
                return Math.sqrt(Math.pow(Math.abs(posA.x - posB.x),2) + Math.pow(Math.abs(posA.y - posB.y),2));
            },
            ...
            intersectLines : function(lineA_start_pos, lineA_end_pos, lineB_start_pos, lineB_end_pos){
                ...
                // 线段ab的法线N1
                var nx1 = (lineA_end_pos.y - lineA_start_pos.y), ny1 = (lineA_start_pos.x - lineA_end_pos.x);

                // 线段cd的法线N2
                var nx2 = (lineB_end_pos.y - lineB_start_pos.y), ny2 = (lineB_start_pos.x - lineB_end_pos.x);
            ...
            intersectLineRect : function(line_x1, line_y1, line_x2, line_y2, rect_left_x, rect_right_x, rect_top_y, rect_bottom_y){
                if(YTX_WBSS_KERNEL.MathLib.intersectLines({x:line_x1,y:line_y1},
                    {x:line_x2,y:line_y2},
                    {x:rect_left_x,y:rect_top_y},
                    {x:rect_right_x,y:rect_top_y}) != null){
                    return true;
                }else if(YTX_WBSS_KERNEL.MathLib.intersectLines({x:line_x1,y:line_y1},
                    {x:line_x2,y:line_y2},
                    {x:rect_left_x,y:rect_bottom_y},
                    {x:rect_right_x,y:rect_bottom_y}) != null){
                    return true;
                }else if(YTX_WBSS_KERNEL.MathLib.intersectLines({x:line_x1,y:line_y1},
                    {x:line_x2,y:line_y2},
                    {x:rect_left_x,y:rect_top_y},
                    {x:rect_left_x,y:rect_bottom_y}) != null){
                    return true;
                }else if(YTX_WBSS_KERNEL.MathLib.intersectLines({x:line_x1,y:line_y1},
                    {x:line_x2,y:line_y2},
            ...
            intersectRectCircle : function(rect_letf_top_pos, rect_right_top_pos, rect_left_bottom_pos, rect_right_bottom_pos, circle_center_pos, circle_radius){
                var letf_top_dist = YTX_WBSS_KERNEL.MathLib.twoPointsDistance(rect_letf_top_pos, circle_center_pos);
                var right_top_dist = YTX_WBSS_KERNEL.MathLib.twoPointsDistance(rect_right_top_pos, circle_center_pos);
                var letf_bottom_dist = YTX_WBSS_KERNEL.MathLib.twoPointsDistance(rect_left_bottom_pos, circle_center_pos);
                var right_bottom_dist = YTX_WBSS_KERNEL.MathLib.twoPointsDistance(rect_right_bottom_pos, circle_center_pos);
                if(((letf_top_dist > circle_radius) && (right_top_dist > circle_radius) && (letf_bottom_dist > circle_radius) && (right_bottom_dist > circle_radius)) ||
                    ((letf_top_dist < circle_radius) && (right_top_dist < circle_radius) && (letf_bottom_dist < circle_radius) && (right_bottom_dist < circle_radius))){
                    // fix Accuracy
                    ...
                    var all_diff = Math.min(letf_top_diff, right_top_diff, letf_bottom_diff, right_bottom_diff);
                    if(all_diff < 0.00001){       ///< .toFixed(6) or Math.round 精度控制，主要影响坐标保存信息
                        return true;
                    }else{
                        return false;
                    }
        ...
        _protobuf: {
            ...
            _buildDrawData: function(draw_data_obj) {
                ...
                return "{\"type\":" + YTX_WBSS_KERNEL._prototype.WbssDrawReq + ",\"payload\":" + payloadJsonStr + "}";
            },
            _buildCreateRoom: function(createRoomBuilder, onSuccess, onError) {
                ...
                var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.CreateRoomReq, onSuccess, onError);
                ...
                return "{\"type\":" + YTX_WBSS_KERNEL._prototype.CreateRoomReq + ",\"payload\":" + sendJsonStr + "}";
            },
            _buildJoinRoom: function(joinRoomBuilder, onSuccess, onError) {
                ...
                var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.JoinRoomReq, onSuccess, onError);
                ...
                sendJsonStr = JSON.stringify(sendJsonStr);
                return "{\"type\":" + YTX_WBSS_KERNEL._prototype.JoinRoomReq + ",\"payload\":" + sendJsonStr + "}";
            },
            _buildDeleteRoom: function(deleteRoomBuilder, onSuccess, onError) {
                ...
                var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.DeleteRoomReq, null, null);
                ...
                sendJsonStr = JSON.stringify(sendJsonStr);
                return "{\"type\":" + YTX_WBSS_KERNEL._prototype.DeleteRoomReq + ",\"payload\":" + sendJsonStr + "}";
            },
            _buildLeaveRoom: function(leaveRoomBuilder, onSuccess, onError) {
                ...
                var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.LeaveRoomReq, onSuccess, onError);
                ...
                return "{\"type\":" + YTX_WBSS_KERNEL._prototype.LeaveRoomReq + ",\"payload\":" + sendJsonStr + "}";
            },
            _buildClearRoom: function(clearRoomBuilder, onSuccess, onError) {
                ...
                var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.ClearRoomReq, onSuccess, onError);
                ...
                sendJsonStr = JSON.stringify(sendJsonStr);
                return "{\"type\":" + YTX_WBSS_KERNEL._prototype.ClearRoomReq + ",\"payload\":" + sendJsonStr + "}";
            },
            _buildShareDoc: function(shareDocBuilder, onSuccess, onError) {
                ...
                if(roomId == current_room_id){
                    ...
                    if(doc_info != null){
                        ...
                        var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.ShareDocReq, onSuccess, onError);
                        ...
                        sendJsonStr = JSON.stringify(sendJsonStr);
                        return "{\"type\":" + YTX_WBSS_KERNEL._prototype.ShareDocReq + ",\"payload\":" + sendJsonStr + "}";
                    }else{
                        return null;
                    }
                }else{
            ...
            _buildRemoveDoc: function(removeDocBuilder, onSuccess, onError) {
                ...
                var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.RemoveShareDocReq, onSuccess, onError);
                var headJson = new Object();
                headJson["authKey"] = YTX_WBSS_KERNEL._authKey;
                headJson["userID"] = YTX_WBSS_KERNEL._userId;
                headJson["reqID"] = request_id_number;
                ...
                sendJsonStr = JSON.stringify(sendJsonStr);
                return "{\"type\":" + YTX_WBSS_KERNEL._prototype.RemoveShareDocReq + ",\"payload\":" + sendJsonStr + "}";
            },
            _buildGotoPage: function(gotoPageBuilder, onSuccess, onError) {
                ...
                if (gotoPageBuilder == null || current_room_id == null || current_doc_id == null || current_page_index == null || goto_page_index == null || current_doc_info == null ||
                    current_room_id <= 0 || current_doc_id < 0 || goto_page_index <= 0 || (current_page_index == goto_page_index) ||
                    (goto_page_index < min_page_index) || (goto_page_index > max_page_index)) {
                    var respError = {};
                    respError.code = YTX_WBSS_KERNEL._errcode._NO_REQUIRED_PARAM;
                ...
                var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.GotoPageReq, onSuccess, onError);
                ...
                sendJsonStr = JSON.stringify(sendJsonStr);
                return "{\"type\":" + YTX_WBSS_KERNEL._prototype.GotoPageReq + ",\"payload\":" + sendJsonStr + "}";
            },
            _buildGotoNextPage: function(onSuccess, onError) {
                ...
                if (current_room_id == null || current_doc_id == null || current_page_index == null || goto_page_index == null || current_doc_info == null ||
                    current_room_id <= 0 || current_doc_id < 0 || goto_page_index <= 0 || (current_page_index == goto_page_index) ||
                    (goto_page_index < min_page_index) || (goto_page_index > max_page_index)) {
                    var respError = {};
                    respError.code = YTX_WBSS_KERNEL._errcode._NO_REQUIRED_PARAM;
            ...
            _buildDraw_Undo_or_wRedo: function(is_Undo_or_wRedo, onSuccess, onError) {
                ...
                if(current_page_info != null){
                    ...
                    if(is_Undo_or_wRedo){
                        // 撤销
                        if(YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].drawDataElementArray != null){
                            for(var i = (YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].drawDataElementArray.length - 1); i >= 0; i--){     ///< 从后向前查找
                                var draw_data_element = YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].drawDataElementArray[i];
                        ...
                        // 恢复
                        if(YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].drawDataElementArray != null){
                            for(var i = 0; i < YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].drawDataElementArray.length; i++){     ///< 从前向后查找
                                var draw_data_element = YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].drawDataElementArray[i];
                                if(draw_data_element != null){
                                    if(draw_data_element._drawID != null){
                                        var draw_id_split_arrary = draw_data_element._drawID.split("-");
                                        if(draw_id_split_arrary != null){
                                            if(draw_id_split_arrary.length >= 6){
                                                if((draw_id_split_arrary[0] == room_id) &&
                                                    ...
                                                    (draw_id_split_arrary[4] == YTX_WBSS_KERNEL._userId)){
                                                    // 找到属于自己的DrawID
                                                    if(draw_data_element._isUndo == true){         ///< 可以被恢复的DrawID
                                                        findDrawID = draw_data_element._drawID;
                    ...
                    if(findDrawID.length > 0){
                        var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.DrawUndoReq, onSuccess, onError);
                        ...
                        return "{\"type\":" + YTX_WBSS_KERNEL._prototype.DrawUndoReq + ",\"payload\":" + sendJsonStr + "}";
                    }
                }//if(current_page_info != null)
                return null;
            },
            _buildDeleteElement: function(room_id, doc_id, page_index, draw_id) {
                ...
                var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.WbssDeleteDrawReq, null, null, ext_data_obj);
                ...
                sendJsonStr = JSON.stringify(sendJsonStr);
                return "{\"type\":" + YTX_WBSS_KERNEL._prototype.WbssDeleteDrawReq + ",\"payload\":" + sendJsonStr + "}";
            },
            _buildClearCurrentPage: function(onSuccess, onError) {
                ...
                if(current_page_info != null){
                    ...
                    var request_id_number = YTX_WBSS_KERNEL.getRequestIDNumber(YTX_WBSS_KERNEL._prototype.WbssDeleteDrawReq, onSuccess, onError, ext_data_obj);
        ...
        requestSyncDrawData: function(roomId, docId, curServerSyncDocDrawDataTimestamp) {
            ...
            if (doc_info != null){
                ...
                if (curServerSyncDocDrawDataTimestamp > localDocTimestamp) {
                    ...
                    var sendJsonStr = "{\"type\":" + YTX_WBSS_KERNEL._prototype.SyncRoomDataReq + ",\"payload\":" + JSON.stringify(sendJsonObj) + "}";
            ...
            if (respCode == 0) {
                        ...
                        if(doc_id != null){
                            ...
                            if(current_doc_info != null){
                                ...
                                if(current_recv_server_timestamp != null && page_index != null){
                                    ...
                                    YTX_WBSS_KERNEL.addServerDrawDataObject(room_id, doc_id, page_index, current_draw_data_object);
                ...
                if(draw_data_objects.length >= 100 && last_doc_id != null){
                    ...
                    if (doc_info != null){
                        ...
                        if(doc_server_timestamp > last_recv_server_timestamp){                           ///< 同步画图数据到，从服务器获取的最后时间戳
                ...
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "resposeSyncDrawData ErrorMsg=" + respMsg + " ErrorCode=" + respCode);
            }
        },
        ...
        requestSynchronizeOneRoomAllDocsAllPageFiles: function(current_room_id){
            ...
            if(current_room_id != null && current_room_id >= 0){
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "===== requestSynchronizeOneRoomAllDocsAllPageFiles room_id=" + current_room_id + "=====");
                var currentRoomInfo = YTX_WBSS_KERNEL.allRoomInfoMap[current_room_id];
                if(currentRoomInfo != null){
                    ...
                    if(doc_id_array != null && doc_number > 1){
                        for(var i = 0; i < doc_number; i++){
                            ...
                            if(current_doc_id > 0){         // 非白板，文档
                                YTX_WBSS_KERNEL.requestSynchronizeOneRoomOneDocAllPageFiles(current_room_id,current_doc_id);
                            }//if(current_doc_id > 0)
                        }//for(var i = 0; i < doc_number; i++)
                    }//if(doc_id_array != null && doc_number > 1)
                }//if(currentRoomInfo != null)
            ...
            if(current_doc_id > 0){     ///< 文档类型
                ...
                if(current_room_id != null && current_doc_info != null){
                    ...
                    if(current_total_page != null && current_total_page > 0){
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====requestSynchronizeOneRoomOneDocAllPageFiles room_id=" +
                            current_room_id + " doc_id=" + current_doc_id + " total_page=" + current_total_page + "=====");
                        for(var page_index = 1; page_index <= current_total_page; page_index++){
                            YTX_WBSS_KERNEL.requestSynchronizeOneRoomOneDocOnePageFile(current_room_id, current_doc_id, page_index);
                        }//for(var page_index = 1; page_index <= current_total_page; page_index++)
            ...
            if(docId > 0){              ///< 文档类型
                ...
                if(current_page_info != null){
                    ...
                    if(current_page_filename != null){
                        YTX_WBSS_KERNEL.asynGetLocalDataBaseItem(current_page_filename,function completedCallback(resp){

                            if(resp != null && resp.code != null && resp.code == YTX_WBSS_KERNEL._errcode._SUCCESS){
                                if(resp.key_value != null){
                                    // 获取数据
                                    var image_key_value = resp.key_value;

                                    //同步PageInfo信息
                                    if(!YTX_WBSS_KERNEL.setImageInfo(roomId, docId, pageIndex,
                                        image_key_value.image_width,
                                        image_key_value.image_height)){
                                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "Get Image Done, setImageInfo Failed，");
                                    }
                                    ...
                                    // 没有数据对象，请求下载
                                    YTX_WBSS_KERNEL.asynDownloadFile(roomId, docId, pageIndex, current_page_filename);
                                }
                            }

                        },function errorCallback(resp){
                            if(resp != null && resp.code != null && resp.msg != null){
                                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "Asyn getLocalDataBaseItem Failed，resp.code=" + resp.code + " resp.msg=" + resp.msg);
                            }
                        });
        ...
        asynDownloadFile: function(roomId, docId, pageIndex, current_page_filename, docInfo) {
            ...
            if(YTX_WBSS_KERNEL.isShowDebugDownLoadFile){
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====asynDownloadFile(roomId=" + roomId + ",docId=" + docId + ",filename=" + current_page_filename + ")=====");
            }
            ...
            // //服务器端，不使用 https 文件下载
            if (YTX_WBSS_KERNEL.websocket_isSSLEncrypt) {
                download_page_url = "https://" + Base64.decode(YTX_WBSS_KERNEL._file_servers_http_url[0]) + "/download";
            } else {
                 download_page_url = "http://" + Base64.decode(YTX_WBSS_KERNEL._file_servers_http_url[0]) + "/download";
            }
            ...
            download_page_XMLHttpRequest.onreadystatechange = function() {
                ...
                if(XMLHttpRequest.DONE == download_page_XMLHttpRequest.readyState){
                    ...
                    if (response_status == 200) {
                        if(YTX_WBSS_KERNEL.isShowDebugDownLoadFile){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "DownloadFile Done roomId=" + roomId + ",docId=" + docId + ",filename=" + current_page_filename + " is Done ! status=" + response_status + " datasize=" + response_datasie);
                        }else{
                            if(YTX_WBSS_KERNEL.isCurrentRoomId_DocId_PageIndex(roomId, docId, pageIndex)){
                                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "DownloadFile Done roomId=" + roomId + ",docId=" + docId + ",filename=" + current_page_filename + " is Done ! status=" + response_status + " datasize=" + response_datasie);
                            }
                        ...
                        new_page_image_obj.onload = function(){
                            if(new_page_image_obj.complete){
                                ...
                                var newImageDataInfo = new YTX_WBSS_KERNEL.ImageDataInfo(filename, download_page_BlobFile, download_page_BlobFile_URL,
                                    new_page_image_obj, image_width, image_height);

                                // Save Image Object
                                YTX_WBSS_KERNEL.asynSetLocalDataBaseItem(filename, newImageDataInfo, function(resp){

                                    //同步PageInfo信息
                                    if(!YTX_WBSS_KERNEL.setImageInfo(roomId, docId, pageIndex,
                                        image_width,
                                        image_height)){
                                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "DownloadFile Done, setImageInfo Failed，");
                                    }
                                    ...
                                    if(resp != null){
                                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "set database item failed filename=" + filename + "resp.code=" + resp.code + " resp.msg=" + resp.msg);
                                    }
                                });
                            }
                        };
                        ...
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "DownloadFile Error roomId=" + roomId + ",docId=" + docId + ",filename=" + current_page_filename + " is Failed ! status=" + response_status + " datasize=" + response_datasie);
                    }
                }else{
                    if(XMLHttpRequest.OPENED == download_page_XMLHttpRequest.readyState){
                        if(YTX_WBSS_KERNEL.isShowDebugDownLoadFile){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "DownloadFile Opened URL=" + download_page_url + " filename=" + filename);
                        }
                    }else if(XMLHttpRequest.HEADERS_RECEIVED == download_page_XMLHttpRequest.readyState){
                        if(YTX_WBSS_KERNEL.isShowDebugDownLoadFile){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "DownloadFile Received Header roomId=" + roomId + ",docId=" + docId + ",filename=" + current_page_filename);
                        }
                    }else if(XMLHttpRequest.LOADING == download_page_XMLHttpRequest.readyState){
                        if(YTX_WBSS_KERNEL.isShowDebugDownLoadFile){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "DownloadFile Loading roomId=" + roomId + ",docId=" + docId + ",filename=" + current_page_filename);
                        }
                    }else{
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "DownloadFile Unknown roomId=" + roomId + ",docId=" + docId + ",filename=" + current_page_filename + " download_page_XMLHttpRequest.readyState=" + download_page_XMLHttpRequest.readyState);
                    }
                }
            };
            ...
            download_page_XMLHttpRequest.setRequestHeader("Content-Disposition", "attachment;filename=" + filename);
      ...
      setFileToLocal: function(data) {
        ...
        var current_page_filename = current_page_info.getPageFileName();
        if (current_page_filename !== null) {
          YTX_WBSS_KERNEL.asynGetLocalDataBaseItem(current_page_filename, res => {
            if(res != null && res.code != null && res.code == YTX_WBSS_KERNEL._errcode._SUCCESS){
              ...
              if (image_key_value !== null) {
                ...
                YTX_WBSS_KERNEL.asynDownloadFile(data.roomId, data.docId, 1, current_page_filename, {
                  fileName: data.fileName
                });
              }
            }
        ...
        asynUploadFile: function(room_id, file_object, file_url, file_extra_data, onSuccess, onError, onProcess) {

            if(YTX_WBSS_KERNEL.isShowDebugUpLoadFile){
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=====asynUploadFile(roomId=" + room_id + ",file_size=" + ((file_object == null)?"null":file_object.size) +
                 ",file_url=" + ((file_url == null)?"null":file_url) + ")=====");
            }
            ...
            // //服务器端，不使用 https 文件上传
            if (YTX_WBSS_KERNEL.websocket_isSSLEncrypt) {
                upload_doc_server_url = "https://" + Base64.decode(YTX_WBSS_KERNEL._file_servers_http_url[0]) + "/upload";
            } else {
                upload_doc_server_url = "http://" + Base64.decode(YTX_WBSS_KERNEL._file_servers_http_url[0]) + "/upload";
            }
            ...
            if(file_object != null){
                ...
                file_reader_obj.onload = function loaded(evt) {
                    ...
                    upload_doc_XMLHttpRequest.onreadystatechange = function() {
                        if (XMLHttpRequest.DONE == upload_doc_XMLHttpRequest.readyState) {
                            ...
                            if (response_status == 200) {
                                ...
                                var startUpLoadTimeStampMs = YTX_WBSS_KERNEL._currentUpLoadDocObject.startUpLoadTimeStampMs;

                                // 保存信息
                                var responseText = upload_doc_XMLHttpRequest.responseText;
                                if(responseText != null && responseText.length > 0 && file_size > 0){
                                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "responseText=" + responseText);
                                    ...
                                    if(jsonResponse != null){
                                        ...
                                        if(statusCode == 0){
                                            ...
                                            wait_convert_complete_doc_obj.code = YTX_WBSS_KERNEL._errcode._UPLOAD_COVERTING_STATUS;
                                            ...
                                            wait_convert_complete_doc_obj.diffUpLoadTimeStampMs = endUpLoadTimeStampMs - startUpLoadTimeStampMs;
                                            wait_convert_complete_doc_obj.file_size = file_size;
                                            wait_convert_complete_doc_obj.timestamp_step_ms = YTX_WBSS_KERNEL._waitConvertCompletedMS;
                                            ...
                                            var total_ms = (wait_convert_complete_doc_obj.file_size/wait_convert_complete_doc_obj.file_size_step_every100ms) * 100;
                                            ...
                                            wait_convert_complete_doc_obj.timer_handle = window.setInterval(function () {
                                                wait_convert_complete_doc_obj.timeout_step_ms = wait_convert_complete_doc_obj.timeout_step_ms + YTX_WBSS_KERNEL._waitConvertCompletedMS;
                                                if(wait_convert_complete_doc_obj.timeout_step_ms > wait_convert_complete_doc_obj.timeout_total_ms){

                                                    // 清除缓存对象
                                                    delete YTX_WBSS_KERNEL._docWaitConvertCompletedMap[wait_convert_complete_doc_obj.docId];
                                                ...
                                                wait_convert_complete_doc_obj.complete_percentage = wait_convert_complete_doc_obj.complete_percentage + wait_convert_complete_doc_obj.complete_percentage_step;
                                                ...
                                                if(YTX_WBSS_KERNEL._onUploadDocProcessListener != null){
                                                    ...
                                                    respUploadDocProcess.complete_percentage = wait_convert_complete_doc_obj.complete_percentage;
                                                    YTX_WBSS_KERNEL._onUploadDocProcessListener(respUploadDocProcess);
                                                }else{
                                                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "converting filename=" + upload_filename + " complete_percentage=" + wait_convert_complete_doc_obj.complete_percentage);
                                                }
                                            }, YTX_WBSS_KERNEL._waitConvertCompletedMS);

                                            // 保存缓存
                                            YTX_WBSS_KERNEL._currentUpLoadDocObject = null;
                                            YTX_WBSS_KERNEL._docWaitConvertCompletedMap[docId] = wait_convert_complete_doc_obj;
                                        }else{
                                            YTX_WBSS_KERNEL._currentUpLoadDocObject = null;
                                            if (YTX_WBSS_KERNEL._onUploadDocProcessListener != null) {
                                                var respUploadDocProcess = {};
                                                ...
                                                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "filename=" + upload_filename + " convert error=" + statusCode);
                                            }
                                        }
                                    }else{
                                        YTX_WBSS_KERNEL._currentUpLoadDocObject = null;
                                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "UploadFile Complete Parse Json Failed");
                                    }
                                }//if(responseText != null && responseText.length > 0)
                                else{
                                    YTX_WBSS_KERNEL._currentUpLoadDocObject = null;
                                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "UploadFile Complete Error room_id=" + room_id + ",filename=" + upload_filename + " is Failed ! status=" + response_status + " datasize=" + response_datasie);
                                }
                            } else {
                                YTX_WBSS_KERNEL._currentUpLoadDocObject = null;
                                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "UploadFile Error room_id=" + room_id + ",filename=" + upload_filename + " is Failed ! status=" + response_status + " datasize=" + response_datasie);
                            }
                        }else{
                            if(XMLHttpRequest.OPENED == upload_doc_XMLHttpRequest.readyState){
                                if(YTX_WBSS_KERNEL.isShowDebugUpLoadFile){
                                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "UploadFile Opened URL=" + upload_doc_server_url + " filename=" + upload_filename);
                                }
                            }else if(XMLHttpRequest.HEADERS_RECEIVED == upload_doc_XMLHttpRequest.readyState){
                                if(YTX_WBSS_KERNEL.isShowDebugUpLoadFile){
                                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "UploadFile Received Header room_id=" + room_id + ",filename=" + upload_filename);
                                }
                            }else if(XMLHttpRequest.LOADING == upload_doc_XMLHttpRequest.readyState){
                                if(YTX_WBSS_KERNEL.isShowDebugUpLoadFile){
                                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "UploadFile Loading room_id=" + room_id + ",filename=" + upload_filename);
                                }
                            }else{
                                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "UploadFile Unknown room_id=" + room_id + ",filename=" + upload_filename + " upload_doc_XMLHttpRequest.readyState=" + upload_doc_XMLHttpRequest.readyState);
                            }
                        }
                    };
                    // 上传进度调用方法实现
                        ...
                        if (event.lengthComputable) {
                            if(YTX_WBSS_KERNEL._currentUpLoadDocObject != null){
                                ...
                                if(event.loaded > YTX_WBSS_KERNEL._currentUpLoadDocObject.file_load_size){
                                    var diff_already_load_size = event.loaded - YTX_WBSS_KERNEL._currentUpLoadDocObject.file_load_size;
                            ...
                            if (YTX_WBSS_KERNEL._onUploadDocProcessListener != null) {
                                ...
                                respUploadDocProcess.filename = upload_filename;
                                respUploadDocProcess.complete_percentage = (((event.loaded * 1.0)/(event.total * 1.0)) * 100.0) / 2;
                                if(respUploadDocProcess.complete_percentage > 50.0){
                                    respUploadDocProcess.complete_percentage = 50.0;
                                }
                                YTX_WBSS_KERNEL._onUploadDocProcessListener(respUploadDocProcess);
                            }else{
                                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "filename=" + upload_filename + " loaded=" + event.loaded + ",total=" + event.total);
                            }
                        }
                    };
                    ...
                    upload_doc_XMLHttpRequest.setRequestHeader("Content-Disposition", "attachment;filename=" + encodeURI(upload_filename));
        ...
        ImageDataInfo: function(img_json_filename, img_blob_file, img_blob_file_url, image_object, image_width, image_height) {
        ...
        openLocalDataBase: function() {
            ...
            // 初始化 table name
            YTX_WBSS_KERNEL.indexDB_dbInfo.dbName = YTX_WBSS_KERNEL.indexDB_dbInfo.dbName + "_" + YTX_WBSS_KERNEL.WBSS_SDK_VERSION_NUMBER;

            // 数据库处理
            if (window.indexedDB == null) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "Your browser does not support a stable version of IndexedDB. Such and such feature will not be available.");
                window.alert("Your browser does not support a stable version of IndexedDB. Such and such feature will not be available.")
            }
            var db_open_request = indexedDB.open(YTX_WBSS_KERNEL.indexDB_dbInfo.dbName, YTX_WBSS_KERNEL.WBSS_SDK_VERSION_NUMBER);
                ...
                if(evt.oldVersion != null && evt.newVersion != null){
                    if(evt.newVersion != evt.oldVersion){
                        ...
                        if(YTX_WBSS_KERNEL.indexDB_handle != null){
                            var isExsitObjectStore = YTX_WBSS_KERNEL.indexDB_handle.objectStoreNames.contains(YTX_WBSS_KERNEL.indexDB_dbInfo.dbStoreName);
                            if(isExsitObjectStore != true){
                                // 创建数据库表
                                var indexDB_objectStore = YTX_WBSS_KERNEL.indexDB_handle.createObjectStore(YTX_WBSS_KERNEL.indexDB_dbInfo.dbStoreName, {keyPath: YTX_WBSS_KERNEL.indexDB_dbInfo.dbIndexKeyName});
                                if(indexDB_objectStore != null){

                                    // 保存信息
                                    for(var i = 0; i < YTX_WBSS_KERNEL.indexDB_handle.objectStoreNames.length; i++){
                                        if(YTX_WBSS_KERNEL.indexDB_handle.objectStoreNames[i] == YTX_WBSS_KERNEL.indexDB_dbInfo.dbStoreName){
                                    ...
                                    // 添加索引
                                    var request_create_index = indexDB_objectStore.createIndex(YTX_WBSS_KERNEL.indexDB_dbInfo.dbIndexKeyName, YTX_WBSS_KERNEL.indexDB_dbInfo.dbIndexKeyName, { unique: true });
                                    if(request_create_index != null){
                                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "request_create_index is Failed,is not surport indexDB!");
                                    }

                                }//if(indexDB_objectStore != null)
                            }//if(isExsitObjectStore != true)
                        }//if(YTX_WBSS_KERNEL.indexDB_handle != null)
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "====== indexDB onUpgradeneeded ======");
                    }
                }
            };
            ...
            db_open_request.onsuccess = function(evt) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "====== indexDB onSuccess Start ======");
                ...
                if(YTX_WBSS_KERNEL.indexDB_handle != null){
                    ...
                    if(YTX_WBSS_KERNEL.indexDB_handle.onerror != null){
                        YTX_WBSS_KERNEL.indexDB_handle.onerror = function (evt) {
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "YTX_WBSS_KERNEL.indexDB_handle.onerror");
                        };
                    }
                    if(YTX_WBSS_KERNEL.indexDB_handle.onclose != null){
                        YTX_WBSS_KERNEL.indexDB_handle.onclose = function (evt) {
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "YTX_WBSS_KERNEL.indexDB_handle.onclose");
                        };
                    }
                    ...
                    if(YTX_WBSS_KERNEL.indexDB_handle.objectStoreNames != null){
                        var isExsitObjectStore = YTX_WBSS_KERNEL.indexDB_handle.objectStoreNames.contains(YTX_WBSS_KERNEL.indexDB_dbInfo.dbStoreName);
                        if(isExsitObjectStore != true){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "indexDb database_name=" + YTX_WBSS_KERNEL.indexDB_dbInfo.dbStoreName + " is not exsit.");
                        }else{
        ...
        asynReadIndexDB: function(key_name, asynCompletedCallback, asynErrorCallback) {
            ...
            // 保存到持久化层
            if(YTX_WBSS_KERNEL.indexDB_handle != null){
                var readwrite_transaction = YTX_WBSS_KERNEL.indexDB_handle.transaction([YTX_WBSS_KERNEL.indexDB_dbInfo.dbStoreName], "readwrite");
                if(readwrite_transaction != null){
                    var obj_store = readwrite_transaction.objectStore(YTX_WBSS_KERNEL.indexDB_dbInfo.dbStoreName);
                    if(obj_store != null){
                        ...
                        if(obj_index != null){
                            ...
                            request_index_db_get.onerror = function(event) {
                                ...
                                if(asynErrorCallback != null){
                                    ...
                                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "respError.code=" + respError.code + " respError.msg=" + respError.msg);
                                }
                            };
        ...
        asynSetLocalDataBaseItem: function(key_name, key_value, asynCompletedCallback, asynErrorCallback) {
            ...
            try {
                ...
                // 保存到持久化层
                YTX_WBSS_KERNEL.asynWriteIndexDB(key_name, key_value,function completedCallback(resp){
                    // 不返回上层
                    if(resp != null && resp.code != null && resp.msg != null){
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "asynWriteIndexDB Successed resp.code=" + resp.code + " resp.msg=" + resp.msg);
                    }
                }, function errorCallback(resp){
                    // 不返回上层
                    if(resp != null && resp.code != null && resp.msg != null){
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "asynWriteIndexDB Failed resp.code=" + resp.code + " resp.msg=" + resp.msg);
                    }
                });
            } catch (error) {
                var respError = {};
        ...
        asynGetLocalDataBaseItem: function(key_name, asynCompletedCallback, asynErrorCallback) {
            try {
                ...
                if(key_value == null){
                    ...
                    // 内存中没有数据，尝试从持久化层查找
                    YTX_WBSS_KERNEL.asynReadIndexDB(key_name, function(resp){

                        // 保存数据
                        var respSuccess = {};
                        respSuccess.code = YTX_WBSS_KERNEL._errcode._SUCCESS;
                        respSuccess.msg = "get database item value is Failed, key_name=" + key_name + "is not exsit!";
                        respSuccess.key_value = null;
                        if(resp != null && resp.code != null && resp.code == YTX_WBSS_KERNEL._errcode._SUCCESS && resp.key_value != null){
                            // 同步数据
                        ...
                        if(resp != null && resp.code != null && resp.msg != null){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "get database item asyn read indexDB resp.code=" + resp.code + " resp.msg=" + resp.msg);
                        }
                    });
                }else{
                    // 返回成功
        ...
        drawContext: {
            ...
            // 创建 Draw Data Object
            createCurrentDrawDataElementObject: function(room_id, doc_id, page_index, draw_data_obj, lastTimestampMS, maxFPS){
            ...
            startCurrentDrawDataElement: function(room_id, doc_id, page_index, mouse_event_obj) {
                ...
                //画线处理
                if((YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&        ///< 画自由线
                    YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.FREELINE) ||
                    (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&       ///< 画直线
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.LINE) ||
                    (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&       ///< 画矩形
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.RECT) ||
                    (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&       ///< 画三角形
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.TRIANGLE) ||
                    (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&       ///< 画圆
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.CIRCLE) ||
                    (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&       ///< 椭圆
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.ELLIPSE) ||
                    (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_LASER_PEN &&    ///< 激光笔
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.LASERPEN))
                {
                    ...
                    var world_coordinate_array = [];
                    YTX_WBSS_KERNEL.CANVAS_MOD.screenToWorldCoors(world_coordinate_array, curPageInfo, screen_coordinate_array);
                    if(world_coordinate_array.length <= 0){
                        return false;
                    }
                    var coordinate_array = [];
                    ...
                    var draw_id = room_id.toString() + "-" + doc_id.toString() + "-" + page_index.toString() + "-" +
                        (YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index-1].drawIDSeedNumber++) + "-" + YTX_WBSS_KERNEL._userId +
                    ...
                    current_draw_data_object["drawAreaHeight"] = Math.round(curPageInfo.last_draw_space_height);
                    ...
                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject = new YTX_WBSS_KERNEL.drawContext.createCurrentDrawDataElementObject(room_id, doc_id, page_index, current_draw_data_object, nowTimeStampMS, send_msg_max_fps);
                    if(YTX_WBSS_API._shapeType.LASERPEN == YTX_WBSS_KERNEL.drawContext.drawShapeType){
                        // 发送渲染消息
                        var sendStr = YTX_WBSS_KERNEL._protobuf._buildDrawData(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj);
                        if (sendStr != null && sendStr.length > 0) {
                            YTX_WBSS_KERNEL.sendWebSocketMsg(sendStr);
                        }
                    }//if(YTX_WBSS_API._shapeType.LASERPEN == YTX_WBSS_KERNEL.drawContext.drawShapeType)

                }else if(YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_ERASER &&        ///< 元素橡皮擦
                    YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.ERASER_DRAW_ID){
                        if(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject == null){
                            if(mouse_event_obj != null && mouse_event_obj.x != null && mouse_event_obj.y != null){
                                ...
                                // 查找DrawID
                                var find_draw_id = curPageInfo.findDrawDataElement(mouse_event_obj.x, mouse_event_obj.y);
                                if(find_draw_id != null && find_draw_id.length > 0){
                                    // 发送渲染消息
                                    var sendStr = YTX_WBSS_KERNEL._protobuf._buildDeleteElement(room_id, doc_id, page_index, find_draw_id);
                                    if (sendStr != null && sendStr.length > 0) {
                                        YTX_WBSS_KERNEL.sendWebSocketMsg(sendStr);
                                    }
                                }
                    ...
                    if(YTX_WBSS_KERNEL.isShowDebugManagerDrawDataElement){
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN,"startCurrentDrawDataElement(" + YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.order_index + ")");
                    }
                }
            },
                ...
                if(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject != null){
                        ...
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.FREELINE)
                    {
                        ...
                        if(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj != null){
                            ...
                            // 添加坐标
                            var coordinates_length = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.length;
                            if(coordinates_length >= 2){
                                var A_x = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates[coordinates_length-2];
                                var A_y = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates[coordinates_length-1];
                            ...
                            YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.push(world_coordinate_array[0].x);
                            YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.push(world_coordinate_array[0].y);

                            // 获取时间戳
                            var nowTimeStampMS = new Date().getTime();
                            var diff_nowTimeStampMS = nowTimeStampMS - YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastTimestampMS;
                            var diff_fps_ms = 1000.0 / YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgMaxFPS;

                            // 处理坐标
                            if(diff_nowTimeStampMS > diff_fps_ms){ // 根据帧率发送消息

                                coordinates_length = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.length;
                                if((YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber == 0 && coordinates_length >= 4) ||
                                    (YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber != 0 && coordinates_length > YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber)){

                                    // 保存对象
                                    var old_draw_data_object_coordinates = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates;      ///< 备份数据，处理完后恢复
                                    var new_draw_data_object_coordinates = [];
                                    for(var i = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber; i < coordinates_length; i++){
                                        new_draw_data_object_coordinates.push(old_draw_data_object_coordinates[i]);
                                    }

                                    // 发送渲染消息
                                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates = new_draw_data_object_coordinates;
                                    var sendStr = YTX_WBSS_KERNEL._protobuf._buildDrawData(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj);
                                    if (sendStr != null && sendStr.length > 0) {
                                        YTX_WBSS_KERNEL.sendWebSocketMsg(sendStr);
                                    }
                                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates = old_draw_data_object_coordinates;

                                    // 保存更新
                                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastTimestampMS = nowTimeStampMS;
                                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber = coordinates_length;
                                }
                            }

                        }//if(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj != null)
                    }
                    else if((YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&       ///< 画直线
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.LINE) ||
                        (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&           ///< 矩形
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.RECT) ||
                        (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&           ///< 画三角形
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.TRIANGLE) ||
                        (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&           ///< 画圆
                        ...
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.LASERPEN))
                    {
                        ...
                        if(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj != null){
                            ...
                            if(YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.LASERPEN){
                                if(coordinates_length >= 2){
                                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates[0] = world_coordinate_array[0].x;
                                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates[1] = world_coordinate_array[0].y;
                                }else{
                                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.push(world_coordinate_array[0].x);
                                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.push(world_coordinate_array[0].y);
                                }
                                ...
                                if(coordinates_length <= 2){
                                    ...
                                    if(YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.TRIANGLE){
                                        YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.push(-1);
                                        YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.push(-1);
                                    }
                                }else{
                                    // 更新坐标
                                    if(world_coordinate_array.length > 0){
                                        YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates[2] = world_coordinate_array[0].x;
                                        YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates[3] = world_coordinate_array[0].y;
                                    }//if(world_coordinate_array.length > 0)
                                }
                            }
                            ...
                            if(diff_nowTimeStampMS > diff_fps_ms){ // 根据帧率发送消息
                                ...
                                coordinates_length = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.length;
                                if(coordinates_length >= 4 ||
                                    (coordinates_length >= 2 && YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.LASERPEN)){
                                    ...
                                    if(diff_nowTimeStampMS > (diff_fps_ms * 2)){
                                        YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastTimestampMS = nowTimeStampMS;   ///< 如果时差太大，同步到当前时间
                                    }
                                    else{
                                        YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastTimestampMS += diff_fps_ms;     ///< 正常补加时间
                                    }
                                    YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber += coordinates_length;
                                }
                            }
                        ...
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.ERASER_DRAW_ID){
                            if(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject != null){
                                if(mouse_event_obj != null && mouse_event_obj.x != null && mouse_event_obj.y != null){
                                    var current_draw_data_object = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj;
                        ...
                        // Show Log
                        if(YTX_WBSS_KERNEL.isShowDebugManagerDrawDataElement){
                            YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO,"updateCurrentDrawDataElement(" + YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.order_index + ")");
                        }
                    }
                ...
                if(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject != null){
                        ...
                        YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.FREELINE)
                    {
                        ...
                        if(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj != null){
                            ...
                            // 保存发送出最后数据
                            var coordinates_length = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.length;
                            if(coordinates_length >= YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber){
                    ...
                    // Show Log
                    if(YTX_WBSS_KERNEL.isShowDebugManagerDrawDataElement){
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN,"endCurrentDrawDataElement(" + YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.order_index + ")");
                    }
            ...
            createTextDrawDataElement: function(font_pos, font_text, font_textsize, font_type, onSuccess, onError) {

                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "=======createTextDrawDataElement=======");
                ...
                if(!(YTX_WBSS_KERNEL.drawContext.drawToolStatus = YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL &&         ///< 字体
                ...
                if (font_pos != null && font_text != null && font_textsize != null && font_type != null && curPageInfo != null &&
                    font_pos.x != null && font_pos.y != null && font_text.length > 0 && font_textsize > 0) {

                    // 位置校验
                    var canvas_x = font_pos.x;
                    var canvas_y = font_pos.y;
                    if((canvas_x >= (curPageInfo.last_draw_space_fromX) && canvas_x <= (curPageInfo.last_draw_space_fromX + curPageInfo.last_draw_space_width)) &&
                        (canvas_y >= (curPageInfo.last_draw_space_fromY) && canvas_y <= (curPageInfo.last_draw_space_fromY + curPageInfo.last_draw_space_height))){
                        ...
                        if(world_coordinate_array.length > 0){
                            ...
                            current_draw_data_object["lineSize"] = ((font_textsize > 0)?font_textsize:(YTX_WBSS_KERNEL.drawContext.lineSize));
                            current_draw_data_object["isFill"] = false;
                            current_draw_data_object["drawAreaWidth"] = Math.round(curPageInfo.last_draw_space_width);
                            current_draw_data_object["drawAreaHeight"] = Math.round(curPageInfo.last_draw_space_height);
        ...
        CANVAS_MOD: {
            ...
            registerMouseEvent: function() {
                if (YTX_WBSS_KERNEL.isRegisterMouserEvent == false) {
                    ...
                    YTX_WBSS_KERNEL.canvas_html_handle.addEventListener("mousedown", YTX_WBSS_KERNEL.CANVAS_MOD.doMouseDown, false);
                    YTX_WBSS_KERNEL.canvas_html_handle.addEventListener("mousemove", YTX_WBSS_KERNEL.CANVAS_MOD.doMouseMove, false);
                    YTX_WBSS_KERNEL.canvas_html_handle.addEventListener("mouseup", YTX_WBSS_KERNEL.CANVAS_MOD.doMouseUp, false);
                    YTX_WBSS_KERNEL.canvas_html_handle.addEventListener("mouseleave", YTX_WBSS_KERNEL.CANVAS_MOD.doMouseLeave, false);
            ...
            removeMouseEvent: function() {
                if (YTX_WBSS_KERNEL.isRegisterMouserEvent == true) {
                    YTX_WBSS_KERNEL.canvas_html_handle.removeEventListener("mousedown", YTX_WBSS_KERNEL.CANVAS_MOD.doMouseDown, false);
                    YTX_WBSS_KERNEL.canvas_html_handle.removeEventListener("mousemove", YTX_WBSS_KERNEL.CANVAS_MOD.doMouseMove, false);
                    YTX_WBSS_KERNEL.canvas_html_handle.removeEventListener("mouseup", YTX_WBSS_KERNEL.CANVAS_MOD.doMouseUp, false);
                    YTX_WBSS_KERNEL.canvas_html_handle.removeEventListener("mouseleave", YTX_WBSS_KERNEL.CANVAS_MOD.doMouseLeave, false);
            ...
            doMouseEventProc: function(mouseEventStatus, event) {
                ...
                if (current_draw_page_info != null) {
                    ...
                    if(current_draw_page_info.last_canvas_height == 0 || current_draw_page_info.last_canvas_height == 0){
                        if(YTX_WBSS_KERNEL.canvas_html_handle != null){
                            ...
                            if(canvas_context != null){
                                ...
                                if(current_room_id != null && current_doc_id != null && current_page_index != null && current_room_info != null && current_doc_info != null){
                                    // 更新画布布局信息（需要使用白板和文档的比例，适应canvas的大小改变，使用缩放比例）
                                    var isChangedDrawSpaceRect = false;
                                    isChangedDrawSpaceRect = YTX_WBSS_KERNEL.CANVAS_MOD.updateDrawClientRect(canvas_context, current_room_id, current_doc_id, current_page_index, current_room_info, current_doc_info, current_draw_page_info);
                    ...
                    // 获取mouse在canvas的相对坐标
                    var mouse_event_obj = YTX_WBSS_KERNEL.CANVAS_MOD.getPointOnCanvas(current_draw_page_info, event);
                    if(mouse_event_obj != null){

                        // 输出日志
                        if(YTX_WBSS_KERNEL.isShowDebugMouseEventCoors){
                            YTX_WBSS_KERNEL._log((mouse_event_obj.isInCanvasRect?YTX_WBSS_KERNEL._logLev._DEBUG:YTX_WBSS_KERNEL._logLev._WARN),
                                "mouse " + YTX_WBSS_KERNEL.CANVAS_MOD.getMouseEventStatusNameString(mouseEventStatus) +
                                " at point( x:" + mouse_event_obj.x + ", y:" + mouse_event_obj.y + ") inRect=" + mouse_event_obj.isInCanvasRect);
                        }

                        // 事件处理
                        switch(mouseEventStatus){
                            case YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_STATUS.MOUSE_EVENT_STATUS_DOWN:{
                                if(mouse_event_obj.buttonKey == YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_KEY.MOUSE_EVENT_KEY_LEFT){
                                    if(mouse_event_obj.isInCanvasRect == true){
                                        var room_id = YTX_WBSS_KERNEL.getCurRoomId();
                                        var doc_id = YTX_WBSS_KERNEL.getCurDocId();
                                        var page_index = YTX_WBSS_KERNEL.getCurPageIndex();
                                        YTX_WBSS_KERNEL.drawContext.startCurrentDrawDataElement(room_id, doc_id, page_index, mouse_event_obj);
                                    }
                                }
                            }break;
                            ...
                            case YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_STATUS.MOUSE_EVENT_STATUS_UP:{
                                if(mouse_event_obj.buttonKey == YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_KEY.MOUSE_EVENT_KEY_NONE ||
                                    mouse_event_obj.buttonKey == YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_KEY.MOUSE_EVENT_KEY_LEFT){
                                    YTX_WBSS_KERNEL.drawContext.endCurrentDrawDataElement(mouse_event_obj);// mouse_event_obj or null
                                }
                            }break;
            ...
            doMouseDown: function(event) {
                if (YTX_WBSS_KERNEL.isRegisterMouserEvent == true) {
                    YTX_WBSS_KERNEL.CANVAS_MOD.doMouseEventProc(YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_STATUS.MOUSE_EVENT_STATUS_DOWN, event);
                }
            },
            ...
            doMouseMove: function(event) {
                if (YTX_WBSS_KERNEL.isRegisterMouserEvent == true) {
                    YTX_WBSS_KERNEL.CANVAS_MOD.doMouseEventProc(YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_STATUS.MOUSE_EVENT_STATUS_MOVE, event);
                }
            },
            ...
            doMouseUp: function(event) {
                if (YTX_WBSS_KERNEL.isRegisterMouserEvent == true) {
                    YTX_WBSS_KERNEL.CANVAS_MOD.doMouseEventProc(YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_STATUS.MOUSE_EVENT_STATUS_UP, event);
                }
            },
            ...
            doMouseLeave: function(event) {
                if (YTX_WBSS_KERNEL.isRegisterMouserEvent == true) {
                    YTX_WBSS_KERNEL.CANVAS_MOD.doMouseEventProc(YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_STATUS.MOUSE_EVENT_STATUS_LEAVE, event);
                }
            },
            ...
            getPointOnCanvas: function(page_info, event) {
                ...
                var mouse_button_key_value =  YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_KEY.MOUSE_EVENT_KEY_NONE;
                ...
                if(page_info != null){
                    ...
                    if(YTX_WBSS_KERNEL.canvas_html_handle != null){
                        ...
                        YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "getPointOnCanvas is unknow limit condition!");
                        return null;
                    }
                }
                ...
                if(event.buttons != null && event.button != null){
                    if(event.buttons > 0){
                        switch(event.button){
                            case 0:{
                                mouse_button_key_value =  YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_KEY.MOUSE_EVENT_KEY_LEFT;
                            }break;
                            case 1:{
                                mouse_button_key_value =  YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_KEY.MOUSE_EVENT_KEY_MIDDLE;
                            }break;
                            case 2:{
                                mouse_button_key_value =  YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_KEY.MOUSE_EVENT_KEY_RIGHT;
                            }break;
                        }
                    }
                }

                return { x: mouse_canvas_fromX, y: mouse_canvas_fromY, buttonKey: mouse_button_key_value, isInCanvasRect: local_isInCanvasRect };
            },
            ...
            ParseColorIntTo16String: function(colorInt) {
                ...
                return "#" + YTX_WBSS_KERNEL.CANVAS_MOD.colorChannelHexStringFormat(r) + YTX_WBSS_KERNEL.CANVAS_MOD.colorChannelHexStringFormat(g) +
                    YTX_WBSS_KERNEL.CANVAS_MOD.colorChannelHexStringFormat(b) + YTX_WBSS_KERNEL.CANVAS_MOD.colorChannelHexStringFormat(a);
            },
            colorChannelHexStringFormat: function(colorChannelHexString) {
                return (colorChannelHexString.length == 2 ? colorChannelHexString : ("0" + colorChannelHexString));
            },

            clearCanvasDrawSpace: function(canvas_context, current_page_info) {

                // 清空画布所有信息
                canvas_context.clearRect(0, 0, current_page_info.last_canvas_width, current_page_info.last_canvas_height);
                ...
                if(current_page_info.last_image_width == 0 && current_page_info.last_image_height == 0){
                    ...
                    canvas_context.fillRect(current_page_info.last_draw_space_fromX, current_page_info.last_draw_space_fromY,
                        current_page_info.last_draw_space_width, current_page_info.last_draw_space_height);
                }else{
                    ...
                    if(img_filename != null){
                        ...
                        if(currentImageDataInfo != null){
                          ...
                          canvas_context.clearRect(0, 0, current_page_info.last_canvas_width, current_page_info.last_canvas_height);
                          canvas_context.drawImage(currentImageDataInfo.image_object, 0, 0,
                            currentImageDataInfo.image_width, currentImageDataInfo.image_height,
                            current_page_info.last_draw_space_fromX, current_page_info.last_draw_space_fromY,
                            current_page_info.last_draw_space_width, current_page_info.last_draw_space_height);
                          canvas_image.drawImage(currentImageDataInfo.image_object, 0, 0,
                            currentImageDataInfo.image_width, currentImageDataInfo.image_height,
                            current_page_info.last_draw_space_fromX, current_page_info.last_draw_space_fromY,
                            current_page_info.last_draw_space_width, current_page_info.last_draw_space_height);
                ...
                if(YTX_WBSS_KERNEL.drawContext.canvas_frame_bg_linesize > 0){
                    ...
                    canvas_context.strokeRect(0, 0, current_page_info.last_canvas_width, current_page_info.last_canvas_height);
                }
            },
            ...
            // 更新画布布局信息
            updateDrawClientRect: function(canvas_context, current_room_id, current_doc_id, current_page_index, current_room_info, current_doc_info, current_page_info) {
                ...
                if(current_canvas_width > 0 && current_canvas_height > 0){
                    if((current_canvas_width != YTX_WBSS_KERNEL.canvas_html_handle.width) ||
                ...
                if(current_doc_id == 0){
                    ...
                    if(current_page_info.last_image_width > 0 && current_page_info.last_image_height > 0){
                        current_draw_space_ratio = 1.0 * current_page_info.last_image_width / current_page_info.last_image_height;
                    }
                }

                //Canvas大小、缩放比例，画布比例有变化时，更新画布布局
                if ((current_page_info.last_draw_space_ratio != current_draw_space_ratio) ||
                    ...
                    // Show Log
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "updateDrawClientRect doc_id=" + current_doc_id + " pageindex=" + current_page_index +
                        " width=" + current_canvas_width + " height=" + current_canvas_height +
                        " ratio=" + current_draw_space_ratio + " scale=" + current_draw_space_ifSacle);

                    // 最后保存的canvas信息
                    YTX_WBSS_KERNEL.setDrawSpaceInfo(current_room_id, current_doc_id, current_page_index,
                        current_canvas_width, current_canvas_height, current_draw_space_ratio, current_draw_space_ifSacle);
            ...
            drawScreen: function() {
                ...
                if (current_room_info == null || current_doc_info == null || current_page_info == null) {
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "drawScreen the room、doc、page info is null");
                    return false;
                }

                // 获取CanvasContext
                if(YTX_WBSS_KERNEL.canvas_html_handle == null){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "drawScreen the canvas_html_handle is null");
                    return false;
                }
                var canvas_context = YTX_WBSS_KERNEL.canvas_html_handle.getContext("2d");
                if(canvas_context == null){
                    YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._WARN, "drawScreen the canvas_context is null");
                    return false;
                }
                ...
                // 更新画布布局信息（需要使用白板和文档的比例，适应canvas的大小改变，使用缩放比例）
                var isChangedDrawSpaceRect = false;
                isChangedDrawSpaceRect = YTX_WBSS_KERNEL.CANVAS_MOD.updateDrawClientRect(canvas_context, current_room_id, current_doc_id, current_page_index, current_room_info, current_doc_info, current_page_info);
                ...
                for (var i = 0; i < current_page_info.drawDataElementArray.length; i++) {
                    ...
                    // 数据过滤
                    if ((draw_data_element == null) || (draw_data_element._isValid == false) || (draw_data_element._isUndo == true)){
                        continue;
                    }

                    // 世界坐标转换相对canvas坐标
                    var draw_space_in_coordinate_array = [];
                    YTX_WBSS_KERNEL.CANVAS_MOD.worldToScreenCoors(draw_space_in_coordinate_array, current_page_info, draw_data_element._coordinate_array);

                    // 设置线宽
                    canvas_context.lineWidth = YTX_WBSS_KERNEL.CANVAS_MOD.getZoomWidth(draw_data_element._lineSize, draw_data_element._drawAreaWidth, current_page_info.last_draw_space_width);

                    // 获取颜色
                    var current_color_hex_string = YTX_WBSS_KERNEL.CANVAS_MOD.ParseColorIntTo16String(draw_data_element._element_color_num);
                    var current_color_rgba_string = YTX_WBSS_KERNEL.CANVAS_MOD.ParseColorIntToRgbaString(draw_data_element._element_color_num);
                    ...
                    switch (draw_data_element._shapeType) {
                        case YTX_WBSS_API._shapeType.FREELINE:{
                          ...
                          var isEraser = draw_data_element._element_color_num == -1 || draw_data_element._element_color_num == 0;
                                if(draw_space_in_coordinate_array.length >= 2){
                                  ...
                                  if(current_color_hex_string != null){
                                    ...
                                    for (var j = 0; j < draw_space_in_coordinate_array.length; j++) {
                                        ...
                                        if(cur_x != last_x && cur_y != last_y){                     ///< 防止重复坐标
                                          if(isEraser) {
                        ...
                        case YTX_WBSS_API._shapeType.TRIANGLE:{
                                ...
                                if(draw_space_in_coordinate_array.length >= 3){
                                    ...
                                    var pos_c_x = 2 * draw_space_in_coordinate_array[0].x - draw_space_in_coordinate_array[1].x;
                                    ...
                                    canvas_context.moveTo(draw_space_in_coordinate_array[0].x, draw_space_in_coordinate_array[0].y);
                                    canvas_context.lineTo(draw_space_in_coordinate_array[1].x, draw_space_in_coordinate_array[1].y);
                                    canvas_context.lineTo(pos_c_x, pos_c_y);
                                    canvas_context.lineTo(draw_space_in_coordinate_array[0].x, draw_space_in_coordinate_array[0].y);
                                    if(draw_data_element._isFill){
                        ...
                        case YTX_WBSS_API._shapeType.CIRCLE:{
                                ...
                                if(draw_space_in_coordinate_array.length >= 2){
                                    ...
                                    var circle_center_x = (draw_space_in_coordinate_array[0].x + draw_space_in_coordinate_array[1].x) / 2;
                                    var circle_center_y = (draw_space_in_coordinate_array[0].y + draw_space_in_coordinate_array[1].y) / 2;
                                    var circle_radius = YTX_WBSS_KERNEL.MathLib.twoPointsDistance({x:circle_center_x,y:circle_center_y},draw_space_in_coordinate_array[0]);
                                    canvas_context.arc(circle_center_x, circle_center_y, circle_radius, 0, Math.PI*2, true); ///< arc方法参数：圆心X坐标，圆心Y坐标，半径，开始角度（弧度），结束角度弧度，是否按照顺时针画
                                    if(draw_data_element._isFill){
                                        canvas_context.fill();                ///< 实心填充
                                    }else{
                                        canvas_context.stroke();              ///< 外形连线
                        ...
                        case YTX_WBSS_API._shapeType.ELLIPSE:{
                                ...
                                if(draw_space_in_coordinate_array.length >= 2){
                                    ...
                                    var ellipse_center_x = (draw_space_in_coordinate_array[0].x + draw_space_in_coordinate_array[1].x) / 2;
                                    var ellipse_center_y = (draw_space_in_coordinate_array[0].y + draw_space_in_coordinate_array[1].y) / 2;
                                    var ellipse_w_radius = Math.abs(draw_space_in_coordinate_array[1].x - draw_space_in_coordinate_array[0].x) / 2;
                                    var ellipse_h_radius = Math.abs(draw_space_in_coordinate_array[1].y - draw_space_in_coordinate_array[0].y) / 2;
                                    canvas_context.ellipse(ellipse_center_x, ellipse_center_y, ellipse_w_radius, ellipse_h_radius, 0, 0, Math.PI*2);
                                    if(draw_data_element._isFill){
                                        canvas_context.fill();                ///< 实心填充
                                    }else{
                                        canvas_context.stroke();              ///< 外形连线
                        ...
                        case YTX_WBSS_API._shapeType.FONT:{
                                ...
                                if(draw_space_in_coordinate_array.length >= 1){
                                    ...
                                    canvas_context.fillStyle = current_color_hex_string;
                                    canvas_context.fillText(canvas_text, draw_space_in_coordinate_array[0].x, draw_space_in_coordinate_array[0].y + canvas_text_linesize);
                                    canvas_context.closePath();
                ...
                if(laserPenDrawDataElementIndexArray.length > 0){
                    ...
                    if(laserPenDrawDataElementIndexArray.length > 0){
                        ...
                        for(var i = 0; i < laserPenDrawDataElementIndexArray.length; i++){
                            ...
                            var draw_data_element = current_page_info.drawDataElementArray[draw_data_element_index];
                            if(draw_data_element != null){
                                ...
                                if(draw_space_in_coordinate_array.length > 0){
                                    ...
                                    canvas_context.arc(draw_space_in_coordinate_array[0].x, draw_space_in_coordinate_array[0].y, circle_radius, 0, Math.PI*2, true);
                                    // if(draw_data_element._isFill){
                                        canvas_context.fill();                ///< 实心填充
                                    // }else{
                                    //     canvas_context.stroke();              ///< 外形连线
                ...
                if(current_page_info != null){
                    if((current_page_info.last_canvas_width > 0) && (current_page_info.last_canvas_height > 0) &&
                        (current_page_info.last_draw_space_width > 0) && (current_page_info.last_draw_space_height) &&
                        ...
                        var right_rect_w = 0;
                        var right_rect_h = 0;
                        if((current_page_info.last_canvas_width > current_page_info.last_draw_space_width) &&
                            (current_page_info.last_canvas_height == current_page_info.last_draw_space_height)){
                            left_rect_w = (current_page_info.last_canvas_width - current_page_info.last_draw_space_width) / 2;
                        ...
                        }else if((current_page_info.last_canvas_width == current_page_info.last_draw_space_width) &&
                            (current_page_info.last_canvas_height > current_page_info.last_draw_space_height)){
                            left_rect_w = current_page_info.last_canvas_width;
                            left_rect_h = (current_page_info.last_canvas_height - current_page_info.last_draw_space_height) / 2;
                            right_rect_x = 0;
                        ...
                        if((left_rect_w > 0 && left_rect_h > 0) || (right_rect_w > 0 && right_rect_h > 0)){
                            if(current_page_info.last_image_width == 0 && current_page_info.last_image_height == 0){
                                // 白板模式
                                canvas_context.fillStyle = YTX_WBSS_KERNEL.drawContext.color_whiteboard_undraw_area_bg;
                            }else{
                                // 图片模式
                ...
                // Show Log
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._DEBUG, "drawScreen(" + YTX_WBSS_KERNEL.drawContext.drawCountTotalNumber + ") ClientRectChanged=" + isChangedDrawSpaceRect + " " + current_page_info.drawDataElementArray.length + "/" + draw_element_num);
            ...
            getScreenImage: function(img_type) {
                if(YTX_WBSS_KERNEL.canvas_html_handle != null){
                    if(img_type != null){
                        if(!((img_type == "image/jpeg") || (img_type == "image/png") || (img_type == "image/webp"))){
                            img_type = null;
                        }
                    }
                    if(img_type == null){
                    ...
                    var img_blob_url = YTX_WBSS_KERNEL.canvas_html_handle.toDataURL("image/jpeg", default_quality);
                    return img_blob_url;
                }
                return null;
            }
    ...
    window.YTX_WBSS_API = {
        ...
        checkWebSurportAbility: function() {
            ...
            if (YTX_WBSS_KERNEL._isSurportWebSocket && YTX_WBSS_KERNEL._isSurportFileReader && YTX_WBSS_KERNEL._isSurportCanvas) {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._INFO, "this brower is support H5 . Version is " + navigator.appVersion + ". vendor:" + navigator.vendor + ". Is online :" + navigator.onLine + " version:" + YTX_WBSS_KERNEL.WBSS_SDK_VERSION_STRING);
                return true;
            } else {
                YTX_WBSS_KERNEL._log(YTX_WBSS_KERNEL._logLev._ERROR, "sorry, your brower not support H5 isSurportWebSocket=" + YTX_WBSS_KERNEL._isSurportWebSocket + " isSurportFileReader=" + YTX_WBSS_KERNEL._isSurportFileReader + " isSurportCanvas=" + YTX_WBSS_KERNEL._isSurportCanvas);
                return false;
            }
        ...
        createRoom: function(createRoomBuilder, callback, onError) {
            ...
            YTX_WBSS_KERNEL._requestRestServer(-1, function callback_wbss_room_start() {
                //发送创建房间
                var sendReqCreateRoomJsonStr = YTX_WBSS_KERNEL._protobuf._buildCreateRoom(createRoomBuilder, callback, onError);
        ...
        joinRoom: function(joinRoomBuilder, callback, onError) {
            ...
            YTX_WBSS_KERNEL._requestRestServer(joinRoomBuilder.getRoomId(), function callback_wbss_room_start() {
                //发送加入房间
                var sendReqJoinRoomJsonStr = YTX_WBSS_KERNEL._protobuf._buildJoinRoom(joinRoomBuilder, callback, onError);
                if (sendReqJoinRoomJsonStr != null && sendReqJoinRoomJsonStr.length > 0) {
                    YTX_WBSS_KERNEL.sendWebSocketMsg(sendReqJoinRoomJsonStr)
                }
            }, onError);
        ...
        deleteRoom: function(deleteRoomBuilder, callback, onError) {
            ...
            var sendStr = YTX_WBSS_KERNEL._protobuf._buildDeleteRoom(deleteRoomBuilder, callback, onError);
            if (sendStr != null) {
                YTX_WBSS_KERNEL.sendWebSocketMsg(sendStr);
        ...
        leaveRoom: function(leaveRoomBuilder, callback, onError) {
            ...
            var sendJsonStr = YTX_WBSS_KERNEL._protobuf._buildLeaveRoom(leaveRoomBuilder, callback, onError);
            ...
            if(YTX_WBSS_KERNEL.isLoginInRoomServer){
                ...
                if(current_page_info != null){
                    if(current_page_info.last_draw_space_width > 0 && current_page_info.last_draw_space_height > 0){
                        draw_space_rect_info = {x:current_page_info.last_draw_space_fromX,
        ...
        setLineShape: function(shape) {
          ...
          YTX_WBSS_KERNEL.drawContext.isEraser = false;
            if (YTX_WBSS_API._shapeType.FREELINE == YTX_WBSS_KERNEL.drawContext.drawShapeType ||
                ...
                YTX_WBSS_KERNEL.drawContext.drawToolStatus = YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL;
            }else if (YTX_WBSS_API._shapeType.LASERPEN == YTX_WBSS_KERNEL.drawContext.drawShapeType) {
                YTX_WBSS_KERNEL.drawContext.drawToolStatus = YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_LASER_PEN;
            }else if (YTX_WBSS_API._shapeType.FONT == YTX_WBSS_KERNEL.drawContext.drawShapeType) {
                YTX_WBSS_KERNEL.drawContext.drawToolStatus = YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL;
            }else if(YTX_WBSS_API._shapeType.ERASER_DRAW_ID == YTX_WBSS_KERNEL.drawContext.drawShapeType){
                YTX_WBSS_KERNEL.drawContext.drawToolStatus = YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_ERASER;
            } else if(YTX_WBSS_API._shapeType.ERASER_DRAW_LINE == YTX_WBSS_KERNEL.drawContext.drawShapeType) {
              YTX_WBSS_KERNEL.drawContext.drawShapeType = YTX_WBSS_API._shapeType.FREELINE;
              YTX_WBSS_KERNEL.drawContext.drawToolStatus = YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL;
        ...
        setDeleteModel: function() {
            YTX_WBSS_KERNEL.drawContext.drawToolStatus = YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_DELETE;
        },
        setMoveModel: function() {
            YTX_WBSS_KERNEL.drawContext.drawToolStatus = YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_ZOOM;
        },
        ...
        addText: function(font_pos, font_text, font_textsize, font_type, onSuccess, onError) {
            return YTX_WBSS_KERNEL.drawContext.createTextDrawDataElement(font_pos, font_text, font_textsize, font_type, onSuccess, onError);
        },
        ...
        uploadDoc: function(file_object, onSuccess, onError, onProcess) {
            ...
            return YTX_WBSS_KERNEL.asynUploadFile(room_id, file_object, null, null, onSuccess, onError, onProcess);
        },

        // 上传文件
        uploadDocURL: function(file_url, file_url_json_string_extra_data, onSuccess, onError, onProcess) {
            ...
            return YTX_WBSS_KERNEL.asynUploadFile(room_id, null, file_url, file_url_json_string_extra_data, onSuccess, onError, onProcess);
        },
