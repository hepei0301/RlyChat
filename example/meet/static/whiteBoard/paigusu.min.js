	...
	g.prototype = {
		...
		initDefaultColor: function() {
			...
			if(1 == a.length) {
				...
				var d = this.rgbToHex(b),
					e = this.rgbToHsb(b)
			} else 3 == a.length ? (b = a[0], d = a[1], e = a[2], a = 1) : 4 == a.length ? (b = a[0], d = a[1], e = a[2], a = a[3]) : (b = 42, d = 0, e = 255, a = 1), b = {
		...
		latelyColor: function() {
			if(this.options.recommend) {
				...
				b ? b = b.split("-") : (b = "0,0,51,1 0,51,102,1 0,102,153,1 0,153,204,1 0,204,255,1 102,0,51,1 102,51,102,1 102,102,153,1 102,204,204,1 102,255,255,1".split(" "), a.setItem("paigusu-lately", b.join("-")));
		...
		on: function() {
			...
			c("#paigusu-tab").off().on("click", function() {
				c("#paigusu-rgba").is(":hidden") ? (c("#paigusu-rgba").show(), c("#paigusu-rex").hide()) : (c("#paigusu-rgba").hide(), c("#paigusu-rex").show())
			});
			...
			c("#paigusu-alpha").off().on("mousedown", function(b) {
				...
				b = b || f.event;
				f.paigusualpha && (c("#paigusu-alpha-btn").css("left", b.offsetX - 6), a.options.color.a = parseFloat(((0 > b.offsetX ? 0 : b.offsetX) / 160).toFixed(1)), a.setInputColor())
			}).on("mouseup", function() {
				f.paigusualpha = !1
			}).on("mouseleave", function() {
				f.paigusualpha = !1
