webpackJsonp([3], {
  ...
  /***/ feWf: /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          switch (auditType) {
            ...
            case '14':
              ...
              if (
                ...
                (msg.msgDomain && msg.msgDomain.admin == store['a' /* default */].state.user_account)
              ) {
                  ...
                  [
                    _c(
                      'el-input',
                      {
                        ...
                        attrs: { disabled: _vm.personList.length == _vm.len, placeholder: '请输入被邀请者账号' },
                        model: {
                          value: _vm.person.account,
                          callback: function ($$v) {
                            _vm.$set(_vm.person, 'account', typeof $$v === 'string' ? $$v.trim() : $$v);
                          },
    ...
    var Component = normalizeComponent(addPerson, model_addPerson, __vue_template_functional__, __vue_styles__, __vue_scopeId__, __vue_module_identifier__);
      ...
      return _c('div', { staticClass: 'container' }, [
        _c('div', { staticClass: 'main' }, [
          _c('p', { staticClass: 'title' }, [
            ...
            _vm._v(' '),
            _c('span', { staticClass: 'btn' }, [_c('i', { on: { click: _vm.meetInviteHangup } }, [_vm._v('×')])]),
          ]),
          _vm._v(' '),
          _c('div', { staticClass: 'btnGroup' }, [
            _c('span', { staticClass: 'rx_cancel cancel', on: { click: _vm.meetInviteHangup } }, [_vm._v(_vm._s(_vm.$t('btn.refuse')))]),
            _vm._v(' '),
            _c('span', { staticClass: 'rx_btn confirm', on: { click: _vm.hangOn } }, [_vm._v(_vm._s(_vm.hangOnText))]),
          ]),
        ]),
      ]);
    };
      ...
      return _c('div', { staticClass: 'bg' }, [
              ...
              ? _c('div', { staticClass: 'selfInfo' }, [
                  _c('dl', [
                    _c('dt', { staticClass: 'headimg' }, [
                      _c('span', { staticClass: 'img', style: { backgroundImage: _vm.getcolor(_vm.LoginServe.UserId) } }, [
                        _vm._v(_vm._s(_vm.LoginServe.Profile.NickName)),
                      ]),
                    ]),
                    _vm._v(' '),
                    _c('dd', { staticClass: 'userName' }, [_vm._v(_vm._s(_vm.LoginServe.Profile.NickName))]),
                  ]),
                  _vm._v(' '),
                  _c(
                    'div',
        ...
        _vm.addPersonFlag
          ? _c(
              ...
              [
                _c('add-person', {
                  attrs: { len: _vm.len, closeAddModal: _vm.addModelFlag, selected: _vm.selected, callback: _vm.callback, disabled: _vm.disabled },
                }),
              ],
              1
            )
          : _vm._e(),
        _vm._v(' '),
        _vm.v3InviteModel ? _c('div', { staticClass: 'shadow v3InviteModel' }, [_c('invite-model', { attrs: { inviteMsg: _vm.inviteMsg } })], 1) : _vm._e(),
      ]);
    };
