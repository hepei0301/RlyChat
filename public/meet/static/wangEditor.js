  ...
  UploadImg.prototype = {
    ...
    insertLinkImg: function insertLinkImg(link) {
      ...
      img.onerror = function () {
        ...
        _this2._alert(
          '插入图片错误',
          'wangEditor: \u63D2\u5165\u56FE\u7247\u51FA\u9519\uFF0C\u56FE\u7247\u94FE\u63A5\u662F "' + link + '"\uFF0C\u4E0B\u8F7D\u8BE5\u94FE\u63A5\u5931\u8D25'
        );
        return;
      };
  ...
  Editor.prototype = {
    ...
    _transformEmoJiCharacter: function (emoJiStr) {
      for (let i in emoji.show_dataAuto) {
        ...
        let imgStr =
          '<img class="emoji" src="./static/img-apple-64/' + item.unicode + '.png" height="20" width="20" style="vertical-align: middle;" align="absmiddle">';
