  ...
  g.prototype = {
      ...
      if (1 == a.length) {
        ...
        3 == a.length
          ...
          (b = {
            ...
            a: parseFloat(0.9 < parseFloat(a).toFixed(1) ? 1 : parseFloat(a).toFixed(1)),
          }),
          (d = this.rgbToHex(b)),
          (e = this.rgbToHsb(b));
      a = this.hsbToRgb({
    ...
    latelyColor: function () {
      if (this.options.recommend) {
        ...
        b
          ? (b = b.split('-'))
          : ((b = '0,0,51,1 0,51,102,1 0,102,153,1 0,153,204,1 0,204,255,1 102,0,51,1 102,51,102,1 102,102,153,1 102,204,204,1 102,255,255,1'.split(' ')),
