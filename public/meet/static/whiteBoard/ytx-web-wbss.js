  ...
  var YTX_WBSS_KERNEL = {
          ...
          if (jsonCurDocId == jsonDocId) {
            if (jsonCurPageIndex <= 0 || jsonCurPageIndex > jsonDocTotalPage) {
              YTX_WBSS_KERNEL._log(
                ...
                'Check DocId= ' + jsonCurDocId + ' PageIndex Failed: index=' + jsonCurPageIndex + ' total=' + jsonDocTotalPage + ' PageIndex Force Set Zero!'
              );
              jsonCurPageIndex = 0;
              YTX_WBSS_KERNEL.updateCurrentRoomId_DocId_PageIndex(jsonCurRoomId, jsonCurDocId, jsonCurPageIndex);
            }
    ...
    onWebSocketRecvMsg: function (recv_json_string) {
      ...
      if (type == null || payload == null) {
        YTX_WBSS_KERNEL._log(
          YTX_WBSS_KERNEL._logLev._ERROR,
          'receive msg Parse invalid' + (statusCode != null ? 'statusCode=' + statusCode : '') + ' ' + (statusMsg != null ? 'statusMsg=' + statusMsg : '')
        );
        return;
      }
      ...
      YTX_WBSS_KERNEL.connectWebScoketServer(
        function () {
          if (YTX_WBSS_KERNEL.currentLoginInRoomID && YTX_WBSS_KERNEL.currentLoginInRoomID != -1) {
            var joinRoomBuilder = new YTX_WBSS_API.JoinRoomBuilder(YTX_WBSS_KERNEL.currentLoginInRoomID, '123456', 0);
    ...
    setDrawSpaceInfo: function (room_id, doc_id, page_index, _canvas_width, _canvas_height, _draw_space_ratio, _draw_space_ifSacle) {
      ...
      YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index - 1].setDrawSpaceInfo(
        _canvas_width,
        _canvas_height,
        _draw_space_ratio,
        _draw_space_ifSacle
                  ...
                  if (draw_info._coordinate_array.length > 0) {
                    if (draw_info._shapeType == YTX_WBSS_API._shapeType.FREELINE) {
                      ...
                      if (draw_info._coordinate_array.length == 2) {
                        ...
                        if (YTX_WBSS_KERNEL.MathLib.intersectLineRect(x1, y1, x1, y2, limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true) {
                          return draw_info._drawID;
                        } else if (
                          YTX_WBSS_KERNEL.MathLib.intersectLineRect(x1, y1, x2, y1, limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true
                        ) {
                          return draw_info._drawID;
                        } else if (
                          YTX_WBSS_KERNEL.MathLib.intersectLineRect(x2, y1, x2, y2, limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true
                        ) {
                          return draw_info._drawID;
                        } else if (
                          YTX_WBSS_KERNEL.MathLib.intersectLineRect(x1, y2, x2, y2, limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true
                        ) {
                          return draw_info._drawID;
                        }
                      }
                      ...
                      if (draw_info._coordinate_array.length == 3) {
                        ...
                        var x3 = 2 * x1 - x2;
                        var y3 = y2;
                        if (YTX_WBSS_KERNEL.MathLib.intersectLineRect(x1, y1, x2, y2, limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true) {
                          return draw_info._drawID;
                        } else if (
                          YTX_WBSS_KERNEL.MathLib.intersectLineRect(x2, y2, x3, y3, limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true
                        ) {
                          return draw_info._drawID;
                        } else if (
                          YTX_WBSS_KERNEL.MathLib.intersectLineRect(x3, y3, x1, y1, limit_left_x, limit_right_x, limit_top_y, limit_bottom_y) == true
                        ) {
                          return draw_info._drawID;
                        }
                      }
        ...
        if (
          ...
          if (this.last_image_width > 0 && this.last_image_height > 0) {
            ...
            if (img_draw_space_ratio != this.last_draw_space_ratio) {
              YTX_WBSS_KERNEL._log(
                YTX_WBSS_KERNEL._logLev._WARN,
                'setDrawSpaceInfo Force img_draw_space_ratio=' + img_draw_space_ratio + ' to last_draw_space_ratio=' + this.last_draw_space_ratio
              );
                  ...
                  case YTX_WBSS_API._shapeType.LINE:
                    {
                      ...
                      if (this._coordinate_array.length >= 2 && drawDataElement._coordinate_array.length == 2) {
                        ...
                        if (
                          this._coordinate_array[this_end_pos_index].x == drawDataElement._coordinate_array[0].x &&
                          ...
                          YTX_WBSS_KERNEL._log(
                            YTX_WBSS_KERNEL._logLev._WARN,
                            'appendDrawDataElement straight line Failed Unknow CoorsInfo drawId=' + this._drawID + ' is Final Statue!'
                          );
                        }
                      } //if(this._coordinate_array.length >= 2 && drawDataElement._coordinate_array.length == 2)
                    }
        ...
        if (current_page_info != null) {
          ...
          if (is_Undo_or_wRedo) {
            ...
            if (YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index - 1].drawDataElementArray != null) {
              for (
                var i = YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index - 1].drawDataElementArray.length - 1;
                i >= 0;
                i--
              ) {
                ///< 从后向前查找
            ...
            // 恢复
            if (YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index - 1].drawDataElementArray != null) {
              for (var i = 0; i < YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index - 1].drawDataElementArray.length; i++) {
                ///< 从前向后查找
                var draw_data_element = YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index - 1].drawDataElementArray[i];
                if (draw_data_element != null) {
                  if (draw_data_element._drawID != null) {
              ...
              function completedCallback(resp) {
                if (resp != null && resp.code != null && resp.code == YTX_WBSS_KERNEL._errcode._SUCCESS) {
                  if (resp.key_value != null) {
                    ...
                    //同步PageInfo信息
                    if (!YTX_WBSS_KERNEL.setImageInfo(roomId, docId, pageIndex, image_key_value.image_width, image_key_value.image_height)) {
    ...
    asynDownloadFile: function (roomId, docId, pageIndex, current_page_filename, docInfo) {
      if (YTX_WBSS_KERNEL.isShowDebugDownLoadFile) {
        YTX_WBSS_KERNEL._log(
          YTX_WBSS_KERNEL._logLev._DEBUG,
          '=====asynDownloadFile(roomId=' + roomId + ',docId=' + docId + ',filename=' + current_page_filename + ')====='
        );
      }
        ...
        if (XMLHttpRequest.DONE == download_page_XMLHttpRequest.readyState) {
            ...
            new_page_image_obj.onload = function () {
              if (new_page_image_obj.complete) {
                ...
                YTX_WBSS_KERNEL.asynSetLocalDataBaseItem(
                  ...
                  function (resp) {
                    //同步PageInfo信息
                    if (!YTX_WBSS_KERNEL.setImageInfo(roomId, docId, pageIndex, image_width, image_height)) {
                  ...
                  function (resp) {
                    if (resp != null) {
                      YTX_WBSS_KERNEL._log(
                        YTX_WBSS_KERNEL._logLev._ERROR,
                        'set database item failed filename=' + filename + 'resp.code=' + resp.code + ' resp.msg=' + resp.msg
                      );
                    }
                  }
                );
          ...
          if (XMLHttpRequest.OPENED == download_page_XMLHttpRequest.readyState) {
            ...
            if (YTX_WBSS_KERNEL.isShowDebugDownLoadFile) {
              YTX_WBSS_KERNEL._log(
                YTX_WBSS_KERNEL._logLev._DEBUG,
                'DownloadFile Received Header roomId=' + roomId + ',docId=' + docId + ',filename=' + current_page_filename
              );
            }
            ...
            if (YTX_WBSS_KERNEL.isShowDebugDownLoadFile) {
              YTX_WBSS_KERNEL._log(
                YTX_WBSS_KERNEL._logLev._DEBUG,
                'DownloadFile Loading roomId=' + roomId + ',docId=' + docId + ',filename=' + current_page_filename
              );
            }
          } else {
            YTX_WBSS_KERNEL._log(
                    ...
                    if (statusCode == 0) {
                      ...
                      wait_convert_complete_doc_obj.timer_handle = window.setInterval(function () {
                        ...
                        wait_convert_complete_doc_obj.complete_percentage =
                          wait_convert_complete_doc_obj.complete_percentage + wait_convert_complete_doc_obj.complete_percentage_step;
                        ...
                        if (YTX_WBSS_KERNEL._onUploadDocProcessListener != null) {
                          ...
                          YTX_WBSS_KERNEL._log(
                            YTX_WBSS_KERNEL._logLev._DEBUG,
                            'converting filename=' + upload_filename + ' complete_percentage=' + wait_convert_complete_doc_obj.complete_percentage
                          );
                        }
          ...
          if (evt.newVersion != evt.oldVersion) {
            ...
            if (YTX_WBSS_KERNEL.indexDB_handle != null) {
              ...
              if (isExsitObjectStore != true) {
                // 创建数据库表
                var indexDB_objectStore = YTX_WBSS_KERNEL.indexDB_handle.createObjectStore(YTX_WBSS_KERNEL.indexDB_dbInfo.dbStoreName, {
    ...
    drawContext: {
      ...
      startCurrentDrawDataElement: function (room_id, doc_id, page_index, mouse_event_obj) {
        ...
        //画线处理
        if (
          (YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_NORMAL && ///< 画自由线
          ...
          var draw_id =
            ...
            page_index.toString() +
            '-' +
            YTX_WBSS_KERNEL.allRoomInfoMap[room_id].docInfoMap[doc_id].pageInfoArray[page_index - 1].drawIDSeedNumber++ +
            '-' +
          ...
          YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject = new YTX_WBSS_KERNEL.drawContext.createCurrentDrawDataElementObject(
            room_id,
            doc_id,
            page_index,
          ...
          YTX_WBSS_KERNEL.drawContext.drawToolStatus == YTX_WBSS_KERNEL.drawConextToolStatus.DRAW_STATUS_ERASER && ///< 元素橡皮擦
          ...
          if (YTX_WBSS_KERNEL.isShowDebugManagerDrawDataElement) {
            YTX_WBSS_KERNEL._log(
              YTX_WBSS_KERNEL._logLev._WARN,
              'startCurrentDrawDataElement(' + YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.order_index + ')'
            );
          }
        }
      },
          ...
          if (
            ...
            if (YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj != null) {
              ...
              if (diff_nowTimeStampMS > diff_fps_ms) {
                ...
                if (
                  (YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber == 0 && coordinates_length >= 4) ||
                  (YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber != 0 &&
                    coordinates_length > YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.sendMsgLastCoorsNumber)
                ) {
                  // 保存对象
            ...
            if (YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj != null) {
              ...
              if (diff_nowTimeStampMS > diff_fps_ms) {
                ...
                coordinates_length = YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj.coordinates.length;
                if (coordinates_length >= 4 || (coordinates_length >= 2 && YTX_WBSS_KERNEL.drawContext.drawShapeType == YTX_WBSS_API._shapeType.LASERPEN)) {
                  // 发送渲染消息
                  var sendStr = YTX_WBSS_KERNEL._protobuf._buildDrawData(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.draw_data_obj);
                  if (sendStr != null && sendStr.length > 0) {
                    YTX_WBSS_KERNEL.sendWebSocketMsg(sendStr);
            ...
            if (YTX_WBSS_KERNEL.isShowDebugManagerDrawDataElement) {
              YTX_WBSS_KERNEL._log(
                ...
                'updateCurrentDrawDataElement(' + YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.order_index + ')'
              );
            }
          }
        }
      ...
      endCurrentDrawDataElement: function (mouse_event_obj) {
        if (YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject != null) {
          ...
          if (YTX_WBSS_KERNEL.isShowDebugManagerDrawDataElement) {
            YTX_WBSS_KERNEL._log(
              YTX_WBSS_KERNEL._logLev._WARN,
              'endCurrentDrawDataElement(' + YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject.order_index + ')'
            );
          }
        } //if(YTX_WBSS_KERNEL.drawContext.currentDrawDataElementObject != null)
      },
    ...
    CANVAS_MOD: {
        ...
        if (current_draw_page_info != null) {
          ...
          if (mouse_event_obj != null) {
            ...
            if (YTX_WBSS_KERNEL.isShowDebugMouseEventCoors) {
              YTX_WBSS_KERNEL._log(
                mouse_event_obj.isInCanvasRect ? YTX_WBSS_KERNEL._logLev._DEBUG : YTX_WBSS_KERNEL._logLev._WARN,
                'mouse ' +
            ...
            switch (mouseEventStatus) {
              ...
              case YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_STATUS.MOUSE_EVENT_STATUS_UP:
                {
                  if (
                    mouse_event_obj.buttonKey == YTX_WBSS_KERNEL.CANVAS_MOD.MOUSE_EVENT_KEY.MOUSE_EVENT_KEY_NONE ||
      ...
      updateDrawClientRect: function (
        ...
        if (current_canvas_width > 0 && current_canvas_height > 0) {
          if (current_canvas_width != YTX_WBSS_KERNEL.canvas_html_handle.width || current_canvas_height != YTX_WBSS_KERNEL.canvas_html_handle.height) {
    ...
    util: {
      ...
      getSessionDescription: function () {
        var sessionDescription =
          window.RTCSessionDescription || window.mozRTCSessionDescription || window.webkitRTCSessionDescription || window.msRTCSessionDescription;
  ...
  window.YTX_WBSS_API = {
    ...
    setLineColor: function (ColorBuilder) {
      YTX_WBSS_KERNEL.drawContext.lineColor =
        (ColorBuilder.getR() << 24) | (ColorBuilder.getG() << 16) | (ColorBuilder.getB() << 8) | (ColorBuilder.getA() << 0);
    },
