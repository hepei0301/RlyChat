...
(function (A, w) {
        ...
        n.find.ID = function (m, q, p) {
          if (typeof q.getElementById !== 'undefined' && !p)
            return (q = q.getElementById(m[1]))
              ? q.id === m[1] || (typeof q.getAttributeNode !== 'undefined' && q.getAttributeNode('id').nodeValue === m[1])
                ? [q]
                : w
              : [];
        };
  ...
  c.each(
    { slideDown: K('show', 1), slideUp: K('hide', 1), slideToggle: K('toggle', 1), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' } },
    function (a, b) {
      c.fn[a] = function (d, f) {
  ...
  c.extend({
    speed: function (a, b, d) {
      var f =
        a && typeof a === 'object' ? a : { complete: d || (!d && b) || (c.isFunction(a) && a), duration: a, easing: (d && b) || (b && !c.isFunction(b) && b) };
  ...
  c.each(['Height', 'Width'], function (a, b) {
    ...
    c.fn[d] = function (f) {
      ...
      return 'scrollTo' in e && e.document
        ? (e.document.compatMode === 'CSS1Compat' && e.document.documentElement['client' + b]) || e.document.body['client' + b]
        : e.nodeType === 9
        ? Math.max(
