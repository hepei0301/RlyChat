  ...
  (window.jscolor = (function () {
    var e = {
      ...
      getRelPointerPos: function (e) {
        ...
        return (
          typeof e.changedTouches != 'undefined' && e.changedTouches.length
            ? ((s = e.changedTouches[0].clientX), (o = e.changedTouches[0].clientY))
      ...
      redrawPosition: function () {
        if (e.picker && e.picker.owner) {
          ...
          if (!t.smartPosition) var c = [n[u], n[a] + i[a] - l + l * f];
            ...
            var c = [
              -r[u] + n[u] + o[u] > s[u] ? (-r[u] + n[u] + i[u] / 2 > s[u] / 2 && n[u] + i[u] - o[u] >= 0 ? n[u] + i[u] - o[u] : n[u]) : n[u],
              -r[a] + n[a] + i[a] + o[a] - l + l * f > s[a]
                ? -r[a] + n[a] + i[a] / 2 > s[a] / 2 && n[a] + i[a] - l - l * f >= 0
                  ? n[a] + i[a] - l - l * f
                  : n[a] + i[a] - l + l * f
                : n[a] + i[a] - l + l * f >= 0
                ? n[a] + i[a] - l + l * f
      ...
      _drawPosition: function (t, n, r, i, s) {
        ...
        (e.picker.wrap.style.position = i),
          ...
          e.setBoxShadow(e.picker.boxS, t.shadow ? new e.BoxShadow(0, o, t.shadowBlur, 0, t.shadowColor) : null);
      },
      getPickerDims: function (t) {
        var n = !!e.getSliderComponent(t),
          r = [
            2 * t.insetWidth + 2 * t.padding + t.width + (n ? 2 * t.insetWidth + e.getPadToSliderPadding(t) + t.sliderSize : 0),
            2 * t.insetWidth + 2 * t.padding + t.height + (t.closable ? 2 * t.insetWidth + t.padding + t.buttonHeight : 0),
          ];
        return r;
      },
      ...
      onControlPointerStart: function (t, n, r, i) {
        ...
        var o = function (s, o) {
          e.attachGroupEvent('drag', s, e._pointerMoveEvent[i], e.onDocumentPointerMove(t, n, r, i, o)),
            e.attachGroupEvent('drag', s, e._pointerEndEvent[i], e.onDocumentPointerEnd(t, n, r, i));
        };
        o(document, [0, 0]);
        ...
        (this.hide = function () {
          ...
          (this.fromRGB = function (e, t, n, r) {
            ...
            o[0] !== null && (this.hsv[0] = Math.max(0, Math.min(360, o[0]))),
              o[2] !== 0 && (this.hsv[1] = o[1] === null ? null : Math.max(0, this.minS, Math.min(100, this.maxS, o[1]))),
              (this.hsv[2] = o[2] === null ? null : Math.max(0, this.minV, Math.min(100, this.maxV, o[2])));
          ...
          (this.fromString = function (e, t) {
            ...
            if ((n = e.match(/^\W*([0-9A-F]{3}([0-9A-F]{3})?)\W*$/i)))
              return (
                n[1].length === 6
                  ? this.fromRGB(parseInt(n[1].substr(0, 2), 16), parseInt(n[1].substr(2, 2), 16), parseInt(n[1].substr(4, 2), 16), t)
                  : this.fromRGB(
          ...
          (this._processParentElementsInDOM = function () {
            ...
            do {
              ...
              n && n.position.toLowerCase() === 'fixed' && (this.fixed = !0),
                t !== this.targetElement && (t._jscEventsAttached || (e.attachEvent(t, 'scroll', e.onParentScroll), (t._jscEventsAttached = !0)));
