...
var app = {
  ...
  _appToken: '0f26f16e4a8d4680a586c6eb2a9f4e03', // '
};

window.restUrl = 'https://im.gcnao.cn:9002';
window._ws = 'wss://im.gcnao.cn:9002/ws';
// (window.fileServerIp = "https://192.168.27.239:8090"),
(window.fileServerIp = 'https://im.gcnao.cn:9002/uploadFile'), (window.lvsServer = 'https://im.gcnao.cn:9002/accessFile');
window.FILE_ACCESS_URL = 'https://im.gcnao.cn:9002/accessFile';
window.IM_REST_URL = 'https://120.78.65.0:8883';
// 会议相关
window.AppId = '8a2af988536458c301537d7197320004';
window.AppToken = '0f26f16e4a8d4680a586c6eb2a9f4e03';
...
window.LvsAddrs = ['120.78.65.0:8888'];
window.WbssAddrs = ['https://120.78.65.0:9001'];
window.dvrFileAddrs = 'https://im.gcnao.cn::9002/dvrFile';
