/*! jQuery v3.1.0 | (c) jQuery Foundation | jquery.org/license */ !(function (a, b) {
    ...
    (r.extend = r.fn.extend =
      function () {
        var a,
          ...
          j = !1;
        for (
          'boolean' == typeof g && ((j = g), (g = arguments[h] || {}), h++), 'object' == typeof g || r.isFunction(g) || (g = {}), h === i && ((g = this), h--);
          h < i;
          h++
        )
      ...
      (d = ga.selectors =
        {
          ...
          preFilter: {
            ATTR: function (a) {
              return (
                (a[1] = a[1].replace(_, aa)), (a[3] = (a[3] || a[4] || a[5] || '').replace(_, aa)), '~=' === a[2] && (a[3] = ' ' + a[3] + ' '), a.slice(0, 4)
              );
            },
            CHILD: function (a) {
              return (
  ...
  function fa(a) {
    ...
    return e
      ? e
      : ((b = c.body.appendChild(c.createElement(d))), (e = r.css(b, 'display')), b.parentNode.removeChild(b), 'none' === e && (e = 'block'), (ea[d] = e), e);
  }
    ...
    for (var c, d, e = [], f = 0, g = a.length; f < g; f++)
      (d = a[f]),
        d.style &&
          ((c = d.style.display),
          b
            ? ('none' === c && ((e[f] = V.get(d, 'display') || null), e[f] || (d.style.display = '')), '' === d.style.display && ba(d) && (e[f] = fa(d)))
        ...
        while (j--)
          (h = sa.exec(b[j]) || []),
            ...
            n &&
              ...
              (m = i[n]) ||
                ((m = i[n] = []), (m.delegateCount = 0), (l.setup && l.setup.call(a, d, o, g) !== !1) || (a.addEventListener && a.addEventListener(n, g))),
  ...
  (r.Animation = r.extend(gb, {
    ...
    (r.speed = function (a, b, c) {
      ...
      return (
        r.fx.off || d.hidden
          ? (e.duration = 0)
          : (e.duration = 'number' == typeof e.duration ? e.duration : e.duration in r.fx.speeds ? r.fx.speeds[e.duration] : r.fx.speeds._default),
    ...
    r.extend({
      valHooks: {
        ...
        select: {
          get: function (a) {
            for (
              var b, c, d = a.options, e = a.selectedIndex, f = 'select-one' === a.type, g = f ? null : [], h = f ? e + 1 : d.length, i = e < 0 ? h : f ? e : 0;
              i < h;
              i++
            )
    ...
    ajax: function (b, c) {
      ...
      (l = r.event && o.global),
        ...
        o.hasContent
          ...
          : ((n = o.url.slice(f.length)),
            ...
            (o.url = f + n)),
        o.ifModified &&
          (r.lastModified[f] && y.setRequestHeader('If-Modified-Since', r.lastModified[f]), r.etag[f] && y.setRequestHeader('If-None-Match', r.etag[f])),
        ((o.data && o.hasContent && o.contentType !== !1) || c.contentType) && y.setRequestHeader('Content-Type', o.contentType),
        y.setRequestHeader(
          'Accept',
          o.dataTypes[0] && o.accepts[o.dataTypes[0]] ? o.accepts[o.dataTypes[0]] + ('*' !== o.dataTypes[0] ? ', ' + Hb + '; q=0.01' : '') : o.accepts['*']
        );
      ...
      function A(b, c, d, h) {
        ...
        k ||
          ...
          j
            ? (o.ifModified &&
                ((w = y.getResponseHeader('Last-Modified')), w && (r.lastModified[f] = w), (w = y.getResponseHeader('etag')), w && (r.etag[f] = w)),
