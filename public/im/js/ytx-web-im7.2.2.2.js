    ...
    var YTX_Methods = {
      ...
      onResponse: function (obj) {
        ...
        if (type === commonConfig.msgTypeNo._callRoute) {
          ...
          //会议通知
          if (YTX_CONFIG.isV3) {
            ROOT.RL_Media_V3.receiveConferenceNotice(obj);
          } else if (self.meetActive) {
        ...
        if (type === commonConfig.msgTypeNo._login) {
          ...
          if (YTX_CONFIG.isV3) {
            ROOT.RL_Media_V3.receiveMsgResp(obj, request, 'parseConferenceMessageResp');
          } else if (self.meetActive) {
  ...
  function RL_Chat() {
    ...
    var chatMethods = {
      ...
      noticeAppFn: function (obj) {
        ...
        } else if (obj.msgType === commonConfig.msgTypeNo._friendMsg) {
          //好友消息
          return obj;
        } else {
      ...
      buildUploadUserDeviceDetail: function (data, callback, onError) {
        ...
        var send = {
          ...
          userAcc: commonConfig.userName,
          deviceNo: commonConfig.imei,
          deviceType: commonConfig.deviceType,
          deviceModel: navigator.vendor,
          deviceSystemVersion: navigator.appVersion,
    ...
    this.__proto__ = {
      ...
      setConfig: function (val) {
        ...
        if (val.maxSyncNum && typeof val.maxSyncNum === 'number') self.maxSyncNum = val.maxSyncNum;
      ...
      onSantiMsgReceiveListener(callback) {
        self._meetListener = callback;
      },
      ...
      receivePushMsg: function (obj) {
        ...
        if (pushMsg.msgType === commonConfig.msgTypeNo._cmdMsg && pushMsg.msgSender !== commonConfig.userName) {
          try {
            ...
            if (msgDomain.SanTi) {
              self._meetListener(msgDomain.SanTi);
              return;
            }
          } catch (e) {}
        }
