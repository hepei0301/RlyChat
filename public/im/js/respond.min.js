      ...
      var h,
        ...
        u = function () {
          ...
          return (
            ...
            c || ((c = f = k.createElement('body')), (c.style.background = 'none')),
          ...
          for (var s in m)
            if (m.hasOwnProperty(s)) {
              ...
              x && (x = parseFloat(x) * (x.indexOf(B) > -1 ? j || u() : 1)),
                ...
                (w.hasquery && ((z && A) || !(z || e >= x) || !(A || y >= e))) || (f[w.media] || (f[w.media] = []), f[w.media].push(n[w.rules]));
            }
          ...
          for (var b = 0; b < t.length; b++) {
            ...
            e &&
              ...
              (c.styleSheet && c.styleSheet.rawCssText
                ...
                : ((!/^([a-zA-Z:]*\/\/)/.test(e) && !s) || e.replace(RegExp.$1, '').split('/')[0] === a.location.host) &&
