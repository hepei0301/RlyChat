...
RL_MT.prototype = {
  processBuilder: function (obj, tar) {
    Object.keys(obj).forEach(tr => {
      tar["set" + tr.substr(0, 1).toUpperCase() + tr.substr(1)] = function (
        v
      ) {
        obj[tr] = v;
      };
  ...
  processNotice(obj) {
    if (obj.msgType === 50) {
      ...
      //普通IM消息推送
      if (RL_MEET.msgListener)
        RL_MEET.msgListener(obj);
    }
  },
      ...
      e => {
        ...
        if (resp.statusCode != "000000") {
          ...
          if (resp.conf.creator.indexOf("$") > -1) {
            resp.conf.creator = resp.conf.creator.substr(
              resp.conf.creator.indexOf("$") + 1,
              resp.conf.creator.length
            );
          }
        }
  ...
  StartWhiteboardSharing: function (
  ...
  StopWhiteboardSharing: function (
  ...
  GetMeetVoiceMax: function(confId, callback, onError) {
    RL_Media.ConferenceMsg(
      new RL_Media.ConferenceMsgBuilder(
        "/REST/Conference/Impel/Member/List?source=SDK", {
          appId: this.appid,
          userId: this.userId,
          confId: confId
        }
  ...
  GetMeetMemberListBuilder: function (
    appId,
    userId,
    confId,
    pageNo,
  ...
  GetHistoryRoom: function (GetHistoryRoomBuilder, success, error) {
    RL_Media.ConferenceMsg(new RL_Media.ConferenceMsgBuilder('/REST/Conference/History/Search?source=SDK', {
      appId: this.appid,
      userId: this.userId,
  ...
  GetHistoryRoomBuilder: function (confId, searchByMember, memberId, memberIdType, confType, stateInProcess, reserveEnable, mediaType, startTimeBegin, startTimeEnd, pageNo, pageSize) {
    this._confId = confId;
    this._searchByMember = searchByMember;
    this._memberId = memberId;
    this._memberIdType = memberIdType;
  ...
  StopPublishVoice: function (StopPublishVoiceBuilder, callback, onError) {
    ...
    let exclusively;
    if (//StopPublishVoiceBuilder instanceof Function &&
      onError === undefined
    ) {
      onError = callback;
  ...
  UpdateMeetMemberNick: function (
    UpdateMeetMemberNickBuilder,
    callback,
    onError
  ) {
    RL_Media.ConferenceMsg(
  ...
  UpdateMeetMemberNickBuilder: function (
    appId,
    userId,
    confId,
    memberId,
  ...
  prolongMeetTime: function(tryMinDuration, tryMaxDuration, callback, onError) {
    RL_Media.ConferenceMsg(
      new RL_Media.ConferenceMsgBuilder(
        "/REST/Conference/ExtendDuration?source=SDK", {
          "appId": this.appid,
          "userId": this.userId,
          "confId": this.confId,
  ...
  DeleteMeeting: function (confId, callback, onError) {
    ...
    RL_Media.ConferenceMsg(
      new RL_Media.ConferenceMsgBuilder(
        "/REST/Conference/Member/TransferModerator?source=SDK", {
          appId: this.appid,
          userId: this.userId,
  ...
  disconnectMember: function(memberList, callback, onError) {
    RL_Media.ConferenceMsg(
      new RL_Media.ConferenceMsgBuilder(
        "/REST/Conference/Member/Disconnect?source=SDK", {
          appId: this.appid,
          userId: this.userId,
          confId: this.confId,
          members: memberList
  ...
  UpdateSummary(data, success, error) {
    RL_Media.ConferenceMsg(new RL_Media.ConferenceMsgBuilder('/REST/Conference/Abstract/Update?source=SDK', Object.assign({
      userId: this.userId,
      appId: this.appid,
  ...
  GetSummaryList(data, success, error) {
    RL_Media.ConferenceMsg(new RL_Media.ConferenceMsgBuilder('/REST/Conference/Abstract/List?source=SDK', Object.assign({
      appId: this.appid,
      userId: this.userId,
  ...
  DeleteAbstract(data, success, error) {
    RL_Media.ConferenceMsg(new RL_Media.ConferenceMsgBuilder("/REST/Conference/Abstract/Delete?source=SDK", Object.assign({
      appId: this.appid,
      userId: this.userId,
    },data)), success, error)
  },
  GetMeetingMemberInfo: function (
    GetMeetingMemberInfoBuilder,
    callback,
    onerror
  ) {
    RL_Media.ConferenceMsg(
      new RL_Media.ConferenceMsgBuilder(
        "/REST/Conference/Member/Info?source=SDK", {
          appId: this.appid,
          userId: this.userId,
  ...
  SetConfLayout: function (
    ...
    RL_Media.ConferenceMsg(
      new RL_Media.ConferenceMsgBuilder(
        "/REST/Conference/SetConfLayout?source=SDK", {
  ...
  */
  RecordDelete: function (data, callback, onError) {
    RL_Media.ConferenceMsg(
      new RL_Media.ConferenceMsgBuilder("/REST/Conference/Record/Delete?source=SDK", 
      Object.assign({
        appId: this.appid,
        userId: this.userId,
        confId: this.confId,
