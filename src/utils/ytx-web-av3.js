...
YTX_Meeting.unSubscribeMediaFail = function (request, err) {
  console.error(
    YTX_Meeting.getTimeStamp(),
    '[Meeting] unSubscribeMedia Failed, userName:',
    request.userName,
    ', userId:',
    request.userId,
    'errName:',
...
YTX_Meeting.subscribeMedia = function (request) {
  ...
  message[ParKey.MessageType] = ParValue.Call;
  message[ParKey.ClientNo] = clientNo;
  message[ParKey.CallRouteId] = YTX_Meeting.callRouteId;
  message[ParKey.MessageContent] = {};
  message[ParKey.MessageContent].CallEventDataInner = {};
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Method] = ParMethod.SubscribeMediaRequest;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.CallId] = YTX_Meeting.callId;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Called] = YTX_Meeting.called;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Caller] = YTX_Meeting.caller;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.CustomData] = JSON.stringify(customData);
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Seq] = clientNo.toString();
  YTX_Meeting.sendMessage(message);
...
YTX_Meeting.unSubscribeMedia = function (request) {
  ...
  message[ParKey.MessageContent] = {};
  message[ParKey.MessageContent].CallEventDataInner = {};
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Method] = ParMethod.UnSubscribeMediaRequest;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.CallId] = YTX_Meeting.callId;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Called] = YTX_Meeting.called;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Caller] = YTX_Meeting.caller;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.CustomData] = JSON.stringify(customData);
...
YTX_Meeting.startScreenShare = function (onSuccess, onFail) {
  ...
  YTX_Webrtc.publishScreenMedia(function (stream) {
    YTX_Webrtc.buildScreenShareOffer(stream, YTX_Meeting.addCancelScreenShareRequest, YTX_Meeting.sendPublishMediaRequest, YTX_Meeting.startScreenShareFail);
  ...
  this.__proto__ = {
    ...
    ConnectMedia: function (ConnectMediaBuilder, callback, onError) {
      YTX_Meeting.getMediaDevice(function (devices) {
        ...
        parameter.mediaType = 0; // 0表示音频，1表示视频
