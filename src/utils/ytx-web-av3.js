  ...
  YTX_Webrtc.handleAnswer(
    ...
    function () {
      ...
      if (videoPort == 0 && YTX_Meeting.mediaType == MType.Video) {
        ...
        YTX_Webrtc.updateLocalMedia({ mediaType: MType.Audio }, YTX_Meeting.makeCallSuccess, YTX_Meeting.makeCallFail);
        return;
      }
...
YTX_Meeting.updateMedia = function (request) {
  ...
  YTX_Webrtc.updateLocalMedia({ mediaType: mediaType }, YTX_Meeting.startLocalMedia, YTX_Meeting.updateMediaFail);
};
//////////////////////
...
YTX_Webrtc.updateNegotiationOffer = function (onSuccess, onFail) {
  ...
  YTX_Webrtc._peerConnection
    ...
    .then(function () {
      return YTX_Webrtc._peerConnection.setRemoteDescription(YTX_Webrtc._peerConnection.remoteDescription);
    })
    .then(function () {
    ...
    .catch(function (err) {
      console.error(YTX_Meeting.getTimeStamp(), '[Meeting] update Negotiation Offer Fail, errname:', err.name, ', errmessage:', err.message);
      onFail(err);
    });
};
...
YTX_Webrtc.updateNegotiationAnswer = function (onSuccess, onFail) {
  YTX_Webrtc._peerConnection
    ...
    .catch(function (err) {
      console.error(YTX_Meeting.getTimeStamp(), '[Meeting] update Negotiation Answer Fail, errname:', err.name, ', errmessage:', err.message);
      onFail(err);
    });
};
...
YTX_Webrtc.updateRemoteOffer = function (parameter, onSuccess, onFail) {
  ...
  YTX_Webrtc._peerConnection
    ...
    .catch(function (err) {
      console.error(YTX_Meeting.getTimeStamp(), '[Meeting] Update Remote Offer Fail, errname:', err.name, ', errmessage:', err.message);
      onFail(err);
    });
};
...
YTX_Webrtc.updateRemoteAnswer = function (parameter, onSuccess, onFail) {
  ...
  YTX_Webrtc._peerConnection
    ...
    .catch(function (err) {
      console.error(YTX_Meeting.getTimeStamp(), '[Meeting] Update Remote Answer Fail, errname:', err.name, ', errmessage:', err.message);
      onFail(err);
    });
};
/////////////////////////////////////////////////////////////////////////////////
