(function (local_setup) {
  ...
  emoji.img_sets = {
    ...
    google: {
      path: '../demo/emoji-data/img-google-64/',
      sheet: '../demo/emoji-data/sheet_google_64.png',
      mask: 2,
    },
    twitter: {
      path: '../demo/emoji-data/img-twitter-64/',
      sheet: '../demo/emoji-data/sheet_twitter_64.png',
      mask: 4,
    },
    emojione: {
      path: '../demo/emoji-data/img-emojione-64/',
      sheet: '../demo/emoji-data/sheet_emojione_64.png',
      mask: 8,
    },
  };
  ...
  emoji.replacement = function (idx, actual, wrapper, variation) {
    ...
    var text_name = actual
      ...
      : emoji.data[idx][8] || wrapper + emoji.data[idx][3][0] + wrapper;
    ...
    emoji.init_env();
    if (emoji.replace_mode == 'unified' && emoji.allow_native && emoji.data[idx][0][0])
      return emoji.data[idx][0][0] + extra;
    if (emoji.replace_mode == 'softbank' && emoji.allow_native && emoji.data[idx][1])
      return emoji.data[idx][1] + extra;
    if (emoji.replace_mode == 'google' && emoji.allow_native && emoji.data[idx][2])
      return emoji.data[idx][2] + extra;
    ...
    if (
      variation_idx &&
      emoji.variations_data[variation_idx] &&
      emoji.variations_data[variation_idx][2] &&
      !emoji.data[idx][9]
    ) {
    ...
    if (emoji.supports_css) {
      if (emoji.use_sheet && px != null && py != null) {
        ...
        var style =
          'background: url(' +
          emoji.img_sets[emoji.img_set].sheet +
          ');background-position:' +
          mul * px +
          '% ' +
          mul * py +
