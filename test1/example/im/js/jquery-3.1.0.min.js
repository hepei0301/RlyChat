/*! jQuery v3.1.0 | (c) jQuery Foundation | jquery.org/license */ !(function (a, b) {
        ...
        function (a, b, e, f) {
          ...
          if (((e = e || []), 1 === o.length)) {
            ...
            while (i--) {
              ...
              if (
                (m = d.find[l]) &&
                (f = m(k.matches[0].replace(_, aa), ($.test(j[0].type) && qa(b.parentNode)) || b))
              ) {
      ...
      if (
        ...
        try {
          c =
            'true' === c ||
            ('false' !== c &&
              ('null' === c ? null : +c + '' === c ? +c : X.test(c) ? JSON.parse(c) : c));
        } catch (e) {}
        W.set(a, b, c);
      } else c = void 0;
    return c;
  ...
  function oa(a, b, c, d, e) {
    ...
    while ((f = m[n++]))
      if (d && r.inArray(f, d) > -1) e && e.push(f);
        ...
        ((j = r.contains(f.ownerDocument, f)), (g = la(l.appendChild(f), 'script')), j && ma(g), c)
      ) {
        k = 0;
  ...
  (r.event = {
    ...
    remove: function (a, b, c, d, e) {
      ...
      if (q && (i = q.events)) {
        ...
        while (j--)
          if (
            ((h = sa.exec(b[j]) || []), (n = p = h[1]), (o = (h[2] || '').split('.').sort()), n)
          ) {
            (l = r.event.special[n] || {}),
  ...
  function Ia(a, b, c) {
    for (var d, e = b ? r.filter(b, a) : a, f = 0; null != (d = e[f]); f++)
      c || 1 !== d.nodeType || r.cleanData(la(d)),
        d.parentNode &&
          (c && r.contains(d.ownerDocument, d) && ma(la(d, 'script')), d.parentNode.removeChild(d));
    return a;
  }
  r.extend({
  ...
  function db(a, b, c) {
    for (
      var d, e = (gb.tweeners[b] || []).concat(gb.tweeners['*']), f = 0, g = e.length;
      f < g;
      f++
    )
      ...
      (l = r.event && o.global),
        ...
        o.hasContent
          ...
          : ((n = o.url.slice(f.length)),
            ...
            o.cache === !1 &&
              ((f = f.replace(Ab, '')), (n = (sb.test(f) ? '&' : '?') + '_=' + rb++ + n)),
            (o.url = f + n)),
        o.ifModified &&
