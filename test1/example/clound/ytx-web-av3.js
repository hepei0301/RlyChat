  ...
  switch (request.messageId) {
    case YTX_MessageId.SubscribeMedia:
      console.log(
        ...
        '[Meeting] Handle SubscribeMedia, userName:',
        request.userName,
        ', userId:',
        request.userId
      );
    ...
    case YTX_MessageId.UnSubscribeMedia:
      console.log(
        YTX_Meeting.getTimeStamp(),
        '[Meeting] Handle UnSubscribeMedia userName:',
        request.userName,
        ', userId:',
        request.userId
      );
...
YTX_Meeting.subscribeMediaSuccess = function (request) {
  console.log(
    YTX_Meeting.getTimeStamp(),
    '[Meeting] subscribeMedia Success, userName:',
    request.userName,
    ', userId:',
    request.userId
  );
...
YTX_Meeting.unSubscribeMediaSuccess = function (request) {
  console.log(
    YTX_Meeting.getTimeStamp(),
    '[Meeting] unSubscribeMedia Success, userName:',
    request.userName,
    ', userId:',
    request.userId
  );
...
YTX_Meeting.subscribeMedia = function (request) {
  ...
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Method] =
    ParMethod.SubscribeMediaRequest;
...
YTX_Meeting.unSubscribeMedia = function (request) {
  ...
  message[ParKey.MessageContent].CallEventDataInner = {};
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Method] =
    ParMethod.UnSubscribeMediaRequest;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.CallId] = YTX_Meeting.callId;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Called] = YTX_Meeting.called;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.Caller] = YTX_Meeting.caller;
  message[ParKey.MessageContent].CallEventDataInner[ParKey.CustomData] = JSON.stringify(customData);
