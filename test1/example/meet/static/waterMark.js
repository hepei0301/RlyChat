(function (root, factory) {
  ...
  var settingsToDefaultSetting = function (settings) {
    ...
    defaultSettings.watermark_parent_height =
      settings.watermark_parent_height || defaultSettings.watermark_parent_height;
  ...
  loadMark = function (settings) {
    ...
    if (!otdiv) {
      ...
      otdiv.setAttribute(
        'style',
        'pointer-events: none !important; display: block !important; position:absolute !important;'
      );
    ...
    defaultSettings.watermark_cols = parseInt(
      (page_width - defaultSettings.watermark_x) /
        (defaultSettings.watermark_width + defaultSettings.watermark_x_space) || 0
    );
