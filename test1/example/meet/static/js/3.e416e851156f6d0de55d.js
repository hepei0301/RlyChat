webpackJsonp([3], {
  /***/ '8gdL': /***/ function (module, exports) {
    // removed by extract-text-webpack-plugin
    /***/
  },

  /***/ EV7L: /***/ function (module, exports) {
    // removed by extract-text-webpack-plugin
    /***/
  },

  /***/ Ec0G: /***/ function (module, exports) {
    // removed by extract-text-webpack-plugin
    /***/
  },

  /***/ feWf: /***/ function (module, __webpack_exports__, __webpack_require__) {
    'use strict';
    ...
    var V3_Meeting =
      ...
      defineProperty_default()(
        _V3_Meeting,
        'getMeetMemberList',
        function getMeetMemberList(succFunc, errFunc) {
          RL_MEET.GetMeetMemberList(
            function (res) {
              succFunc && succFunc(res);
            },
      ...
      defineProperty_default()(
        _V3_Meeting,
        'rejectInvitation',
        function rejectInvitation(confId, succFunc, errFunc) {
          ...
          RL_MEET.RejectInvitation(
            rejectInvitationBuilder,
            function (res) {
      ...
      onConnectStateChangeCallback: function onConnectStateChangeCallback(vm, msg) {
        ...
        if (msg.code == 1) {
          ...
          if (msg.errCode && msg.errCode == '550004') {
            this.repeatLoginCertification(
              store['a' /* default */].state.user_account,
              1,
              function () {
          ...
          peopleArray.forEach(function (item, i) {
            if (item.account == store['a' /* default */].state.user_account) {
              ...
              if (i == peopleArray.length - 1) {
                str +=
                  '<a class="group_prompt" data-account="' +
                  item.account +
                  '">' +
                  item.nickName +
                  '</a>';
          ...
          switch (auditType) {
            case '1':
              msg.msgContent =
                ...
                msg.adminNickName +
                '</a>' +
                rxVue.$t('last.groupInviteTip') +
                '<a class="group_prompt" data-account="' +
                msg.member +
                '">' +
                msg.nickName +
                '</a>' +
                rxVue.$t('last.inviteWaite');
              break;
            case '2':
              msg.msgContent =
                '<a class="group_prompt" data-account="' +
            ...
            case '3':
              msg.msgContent =
                ...
                msg.nickName +
                '</a>' +
                rxVue.$t('last.inInviteJoinGroup');
              break;
            case '4':
            ...
            case '7':
              msg.msgContent =
                ...
                msg.adminNickName +
                '</a>' +
                rxVue.$t('last.groupInviteSuccess') +
                '<a class="group_prompt" data-account="' +
                msg.member +
                '">' +
                msg.nickName +
            ...
            case '10':
              if (msg.ext.indexOf('isManage') > -1) {
                ...
                if (isManage == 1) {
                  ...
                  msg.msgContent =
                    '<a class="group_prompt" data-account="' +
                    (msg.admin || msg.member) +
                    '">' +
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupClose') + rxVue.$t('last.groupManageSet'));
                } else {
                  msg.msgContent =
                    '<a class="group_prompt" data-account="' +
                    (msg.admin || msg.member) +
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupOpen') + rxVue.$t('last.groupManageSet'));
                }
                ...
                if (isAtAll == 1) {
                  ...
                  msg.msgContent =
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupClose') + rxVue.$t('last.groupManageAite'));
                } else {
                  msg.msgContent =
                    '<a class="group_prompt" data-account="' +
                    (msg.admin || msg.member) +
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupOpen') + rxVue.$t('last.groupManageAite'));
                }
                ...
                if (inviteOperation == 1) {
                  ...
                  msg.msgContent =
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupClose') + rxVue.$t('last.groupManageInvite'));
                } else {
                  msg.msgContent =
                    '<a class="group_prompt" data-account="' +
                    (msg.admin || msg.member) +
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupOpen') + rxVue.$t('last.groupManageInvite'));
                }
                ...
                if (checkAdminFlag == 1) {
                  ...
                  msg.msgContent =
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupOpen') + rxVue.$t('last.groupInviteConfirm'));
                } else {
                  msg.msgContent =
                    '<a class="group_prompt" data-account="' +
                    (msg.admin || msg.member) +
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupClose') + rxVue.$t('last.groupInviteConfirm'));
                }
                ...
                if (qrCodeJoinFlag == 1) {
                  ...
                  msg.msgContent =
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupOpen') + rxVue.$t('last.groupCodeInvite'));
                } else {
                  msg.msgContent =
                    '<a class="group_prompt" data-account="' +
                    (msg.admin || msg.member) +
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupClose') + rxVue.$t('last.groupCodeInvite'));
                }
                ...
                if (linkJoinFlag == 1) {
                  ...
                  msg.msgContent =
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupOpen') + rxVue.$t('last.groupLinkinvite'));
                } else {
                  msg.msgContent =
                    '<a class="group_prompt" data-account="' +
                    (msg.admin || msg.member) +
                    ...
                    (msg.adminName || msg.nickName) +
                    '</a> ' +
                    (rxVue.$t('last.groupClose') + rxVue.$t('last.groupLinkinvite'));
                }
            ...
            case '14':
              // 待确认 判断当前操作人员是否是自己
              if (
                msg.admin == store['a' /* default */].state.user_account ||
                (msg.msgDomain &&
                  msg.msgDomain.admin == store['a' /* default */].state.user_account)
              ) {
                msg.msgContent =
                  rxVue.$t('connect.you') +
                  rxVue.$t('last.groupInviteTip') +
                  str +
                  rxVue.$t('last.beenInvite');
              } else {
                msg.msgContent =
                  '<a class="group_prompt" data-account="' +
                  msg.admin +
            ...
            case '20':
              ...
              msg.msgContent =
                ...
                (msg.adminName || msg.nickName) +
                '</a> ' +
                rxVue.$t('last.groupUnMute');
              break;
            case '21':
              if (
                msg.memberList.length &&
                msg.memberList[0].member == store['a' /* default */].state.user_account
              ) {
                msg.msgContent = rxVue.$t('connect.you') + rxVue.$t('last.groupMediaCall');
              } else {
                msg.msgContent =
                  '<a class="group_prompt" data-account="' +
                  msg.memberList[0].member +
                  '">' +
                  msg.memberList[0].nickName +
                  '</a> ' +
                  rxVue.$t('last.groupMediaCall');
              }
              break;
            case '24':
    ...
    /* harmony default export */ var addPerson = {
      ...
      mounted: function mounted() {
        ...
        this.personList = [].concat(
          toConsumableArray_default()(this.personList),
          toConsumableArray_default()(this.selected)
        );
      },
    };
    ...
    var render = function () {
      ...
      return _c('div', { staticClass: 'addPerson' }, [
        _c('p', { staticClass: 'title' }, [
          _vm._v('添加人员\n        '),
          _c('span', {
            staticClass: 'iconfont icon-popup_closex1 closeModal',
            on: {
              click: function ($event) {
                $event.stopPropagation();
                return _vm.closeAddModal(false);
              },
            },
          }),
        ]),
        ...
        _c(
          ...
          [
            _c(
              'el-form',
              { ref: 'personRef', attrs: { model: _vm.person, rules: _vm.personRules } },
              [
                _c(
                  'el-form-item',
                  { attrs: { prop: 'account' } },
                  [
                    _c(
                      'el-input',
                      {
                        ...
                        attrs: {
                          disabled: _vm.personList.length == _vm.len,
                          placeholder: '请输入被邀请者账号',
                        },
                        model: {
                          value: _vm.person.account,
                          callback: function ($$v) {
                            _vm.$set(
                              _vm.person,
                              'account',
                        ...
                        ? _c(
                            'span',
                            {
                              ...
                              on: {
                                click: function ($event) {
                                  $event.stopPropagation();
                                  return _vm.deletePer(item.account);
                                },
                              },
                            },
                            [_vm._v('x')]
              ...
              _c(
                'span',
                {
                  ...
                  on: {
                    click: function ($event) {
                      $event.stopPropagation();
                      return _vm.callback(_vm.personList);
                    },
                  },
                },
      ...
      methods: {
        ...
        meetInviteHangup: function meetInviteHangup() {
          this.rejectInvitation(
            this.inviteMsg.msgContent.confId,
            function (res) {},
            function (err) {}
          );
    ...
    var inviteModel_render = function () {
      var _vm = this;
      var _h = _vm.$createElement;
      var _c = _vm._self._c || _h;
        ...
        _c('div', { staticClass: 'main' }, [
          _c('p', { staticClass: 'title' }, [
            _c('span', { staticClass: 'time' }, [
              _vm._v(
                _vm._s(_vm.inviteMsg.msgContent && _vm.inviteMsg.msgContent.inviterName) +
                  _vm._s(_vm.$t('last.meetInvite')) +
                  _vm._s(_vm.inviteMsg.msgContent && _vm.inviteMsg.msgContent.confName)
              ),
            ]),
            _vm._v(' '),
            _c('span', { staticClass: 'btn' }, [
              _c('i', { on: { click: _vm.meetInviteHangup } }, [_vm._v('×')]),
            ]),
          ]),
          _vm._v(' '),
          _c('div', { staticClass: 'btnGroup' }, [
            _c('span', { staticClass: 'rx_cancel cancel', on: { click: _vm.meetInviteHangup } }, [
              _vm._v(_vm._s(_vm.$t('btn.refuse'))),
            ]),
            _vm._v(' '),
            _c('span', { staticClass: 'rx_btn confirm', on: { click: _vm.hangOn } }, [
              _vm._v(_vm._s(_vm.hangOnText)),
            ]),
          ]),
        ]),
      ]);
    ...
    var inviteModel_esExports = {
      render: inviteModel_render,
      staticRenderFns: inviteModel_staticRenderFns,
    };
    ...
    /* harmony default export */ var yuntongxun = {
      ...
      computed: extends_default()(
        ...
        Object(vuex_esm['b' /* mapGetters */])(['user_account'])
      ),
      created: function created() {
        ...
        if (!account) {
          ...
          if (!!LoginServe) {
            LoginServe =
              LoginServe && typeof LoginServe === 'string' ? JSON.parse(LoginServe) : LoginServe;
            ...
            if (data.msgType == 50) {
              ...
              if (data.msgContent.noteType == 6) {
                ...
                if (data.msgContent.action == 56 && data.msgContent.invitee == _this.user_account) {
                  if (
                    data.msgContent.members.length &&
                    data.msgContent.members[0].deviceType !== '21'
                  ) {
                    //会议被其他端拒绝
                  ...
                  data.msgContent.action == 153 &&
                  data.msgContent.invitee == _this.user_account
                ) {
    ...
    // CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-f1a6f024","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/yuntongxun/yuntongxun.vue
    var yuntongxun_render = function () {
      var _vm = this;
      var _h = _vm.$createElement;
      var _c = _vm._self._c || _h;
      return _c('div', { staticClass: 'bg' }, [
        _c(
          ...
          [
            _vm.toggleFlag
              ? _c('div', { staticClass: 'selfInfo' }, [
                  _c('dl', [
                    _c('dt', { staticClass: 'headimg' }, [
                      _c(
                        'span',
                        {
                          staticClass: 'img',
                          style: { backgroundImage: _vm.getcolor(_vm.LoginServe.UserId) },
                        },
                        [_vm._v(_vm._s(_vm.LoginServe.Profile.NickName))]
                      ),
                    ]),
                    _vm._v(' '),
                    _c('dd', { staticClass: 'userName' }, [
                      _vm._v(_vm._s(_vm.LoginServe.Profile.NickName)),
                    ]),
                  ]),
                  _vm._v(' '),
                  _c(
                    'div',
                    {
                      ...
                      on: {
                        click: function ($event) {
                          $event.stopPropagation();
                          return _vm.switchAccount($event);
                        },
                      },
                    },
                    [_vm._v('退出登录')]
              ...
              : _vm._e(),
            _vm._v(' '),
            _c('keep-alive', [_c('router-view', { ref: 'headerChild' })], 1),
          ],
          1
        ),
        _vm._v(' '),
          ...
          ? _c(
              ...
              [
                _c('add-person', {
                  attrs: {
                    len: _vm.len,
                    closeAddModal: _vm.addModelFlag,
        ...
        _vm.v3InviteModel
          ? _c(
              'div',
              { staticClass: 'shadow v3InviteModel' },
              [_c('invite-model', { attrs: { inviteMsg: _vm.inviteMsg } })],
              1
            )
          : _vm._e(),
      ]);
    ...
    var yuntongxun_esExports = {
      render: yuntongxun_render,
      staticRenderFns: yuntongxun_staticRenderFns,
    };
    ...
    /* scopeId */
    var yuntongxun___vue_scopeId__ = 'data-v-f1a6f024';
    /* moduleIdentifier (server only) */
    ...
    /* harmony default export */ var components_yuntongxun_yuntongxun = (__webpack_exports__[
      'default'
    ] = yuntongxun_Component.exports);

    /***/
  },
});
//# sourceMappingURL=3.e416e851156f6d0de55d.js.map
