webpackJsonp([1], {
  ...
  /***/ '5Xk0': /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    var get_own_property_names_default =
      /*#__PURE__*/ __webpack_require__.n(get_own_property_names);
    ...
    /* harmony default export */ var meetingHeader = {
      ...
      watch: {
        roomInfo: function roomInfo(val) {
          ...
          this.meetingTime =
            parseInt((time - new Date(val.startTime).getTime()) / 1000) < 0
              ? 0
              : parseInt((time - new Date(val.startTime).getTime()) / 1000);
        },
      },
      ...
      methods: {
        ...
        joinWbRoom: function joinWbRoom() {
          this.$parent.joinWhiteBoardRoom(
            Number(this.$parent.whiteBoardRoomId),
            this.$parent.whiteBoardUserId
          );
        },
        autoTime: function autoTime() {
          ...
          setInterval(function () {
            ...
            _this.meetTimeHour =
              parseInt(_this.meetingTime / 3600) > 9
                ? parseInt(_this.meetingTime / 3600)
                : '0' + parseInt(_this.meetingTime / 3600);
            ...
            _c(
              ...
              [
                _c('el-col', { attrs: { span: 8 } }, [
                  _c('span', { staticClass: 'meetTime' }, [
                    _vm._v(
                      _vm._s(_vm.meetTimeHour + ':' + _vm.meetTimeMinute + ':' + _vm.meetTimeSecond)
                    ),
                  ]),
                ]),
                _vm._v(' '),
                _c('el-col', { staticClass: 'tc', attrs: { span: 8 } }, [
                  _c('span', [
                    _vm._v(
                      _vm._s(_vm.roomInfo.confName) +
                        '    ' +
                        _vm._s(_vm.$t('meeting.meetingNumber')) +
                        ':' +
                        _vm._s(_vm.roomInfo.confId)
                    ),
                  ]),
                ]),
                _vm._v(' '),
                    ...
                    _c(
                      'el-tooltip',
                      {
                        attrs: {
                          effect: 'dark',
                          content: _vm.isHost
                            ? _vm.$t('meeting.leaveEndTheMeeting')
                            : _vm.$t('group.leaveMeet'),
                          placement: 'top',
                        },
                      },
                      [
                        _c('div', { staticClass: 'CLoseBtnBg', on: { click: _vm.leaveMeet } }, [
                          _c('i', {
                            staticClass: 'RSIcon RSIcon-guaduan',
                      ...
                      ? _c(
                          'el-tooltip',
                          {
                            attrs: {
                              effect: 'dark',
                              placement: 'top',
                              content: _vm.$t('meeting.minimizeTheWindow'),
                            },
                          },
                          [
                            _c(
                              'div',
                              { staticClass: 'minimizePage', on: { click: _vm.minimizePage } },
                              [
                                _c('i', {
                    ...
                    _vm.showShareBtn
                      ? _c(
                          'el-tooltip',
                          {
                            attrs: {
                              effect: 'dark',
                              content: _vm.$t('meeting.whiteSharing'),
                              placement: 'top',
                            },
                          },
                          [
                            _c(
                              'div',
                              { staticClass: 'screen-share', on: { click: _vm.joinWbRoom } },
                              [
                                _c('i', {
                                  staticClass: 'el-icon el-icon-s-platform',
                                  staticStyle: { 'font-size': '28px' },
                                }),
                              ]
                            ),
                    ...
                    [
                      _vm.confTopic && _vm.confTopic.length == 0
                        ? _c('div', { staticClass: 'emptyMeetTopic' }, [
                            _c('p', [
                              _c('img', { attrs: { src: __webpack_require__('YxoK'), alt: '' } }),
                            ]),
                            _vm._v(' '),
                              ...
                              [
                                ...
                                _c(
                                  ...
                                  [
                                    _c('el-input', {
                                      attrs: {
                                        placeholder: _vm.$t('last.chatTip'),
                                        maxlength: '20',
                                        clearable: '',
                                      },
                                      model: {
      ...
      methods: {
        ...
        chooseDelayTime: function chooseDelayTime(nextEndTime) {
          ...
          if (this.tryMaxDuration > 0 && this.tryMaxDuration < 14) {
            // disabled
            this.delayDisabled15 =
              this.delayDisabled30 =
              this.delayDisabled45 =
              this.delayDisabled60 =
                true;
          ...
          _c(
            ...
            [
              _c('p', { staticClass: 'prolongTips' }, [
                _c('span', { staticStyle: { color: '#FF3B3B' } }, [
                  _vm._v(_vm._s(_vm.$t('last.tenMinu'))),
                ]),
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(' '),
                  _c('el-radio', { attrs: { label: 15, disabled: _vm.delayDisabled15 } }, [
                    _vm._v(_vm._s(_vm.$t('last.minu15'))),
                  ]),
                  _vm._v(' '),
                  _c('el-radio', { attrs: { label: 30, disabled: _vm.delayDisabled30 } }, [
                    _vm._v(_vm._s(_vm.$t('last.minu30'))),
                  ]),
                  _vm._v(' '),
                  _c('el-radio', { attrs: { label: 45, disabled: _vm.delayDisabled45 } }, [
                    _vm._v(_vm._s(_vm.$t('last.minu45'))),
                  ]),
                  _vm._v(' '),
                  _c('el-radio', { attrs: { label: 60, disabled: _vm.delayDisabled60 } }, [
                    _vm._v(_vm._s(_vm.$t('last.minu60'))),
                  ]),
                ],
                1
              ),
    ...
    /* harmony default export */ var merberlist = {
      ...
      computed: extends_default()(
        {},
        Object(vuex_esm['b' /* mapGetters */])(['memberInObj', 'meetInfo', 'memberOutObj'])
      ),
      ...
      methods: {
        ...
        hostTransfer: function hostTransfer(user) {
          ...
          this.$confirm(
            this.$t('btn.determine') + user.userName + this.$t('last.setHoster') + '？',
            this.$t('modelMessage.prompt'),
            {
        ...
        kictout: function kictout(user) {
          ...
          this.$confirm(
            this.$t('btn.determine') + name + this.$t('meeting.removedFromMeeting') + '？',
            this.$t('modelMessage.prompt'),
            {
              confirmButtonText: this.$t('btn.determine'),
              cancelButtonText: this.$t('btn.cancel'),
                        ...
                        'el-tab-pane',
                        {
                          attrs: {
                            label:
                              _vm.$t('last.memberIn') +
                              '(' +
                              Object.getOwnPropertyNames(_vm.memberInObj).length +
                              ')',
                            name: '1',
                          },
                        },
                                    ...
                                    _c(
                                      ...
                                      [
                                          ...
                                          _c('div', { staticClass: 'img' }, [
                                            user.photourl
                                              ...
                                              : _c(
                                                  ...
                                                  {
                                                    style: {
                                                      backgroundImage: _vm.getcolor(user.account),
                                                    },
                                                  },
                                                  [
                                                    _vm._v(
                                                      _vm._s(_vm._f('nameslice')(user.userName))
                                                    ),
                                                  ]
                                                ),
                                          ]),
                                        ...
                                        _c('el-col', { staticClass: 'tl', attrs: { span: 10 } }, [
                                                ...
                                                directives: [
                                                  {
                                                    name: 'show',
                                                    rawName: 'v-show',
                                                    value: _vm.IsHost(user.roleId),
                                                    expression: 'IsHost(user.roleId)',
                                                  },
                                                ],
                                              },
                                              [
                                                _vm._v(
                                                  '(' + _vm._s(_vm.$t('meeting.moderator')) + ')'
                                                ),
                                              ]
                                            ),
                                          ]),
                                          _vm._v(' '),
                                          _c('p', [
                                            _vm._v(_vm._s(_vm._f('getTerminalUA')(user.memberId))),
                                          ]),
                                        ]),
                                        _vm._v(' '),
                                        _c(
                                          ...
                                          [
                                              ...
                                              directives: [
                                                {
                                                  ...
                                                  rawName: 'v-show',
                                                  value:
                                                    user.state & 0x00020000 && user.roleId == 11,
                                                  expression:
                                                    '(user.state&0x00020000)&&user.roleId==11',
                                                },
                                              ],
                                              ...
                                              directives: [
                                                {
                                                  name: 'show',
                                                  rawName: 'v-show',
                                                  value: !user.isOpenAudio,
                                                  expression: '!user.isOpenAudio',
                                                },
                                              ],
                                                ...
                                                directives: [
                                                  {
                                                    ...
                                                    value:
                                                      user.isOpenAudio &&
                                                      user.memberId !== _vm.voiceIncentiveId,
                                                    expression:
                                                      'user.isOpenAudio && user.memberId !== voiceIncentiveId',
                                                  },
                                                ],
                                              ...
                                              [
                                                _c(
                                                  ...
                                                  [
                                                    _c('use', {
                                                      attrs: {
                                                        'xlink:href': '#RSIcon-kaiqimaikefeng1',
                                                      },
                                                    }),
                                                  ]
                                                ),
                                            ...
                                            _c('i', {
                                              ...
                                              staticClass:
                                                'iconfont icon-yuyinzhengzaishuohua colaf84',
                                            }),
                                            _vm._v(' '),
                                            _c('i', {
                                              directives: [
                                                {
                                                  name: 'show',
                                                  rawName: 'v-show',
                                                  value: user.isOpenVideo,
                                                  expression: 'user.isOpenVideo',
                                                },
                                              ],
                                            ...
                                            _c(
                                                ...
                                                directives: [
                                                  {
                                                    ...
                                                    expression:
                                                      '(isHost || user.memberId === SelfMeetUserId)',
                                                  },
                                                ],
                                              ...
                                              [
                                                _c('span', { staticClass: 'el-dropdown-link' }, [
                                                  _c('i', {
                                                    staticClass: 'RSIcon RSIcon-gengduo',
                                                    staticStyle: { 'font-size': '20px' },
                                                  }),
                                                ]),
                                                _vm._v(' '),
                                                        ...
                                                        directives: [
                                                          {
                                                            ...
                                                            value:
                                                              _vm.isHost &&
                                                              _vm.SelfMeetUserId != user.memberId &&
                                                              !_vm.IsHost(user.roleId),
                                                            expression:
                                                              'isHost&&SelfMeetUserId!=user.memberId && !IsHost(user.roleId)',
                                                          },
                                                        ],
                                                      },
                                                      [
                                                        ...
                                                        directives: [
                                                          {
                                                            ...
                                                            value:
                                                              ...
                                                              _vm.SelfMeetUserId != user.memberId,
                                                            expression:
                                                              'isHost&&SelfMeetUserId!=user.memberId',
                                                          },
                                                        ],
                                                      },
                                                      [
                                                        _c(
                                                          ...
                                                          [
                                                            _vm._v(
                                                              _vm._s(
                                                                _vm.$t('meeting.removedFromMeeting')
                                                              )
                                                            ),
                                                          ]
                                                        ),
                      ...
                      Object.getOwnPropertyNames(_vm.memberOutObj).length > 0
                        ? _c(
                            'el-tab-pane',
                            {
                              attrs: {
                                label:
                                  _vm.$t('meeting.waitingForEnter') +
                                  '(' +
                                  Object.getOwnPropertyNames(_vm.memberOutObj).length +
                                  ')',
                                name: '3',
                              },
                            },
                                              ...
                                              _c('div', { staticClass: 'img' }, [
                                                item.photourl
                                                  ...
                                                  : _c(
                                                      ...
                                                      [
                                                        _vm._v(
                                                          _vm._s(_vm._f('nameslice')(item.userName))
                                                        ),
                                                      ]
                                                    ),
                                              ]),
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                value:
                                                                  ...
                                                                  _vm.SelfMeetUserId !=
                                                                    item.memberId,
                                                                expression:
                                                                  'isHost&&SelfMeetUserId!=item.memberId',
                                                              },
                                                            ],
                                                          },
                                                          [
                                      ...
                                      _c(
                                        ...
                                        [
                                          ...
                                          _c('el-col', { staticClass: 'tl', attrs: { span: 10 } }, [
                                            ...
                                            _c('p', [
                                              _vm._v(
                                                _vm._s(_vm._f('getTerminalUA')(user.memberId))
                                              ),
                                            ]),
                                          ]),
                                          _vm._v(' '),
                                          _c(
                                            ...
                                            [
                                              ...
                                              _c('i', {
                                                ...
                                                staticClass:
                                                  'RSIcon RSIcon-kaiqishexiangtou colaf84',
                                                staticStyle: { 'font-size': '35px' },
                                              }),
                                              _vm._v(' '),
                                              _c('i', {
                                                ...
                                                staticClass:
                                                  'RSIcon RSIcon-guanbishexiangtou colred',
                                                staticStyle: { 'font-size': '35px' },
                                              }),
                                              _vm._v(' '),
                                              _c(
                                                          ...
                                                          directives: [
                                                            {
                                                              ...
                                                              value:
                                                                ...
                                                                user.isOpenAudio,
                                                              expression:
                                                                '(isHost||user.memberId==SelfMeetUserId)&&(user.isOpenAudio)',
                                                            },
                                                          ],
                                                        },
                                                        [
                                                          ...
                                                          directives: [
                                                            {
                                                              ...
                                                              value:
                                                                ...
                                                                user.isOpenVideo,
                                                              expression:
                                                                '(isHost||user.memberId==SelfMeetUserId)&&(user.isOpenVideo)',
                                                            },
                                                          ],
                                                        },
                                                        [
                                                          ...
                                                          directives: [
                                                            {
                                                              ...
                                                              rawName: 'v-show',
                                                              value:
                                                                user.memberId == _vm.screenUserId,
                                                              expression:
                                                                'user.memberId==screenUserId',
                                                            },
                                                          ],
                                                        },
                                                        [
                            ...
                            [
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      _vm.isAllmuet ? _vm.$t('last.unMute') : _vm.$t('last.mute')
                                    )
                                  ),
                                ]
                              ),
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    '\n\t\t\t\t\t\t\t' +
                                      _vm._s(
                                        _vm.isAllCloseCamera
                                          ? _vm.$t('last.unOpenCamera')
                                          : _vm.$t('last.closeCamera')
                                      )
                                  ),
                                ]
                              ),
    ...
    var merberlist_esExports = {
      render: merberlist_render,
      staticRenderFns: merberlist_staticRenderFns,
    };
    ...
    /* harmony default export */ var setMainHall = {
      ...
      computed: extends_default()(
        {},
        Object(vuex_esm['b' /* mapGetters */])(['memberInObj', 'meetInfo', 'mainVenue'])
      ),
      watch: {
                  ...
                  [
                    _c(
                      ...
                      [
                        _c('el-col', { attrs: { span: 4 } }, [
                          _c('img', {
                            attrs: { src: user.photoUrl ? user.photoUrl : _vm.defaultImg, alt: '' },
    ...
    var setMainHall_esExports = {
      render: setMainHall_render,
      staticRenderFns: setMainHall_staticRenderFns,
    };
          ...
          for (var i = 0; i < this.checkList.length; i++) {
            ...
            for (var j = 0; j < this.merberLists.length; j++) {
              ...
              if (this.checkList[i] == this.merberLists[j].memberId) {
                (positionObj.pos = position),
                  (positionObj.interval = interval),
                  (screenObj.userName = this.merberLists[j].userName);
                (screenObj.memberID = this.checkList[i]),
                  (screenObj.idType = this.merberLists[j].idType),
                  screenArr.push(screenObj);
            ...
            [
                            ...
                            [
                              _c(
                                ...
                                [
                                  ...
                                  _vm._v(' '),
                                  _c('span', [
                                    _vm._v(_vm._s(item.isChecked) + ' ' + _vm._s(item.userName)),
                                  ]),
                                ]
                              ),
                            ],
                      ...
                      _c(
                        ...
                        [
                          _vm.checkIsAll == 1
                            ...
                            : _vm._e(),
                          _vm._v(' '),
                          _c('el-col', { staticStyle: { height: '100px' } }, [
                            _c('div', { staticClass: 'oneToOneMyself' }, [
                              _c('p', [_vm._v('自己不可指定')]),
                            ]),
                          ]),
                        ],
                ...
                ? _c(
                    ...
                    [
                      ...
                      _c('el-col', { staticStyle: { height: '300px' }, attrs: { span: 4 } }, [
                        _c('div', { staticClass: 'dialogMyself' }, [
                          _c('p', [_vm._v('自己不可指定')]),
                        ]),
                        _vm._v(' '),
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    'el-button',
                    { attrs: { type: 'primary' }, on: { click: _vm.confirmAssign } },
                    [_vm._v('启用布局')]
                  ),
                ],
                1
    ...
    var setLayout_esExports = {
      render: setLayout_render,
      staticRenderFns: setLayout_staticRenderFns,
    };
                ...
                directives: [
                  {
                    name: 'show',
                    rawName: 'v-show',
                    value: _vm.IsHost(_vm.user.roleId),
                    expression: 'IsHost(user.roleId)',
                  },
                ],
              },
    ...
    var speakstaus_esExports = {
      render: speakstaus_render,
      staticRenderFns: speakstaus_staticRenderFns,
    };
    ...
    /* harmony default export */ var meetVideo = {
      ...
      computed: extends_default()(
        {},
        Object(vuex_esm['b' /* mapGetters */])(['memberInObj', 'streamIdObj', 'streamObj']),
        {
          user: function user() {
      ...
      watch: {
        ...
        streamIdObj: {
          ...
          handler: function handler(newVal, oldVal) {
            ...
            if (
              this.userId &&
              this.streamObj[this.userId] &&
              newVal[this.userId] !== oldVal[this.userId]
            ) {
      ...
      methods: {
        ...
        videoShow: function videoShow(stream) {
          if (this.$refs['selfvideo'] && stream && stream.id) {
            ...
            console.log(
              this.$refs['selfvideo'].srcObject,
              '渲染视频流,id:' + this.userId + ',userName:' + this.user.userName
            );
          }
        },
        noImgFind: function noImgFind(event) {
      ...
      return _c(
        ...
        [
          ...
          _c('img', {
            ...
            attrs: {
              src:
                _vm.memberInObj[_vm.userId] && _vm.memberInObj[_vm.userId].photourl
                  ? _vm.memberInObj[_vm.userId].photourl
                  : _vm.defaultImg,
    ...
    var meetVideo_esExports = {
      render: meetVideo_render,
      staticRenderFns: meetVideo_staticRenderFns,
    };
    ...
    /* harmony default export */ var selfmeetVideo = {
      ...
      computed: extends_default()(
        {},
        Object(vuex_esm['b' /* mapGetters */])(['memberInObj', 'streamObj', 'streamIdObj']),
        {
          user: function user() {
            if (this.userId && this.$store.getters.getMemberInById(this.userId)) {
              var user = this.$store.getters.getMemberInById(this.userId);
    ...
    var selfmeetVideo_esExports = {
      render: selfmeetVideo_render,
      staticRenderFns: selfmeetVideo_staticRenderFns,
    };
    ...
    /* harmony default export */ var components_meeting_selfmeetVideo =
      selfmeetVideo_Component.exports;
    ...
    /* harmony default export */ var whiteBoard = {
      ...
      computed: extends_default()(
        ...
        Object(vuex_esm['b' /* mapGetters */])(['meetInfo'])
      ),
      watch: {
      ...
      data: function data() {
        return {
          ...
          controllerList: [
            ...
            {
              id: 2,
              name: this.$t('last.brush'),
              className: 'brush',
              children: 'BruchBoxShow',
              isActive: 'active',
            },
            ...
            {
              id: 5,
              name: this.$t('last.layout'),
              className: 'layout',
              children: 'LayoutBoxShow',
              isActive: '',
            },
          ...
          fileAccept:
            '.png,.jpg,.jpeg,.pdf,.ppt,.pps,.pptx,.pot,.ppa,.doc,.docx,.dot,.xls,.xlt,.xlsx',
          isReconnect: false,
        };
      },
      ...
      methods: {
        ...
        closeAllBox: function closeAllBox() {
          ...
          ['BruchBoxShow', 'ColorBoxShow', 'LayoutBoxShow', 'MoreBoxShow', 'DocBoxShow'].forEach(
            function (it) {
        ...
        handleClickColor: function handleClickColor(item, index) {
          this.ColorBoxShow.list.forEach(function (it, i) {
            ...
            if (index === i) {
              ...
              // 设置颜色
              // 224,32,32,1
              var builder = new (Function.prototype.bind.apply(
                YTX_WBSS_API.ColorBuilder,
                [null].concat(toConsumableArray_default()(it.rgb), [255])
              ))();
        ...
        lockLabel: function lockLabel(value) {
          ...
          RL_MEET.LockMeet(
            ...
            function (res) {
              self.$message.info(
                _this7.$t('last.noteLock') +
                  (_this7.isLock ? _this7.$t('last.open') : _this7.$t('btn.close'))
              );
            },
            function (error) {
              console.info(error);
        ...
        [
          _c('div', { staticClass: 'whiteboard-header' }, [
            _c('span', { staticClass: 'txt' }, [
              _vm._v(
                '\n      ' +
                  _vm._s(
                    _vm.isLock && !_vm.isWhiteBoarOrganiser
                      ? _vm.$t('last.looking')
                      : _vm.$t('last.noting')
                  ) +
                  '\n    '
          ...
          _c(
            'div',
            {
              ...
              class: {
                controller: true,
                disabled: (_vm.isLock && !_vm.isWhiteBoarOrganiser) || _vm.isReconnect,
              },
            },
            [
              _c(
                ...
                _vm._l(_vm.controllerList, function (item) {
                  return (item.className !== 'lock' && item.className !== 'delete') ||
                    ((item.className === 'lock' || item.className === 'delete') &&
                        ...
                        return _c(
                          ...
                          [
                            item.wbssDocId == 0
                              ...
                              ? _c('img', {
                                  attrs: { src: _vm.fileObj[item.wbssDocId].path, alt: '' },
                                })
                              : _c('img', {
                                  attrs: {
                                    src:
                                      _vm.fileObj[item.wbssDocId] &&
                                      _vm.fileObj[item.wbssDocId].fileType
                                        ? __webpack_require__('Hmds')(
                                            './FileTypeS_' +
                                              _vm.fileObj[item.wbssDocId].fileType +
                                              '.png'
                                          )
            ...
            directives: [
              {
                name: 'show',
                rawName: 'v-show',
                value: _vm.isWhiteBoardInput,
                expression: 'isWhiteBoardInput',
              },
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _c('p', { staticStyle: { 'font-size': '18px', 'margin-bottom': '20px' } }, [
                    _vm._v(_vm._s(_vm.$t('last.closeWbTip'))),
                  ]),
                  _vm._v(' '),
                  _vm.isWhiteBoarOrganiser
                    ? _c(
    ...
    var whiteBoard_esExports = {
      render: whiteBoard_render,
      staticRenderFns: whiteBoard_staticRenderFns,
    };
    ...
    /* harmony default export */ var setRoundTour = {
      ...
      methods: extends_default()(
        {},
        Object(vuex_esm['c' /* mapMutations */])(['SET_MeetSetting']),
        {
          handleClose: function handleClose() {
          ...
          _c('div', { staticClass: 'roundTourCon' }, [
            _c('ul', [
              ...
              _c(
                ...
                [
                  _c('span', { staticClass: 'text' }, [
                    _vm._v(_vm._s(_vm.$t('last.roundInterval')) + '(s)'),
                  ]),
                  _vm._v(' '),
                  _c(
                    'el-select',
              ...
              _c(
                ...
                [
                  _c('span', { staticClass: 'text' }, [
                    _vm._v(_vm._s(_vm.$t('last.skipNoImgeUser'))),
                  ]),
                  _vm._v(' '),
                  _c('el-switch', {
                    attrs: { 'inactive-color': '#dadada' },
            ...
            [
              ...
              _c(
                'el-button',
                {
                  staticStyle: { 'margin-left': '30px' },
                  attrs: { type: 'primary' },
                  on: { click: _vm.setRoundTourEvent },
                },
                [_vm._v(_vm._s(_vm.$t('btn.determine')))]
              ),
            ],
    ...
    var setRoundTour_esExports = {
      render: setRoundTour_render,
      staticRenderFns: setRoundTour_staticRenderFns,
    };
    ...
    /* harmony default export */ var components_meeting_setRoundTour =
      setRoundTour_Component.exports;
    ...
    /* harmony default export */ var Meeting = {
          ...
          handler: function handler(newVal, oldVal) {
            ...
            oldVal.forEach(function (item) {
              if (
                ...
                item !== _this2.SelfMeetUserId &&
                item.indexOf('=screenShare') === -1
              ) {
      ...
      created: function created() {
        // this.YHSDKLogin();
        var fontSize =
          window.CurrentUse && window.CurrentUser.systemSettings
            ? window.CurrentUser.systemSettings.FontSize
            : 100;
      ...
      methods: extends_default()(
        {},
        Object(vuex_esm['c' /* mapMutations */])(['SET_AllMessages']),
        {
          ...
          GetUserPhoto: function GetUserPhoto(memberId) {
            if (
              (this.memberInObj[memberId] &&
                (this.memberInObj[memberId].photoUrl ||
                  this.memberInObj[memberId].photoUrl === false)) ||
              (this.memberOutObj[memberId] &&
                (this.memberOutObj[memberId].photoUrl ||
                  this.memberOutObj[memberId].photoUrl === false))
            )
              return;
          ...
          INIT: function INIT() {
            ...
            if (self.LoginServe.Profile && self.LoginServe.Profile.NickName) {
              ...
              console.log(
                '会前：登录',
                '\u767B\u5F55userid:' + self.LoginServe.UserId + ',userName:' + self.userName
              );
            ...
            YTX_WBSS_API.joinRoom(
              ...
              function (res) {
                ...
                self.$set(_this6, 'wbInfo', {
                  ...
                  totalPage:
                    res['wbssRoomInfoMap'].wbssDocInfoDataArray[
                      res['wbssRoomInfoMap'].wbssCurrentDocId
                    ].wbssDocTotalPage,
            ...
            YTX_WBSS_API.leaveRoom(
              ...
              function (err) {
                if (!destroy) {
                  ...
                  self.$alert(
                    self.$t('meeting.abnormalExitingWhiteboard'),
                    self.$t('modelMessage.prompt'),
                    {
          ...
          shareWhiteBoard: function shareWhiteBoard() {
            ...
            // self.$nextTick(to => {
            var builder = new YTX_WBSS_API.CreateRoomBuilder(
              1,
              '123456',
              100,
              0,
            ...
            YTX_WBSS_API.createRoom(
              ...
              function (resp) {
                ...
                self.$set(self, 'wbInfo', {
                  ...
                  totalPage:
                    resp['wbssRoomInfoMap'].wbssDocInfoDataArray[
                      resp['wbssRoomInfoMap'].wbssCurrentDocId
                    ].wbssDocTotalPage,
          ...
          YHSDKJoinMeet: function YHSDKJoinMeet() {
            ...
            if (this.joinMeetingState && this.joinMeetingState.joinMeetingState)
              joinMeetRoomBuilder.setJoinState(this.joinMeetingState.joinMeetingState);
          ...
          LeaveMeetBtn: function LeaveMeetBtn() {
            ...
            if (this.isHost) {
              ...
              this.$confirm(
                this.$t('meeting.goingToExitTheMeeting'),
                this.$t('modelMessage.prompt'),
                {
                  confirmButtonText: this.$t('btn.determine'),
                  cancelButtonText: this.$t('btn.cancel'),
          ...
          handUser: function handUser() {
            ...
            for (var user in self.MerberiList) {
              if (
                self.MerberiList[user].state & 0x00020000 &&
                self.MerberiList[user].roleId == 11
              ) {
                handCount++;
                if (handCount < 3) {
          ...
          openMicrophone: function openMicrophone(notip) {
            ...
            console.debug('--打开麦克风');
            if (
              this.memberInObj[this.SelfMeetUserId] &&
              this.memberInObj[this.SelfMeetUserId].roleId == 11
            ) {
          ...
          inviteMerbers: function inviteMerbers() {
            ...
            var memberCount =
              this.meetInfo.maxMember -
              keys_default()(this.memberInObj).length -
              keys_default()(this.memberOutObj).length;
            self.$bus.emit(
              'addPerson',
              true,
              memberCount,
            ...
            RL_Media.GetMediaDevice(function (deviceList) {
              ...
              for (var key in deviceList) {
                ...
                if (val.kind == 'audioinput') {
                  ...
                  if (val.deviceId == 'default') {
                    currentMicrophoneID = self.CurrentMicrophoneID
          ...
          cancelReqVideo: function cancelReqVideo(cancelType, isSubScreen, memberId, callback) {
            ...
            console.log(
              ...
              'cancelType:' +
                ...
                memberId +
                '，userName：' +
                _this.memberInObj[memberId].userName
            );
            if (cancelType == 1) {
              antissrc = _this.memberInObj[memberId].videoSsrc;
            } else {
              antissrc =
                _this.memberInObj[memberId].videoSsrc || _this.memberInObj[memberId].ssSsrc;
            }
              ...
              if (e.userId) {
                if (e.mediaType == 1) {
                  ...
                  this.$message.success(
                    this.memberInObj[e.userId].userName + this.$t('meeting.screenSharingVeenStart')
                  );
                  this.screenShareIsMSG =
                    this.memberInObj[e.userId].userName + this.$t('meeting.screenSharing');
          ...
          systemMsgPush: function systemMsgPush(msg, needNotify) {
            ...
            if (!!this.isNewMeetingChat) {
              var timeDifference =
                (this.user_info &&
                  this.user_info.timeDifference &&
                  parseInt(this.user_info.timeDifference)) ||
                0;
          ...
          updateScreenMembers: function updateScreenMembers(memberId, memberIndex) {
            ...
            if (this.memberInArrary.length < 5) {
              ...
              if (
                this.IsShareIng &&
                this.shareType === 1 &&
                memberId !== this.screenUserId &&
                !memberId.includes('=screenShare')
              ) {
                playIndex = 1;
            ...
            members.forEach(function (item) {
              ...
              if (!self.memberInObj[item.memberId]) {
                ...
                if (memberOut[item.memberId]) {
                  self.MerberiList[item.memberId] = extends_default()(
                    {},
                    memberOut[item.memberId],
                    item,
                    defineProperty_default()({}, key, status)
                  );
              ...
              if (
                _this16.shareType === 1 &&
                _this16.IsShareIng &&
                item.memberId === _this16.screenUserId &&
                (item.state & 0x000008) === 0
              ) {
            ...
            if (type === 1) {
              ...
              for (var i = 0; i < obj.kickedMembers.length; i++) {
                ...
                if (memberId == self.SelfMeetUserId) {
                  ...
                  var name =
                    obj.memberId === self.SelfMeetUserId
                      ? this.$t('meeting.you')
                      : this.$t('meeting.moderator');
                  var _user = self.MerberiList[memberId] || self.memberOutObj[memberId];
                  self.systemMsgPush(
                    name +
                      this.$t('meeting.haveBeen') +
                      _user.userName +
                      this.$t('meeting.removedFromMeeting'),
                    true
                  );
            ...
            if (item.state & 0x000100) {
              ...
              if (isPullStream) {
                ...
                if (item.state & 0x000008) {
                  console.log(
                    '===入会拉取共享流===',
                    'userId:' + item.memberId + 'userName:' + item.userName
                  );
              ...
              if (memberOut[item.memberId])
                item = extends_default()({}, memberOut[item.memberId], item);
          ...
          memberInfoChange: function memberInfoChange(obj) {
            ...
            if (obj.action === NoteTypesAction['kControlNone']) {
              ...
              self.$set(
                self.MerberiList,
                item.memberId,
                extends_default()({}, self.MerberiList[item.memberId], item)
              );
              self.$store.commit('SET_MemberInObj', self.MerberiList);
              ...
              self.$set(
                self.MerberiList,
                _item.memberId,
                extends_default()({}, self.MerberiList[_item.memberId], _item)
              );
              self.$store.commit('SET_MemberInObj', self.MerberiList);
              // 如果发起屏幕共享的人是自己则不作处理;
              ...
              obj.action == 126 ||
              obj.action == NoteTypesAction['KControlStopPublishVoiceBySelf']
            ) {
              ...
              obj.members.forEach(function (item) {
                ...
                var state = (self.memberInObj[item.memberId] || self.memberOutObj[item.memberId])
                  .state;
          ...
          meetInfoChange: function meetInfoChange(obj) {
            ...
            if (obj.action == NoteTypesAction['KControlConfMaxMember']) {
              ...
              if (obj.memberId && self.SelfMeetUserId !== obj.memberId) {
                self.$message({
                  message:
                    self.memberInObj[obj.memberId].userName +
                    this.$t('meeting.closeTheWhiteboardShar'),
                  type: 'warning',
                });
          ...
          nextScreen: function nextScreen(roundTour) {
            ...
            if (!!roundTour && !!roundTour.skipNoImgeUser) {
              ...
              if (imgUserList.length < num) {
                ...
                memberInArrary = imgUserList.concat(
                  noImgUserList.slice(0, num - imgUserList.length)
                );
              }
            }
          ...
          preScreen: function preScreen() {
            ...
            PlayUserList.forEach(function (item) {
              if (_this20.memberInArrary.indexOf(item) > max)
                max = _this20.memberInArrary.indexOf(item);
            });
            ...
            if (
              ((getArr.includes(PlayUserList[0]) && getArr.length === 1 && num === 3) ||
                (num === 2 &&
                  getArr.includes(PlayUserList[0]) &&
                  getArr.includes(PlayUserList[1]) &&
                  getArr.length === 2)) &&
              max > num
            ) {
              ...
              self.getMeetInfo(function (res) {
                ...
                res.members.forEach(function (item) {
                  ...
                  if (item.memberId === self.SelfMeetUserId) {
                    ...
                    if (self.LoginServe.Profile && self.LoginServe.Profile.PhotoUrl)
                      item.photourl = self.LoginServe.Profile.PhotoUrl;
                    self.$store.commit('SET_MemberInObj', self.MerberiList);
                  } else {
      ...
      return _c(
        ...
        [
            ...
            directives: [
              {
                name: 'show',
                rawName: 'v-show',
                value: !(_vm.IsShareIng && _vm.shareType == 2),
                expression: '!(IsShareIng && shareType==2)',
              },
            ],
            ref: 'meetHeader',
            attrs: {
                    ...
                    directives: [
                      {
                        ...
                        value:
                          !_vm.MoreWithMore &&
                          Object.getOwnPropertyNames(_vm.memberInObj).length > 1,
                        expression:
                          '!MoreWithMore&&Object.getOwnPropertyNames(memberInObj).length>1',
                      },
                    ],
                  ...
                  [
                    _c(
                        ...
                        directives: [
                          {
                            name: 'show',
                            rawName: 'v-show',
                            value: _vm.IsShareIng && _vm.shareType == 1,
                            expression: 'IsShareIng && shareType == 1',
                          },
                        ],
                      ...
                      [
                        ...
                        _vm._v(' '),
                        _c('p', { staticClass: 'userNameP' }, [
                          _vm._v(_vm._s(_vm.screenShareIsMSG)),
                        ]),
                      ]
                    ),
                    _vm._v(' '),
                          ...
                          directives: [
                            {
                              name: 'show',
                              rawName: 'v-show',
                              value: !_vm.IsShareIng,
                              expression: '!IsShareIng',
                            },
                          ],
                        ...
                        directives: [
                          {
                            name: 'show',
                            rawName: 'v-show',
                            value: _vm.isshowdargLi,
                            expression: 'isshowdargLi',
                          },
                        ],
                            ...
                            directives: [
                              {
                                ...
                                value:
                                  ...
                                  (Object.getOwnPropertyNames(_vm.memberInObj).length > 4 ||
                                    (_vm.IsShareIng &&
                                      _vm.shareType == 1 &&
                                      Object.getOwnPropertyNames(_vm.memberInObj).length > 3)),
                                expression:
                                  ...
                                  directives: [
                                    {
                                      name: 'show',
                                      rawName: 'v-show',
                                      value: !_vm.PlayUserList[1],
                                      expression: '!PlayUserList[1]',
                                    },
                                  ],
                                  ...
                                  directives: [
                                    {
                                      name: 'show',
                                      rawName: 'v-show',
                                      value: !_vm.PlayUserList[2],
                                      expression: '!PlayUserList[2]',
                                    },
                                  ],
                                  staticClass: 'NoMerber',
                                },
                                  ...
                                  directives: [
                                    {
                                      name: 'show',
                                      rawName: 'v-show',
                                      value: !_vm.PlayUserList[3],
                                      expression: '!PlayUserList[3]',
                                    },
                                  ],
                                  staticClass: 'NoMerber',
                                },
                ...
                [
                  _c(
                    ...
                    [
                      _vm.needAV === 'all' ||
                      _vm.needAV === 'video' ||
                      _vm.SelfMeetUserId.includes('vistor')
                        ? _c(
                            'el-tooltip',
                            {
                              attrs: {
                                effect: 'dark',
                                content: _vm.memberInObj[_vm.SelfMeetUserId].isOpenVideo
                                  ? _vm.$t('meeting.closeCamera')
                                  : _vm.$t('meeting.openCamera'),
                                placement: 'top',
                              },
                            },
                            [
                              _c(
                                'li',
                                {
                                  ...
                                  class: {
                                    isActive: _vm.memberInObj[_vm.SelfMeetUserId].isOpenVideo,
                                  },
                                  staticStyle: { 'pointer-events': 'auto' },
                                  on: {
                                    click: function ($event) {
                                      _vm.memberInObj[_vm.SelfMeetUserId].isOpenVideo
                                        ? _vm.closeCameraAndPubVideo()
                                        : _vm.openCamera();
                                    },
                                  },
                                },
                                [
                                  _c('i', {
                                    staticClass: 'RSIcon',
                                    class: _vm.memberInObj[_vm.SelfMeetUserId].isOpenVideo
                                      ? 'RSIcon-kaiqishexiangtou'
                                      : 'RSIcon-guanbishexiangtou',
                      ...
                      (_vm.needAV === 'all' ||
                        ...
                        ? _c(
                            'el-tooltip',
                            {
                              attrs: {
                                effect: 'dark',
                                content: _vm.memberInObj[_vm.SelfMeetUserId].isOpenAudio
                                  ? _vm.$t('meeting.closeMicrophone')
                                  : _vm.$t('meeting.openMicrophone'),
                                placement: 'top',
                              },
                            },
                            [
                              _c(
                                'li',
                                {
                                  ...
                                  class: {
                                    isActive: _vm.memberInObj[_vm.SelfMeetUserId].isOpenAudio,
                                  },
                                  staticStyle: { 'pointer-events': 'auto' },
                                  on: {
                                    click: function ($event) {
                                      _vm.memberInObj[_vm.SelfMeetUserId].isOpenAudio
                                        ? _vm.closeMicrophone()
                                        : _vm.openMicrophone();
                                    },
                                  },
                                ...
                                [
                                  _c('i', {
                                    staticClass: 'RSIcon',
                                    class: _vm.memberInObj[_vm.SelfMeetUserId].isOpenAudio
                                      ? 'RSIcon-kaiqimaikefeng'
                                      : 'RSIcon-guanbimaikefeng',
                      ...
                      _c(
                        'el-tooltip',
                        {
                          ...
                          attrs: {
                            effect: 'dark',
                            content: _vm.videoStart
                              ? _vm.$t('meeting.stopRecord')
                              : _vm.$t('meeting.startRecord'),
                            placement: 'top',
                          },
                        },
                        [
                          _c(
                            ...
                            [
                              _c('i', {
                                staticClass: 'RSIcon RSIcon-luzhi',
                                staticStyle: { 'font-size': '48px' },
                              }),
                            ]
                          ),
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [
                              _c('i', {
                                staticClass: 'RSIcon RSIcon-buju',
                                staticStyle: { 'font-size': '48px' },
                              }),
                            ]
                          ),
                            ...
                            [
                              _c(
                                ...
                                [
                                  _c('span', { staticClass: 'el-dropdown-link' }, [
                                    _c('i', {
                                      staticClass: 'RSIcon RSIcon-gongxiang',
                                      staticStyle: { 'font-size': '48px' },
                                    }),
                                  ]),
                                  _vm._v(' '),
                                  _c(
                                    ...
                                    [
                                      _vm.shareType != 2
                                        ? _c('el-dropdown-item', [
                                            _c('p', { on: { click: _vm.screenShare } }, [
                                              _vm._v(_vm._s(_vm.$t('meeting.shareDesktop'))),
                                            ]),
                                          ])
                                        : _vm._e(),
                                    ],
                        ...
                        : _c(
                            'el-tooltip',
                            {
                              attrs: {
                                ...
                                content:
                                  _vm.shareType === 1
                                    ? _vm.$t('meeting.closeScreenShar')
                                    : _vm.$t('meeting.closeWhiteSharing'),
                                placement: 'top',
                              },
                            },
                            [
                              _c(
                                'li',
                                {
                                  ...
                                  on: {
                                    click: function ($event) {
                                      _vm.shareType === 1
                                        ? _vm.SelfCloseScreenShare()
                                        : _vm.closeWhiteBoardShare();
                                    },
                                  },
                                },
                                [
                                  _c('i', {
                                    staticClass: 'RSIcon RSIcon-guanbigongxiang',
                                    staticStyle: { 'font-size': '48px' },
                                  }),
                                ]
                              ),
                      ...
                      _c(
                        ...
                        [
                          _c('span', { staticClass: 'el-dropdown-link' }, [
                            _c('li', [
                              _c('i', {
                                staticClass: 'RSIcon RSIcon-yaoqing',
                                staticStyle: { 'font-size': '48px' },
                              }),
                            ]),
                          ]),
                          ...
                          _c(
                            ...
                            [
                              !(_vm.SelfMeetUserId.indexOf('vistor') > -1)
                                ? _c('el-dropdown-item', [
                                    _c('p', { on: { click: _vm.inviteMerbers } }, [
                                      _vm._v('邀请人员入会'),
                                    ]),
                                  ])
                                : _vm._e(),
                              ...
                              _c('el-dropdown-item', [
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      _vm._s(_vm.$t('connect.metting')) +
                                        _vm._s(_vm.$t('btn.share'))
                                    ),
                                  ]
                                ),
                              ]),
                      ...
                      _c(
                        'el-tooltip',
                        {
                          attrs: {
                            effect: 'dark',
                            content: _vm.$t('meeting.participant'),
                            placement: 'top',
                          },
                        },
                        [
                          _c(
                            ...
                            [
                              _c('i', {
                                staticClass: 'RSIcon RSIcon-canhuiren',
                                staticStyle: { 'font-size': '48px' },
                              }),
                            ]
                          ),
                      ...
                      _c(
                        ...
                        [
                          _c('span', { staticClass: 'el-dropdown-link' }, [
                            _c('li', [
                              _c('i', {
                                staticClass: 'RSIcon RSIcon-gengduo1',
                                staticStyle: { 'font-size': '48px' },
                              }),
                            ]),
                          ]),
                          ...
                          _c(
                            ...
                            [
                                          ...
                                          directives: [
                                            {
                                              name: 'show',
                                              rawName: 'v-show',
                                              value: _vm.isScreenlockMeet,
                                              expression: 'isScreenlockMeet',
                                            },
                                          ],
                                        },
                                          ...
                                          directives: [
                                            {
                                              name: 'show',
                                              rawName: 'v-show',
                                              value: _vm.isLockMeet,
                                              expression: 'isLockMeet',
                                            },
                                          ],
                                        },
                                        [_vm._v(_vm._s(_vm.$t('meeting.turnedOn')))]
                              ...
                              false
                                ? _c('el-dropdown-item', [
                                    _c('p', { on: { click: _vm.recordStart } }, [_vm._v('录像')]),
                                  ])
                                : _vm._e(),
                            ],
                            1
              ...
              directives: [
                {
                  name: 'show',
                  rawName: 'v-show',
                  value: _vm.handUserMsg && _vm.isHost && _vm.isAllmuet,
                  expression: 'handUserMsg&&isHost&&isAllmuet',
                },
              ],
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _c('p', { staticStyle: { 'font-size': '18px', 'margin-bottom': '20px' } }, [
                    _vm._v(_vm._s(_vm.$t('meeting.meetingConfirm'))),
                  ]),
                  _vm._v(' '),
                  _vm.isHost
                    ? _c(
          ...
          _c(
            ...
            {
              attrs: {
                title: _vm.$t('meeting.windowLayout'),
                visible: _vm.selectMain,
                modal: false,
                width: '500px',
                'close-on-click-modal': false,
              },
            ...
            [
                ...
                [
                  ...
                  _c('el-col', { attrs: { span: 12 } }, [
                    _c(
                      ...
                      [
                        _c('li', [_vm._v(_vm._s(_vm.$t('meeting.smartMode')))]),
                        _vm._v(' '),
                        _c('li'),
                        _vm._v(' '),
                        _c('li'),
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(' '),
                  _c('el-button', { attrs: { type: 'primary' }, on: { click: _vm.changelaout } }, [
                    _vm._v(_vm._s(_vm.$t('btn.determine'))),
                  ]),
                ],
                1
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(' '),
                      _c('p', { staticClass: 'chooseEqu' }, [
                        _vm._v(_vm._s(_vm.$t('meeting.speaker'))),
                      ]),
                      _vm._v(' '),
                      _c(
                        'el-select',
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c('video', {
                        ref: 'SelectVideo2',
                        staticClass: 'selfvide',
                        attrs: { muted: '', autoplay: '' },
                        domProps: { muted: true },
                      }),
                    ],
                    1
                  ...
                  _vm._v(' '),
                  _c('div', { staticClass: 'save-media', on: { click: _vm.saveSet } }, [
          ...
          _vm.memberInObj[_vm.SelfMeetUserId]
            ? _c('setMainHall', {
                attrs: { isShow: _vm.setMainHallDialog, SelfMeetUserId: _vm.SelfMeetUserId },
              })
            : _vm._e(),
          _vm._v(' '),
          ...
          _vm._v(' '),
          _c('delayed', {
            attrs: { isshow: _vm.prolongDialogVisible, willNextEndTime: _vm.nextEndTime },
          }),
          _vm._v(' '),
          _c('meetInfo', {
            attrs: { isShow: _vm.meetInfoDialog, roomInfo: _vm.meetInfo, isHost: _vm.isHost },
          }),
          _vm._v(' '),
          _vm.memberInObj[_vm.SelfMeetUserId]
            ? _c('setRoundTour', {
                attrs: { isShow: _vm.setRoundTourDialog, SelfMeetUserId: _vm.SelfMeetUserId },
              })
            : _vm._e(),
          _vm._v(' '),
          _c('setLayout', {
            attrs: {
              isShow: _vm.SetLayoutDialog,
              merberLists: _vm.MerberiList2,
              isHost: _vm.isHost,
            },
          }),
        ],
    ...
    /* harmony default export */ var components_meet_Meeting = (__webpack_exports__['default'] =
      Meeting_Component.exports);
  ...
  /***/ mbvs: /***/ function (module, exports, __webpack_require__) {
    ...
    /* WEBPACK VAR INJECTION */ (function (global, process) {
      ...
      function invokeSaveAsDialog(file, fileName) {
        ...
        var fileFullName =
          (fileName || Math.round(Math.random() * 9999999999) + 888888888) + '.' + fileExtension;
      ...
      function StereoAudioRecorder(mediaStream, config) {
        ...
        if (legalBufferValues.indexOf(bufferSize) === -1) {
          if (!config.disableLogs) {
            console.log(
              'Legal values for buffer-size are ' + JSON.stringify(legalBufferValues, null, '\t')
            );
          }
        }
      ...
      function WhammyRecorder(mediaStream, config) {
        ...
        function dropBlackFrames(
          ...
          var pixTolerance =
            _pixTolerance && _pixTolerance >= 0 && _pixTolerance <= 1 ? _pixTolerance : 0;
          var frameTolerance =
        ...
        function whammyInWebWorker(frames) {
          ...
          function generateEBML(json) {
            ...
            for (var i = 0; i < json.length; i++) {
              ...
              var padded =
                new Array(zeroes * 7 + 7 + 1 - sizeToString.length).join('0') + sizeToString;
        ...
        init: function () {
          ...
          function putInDB() {
            ...
            function getFromStore(portionName) {
              transaction.objectStore(self.dataStoreName).get(portionName).onsuccess = function (
                event
              ) {
                if (self.callback) {
      ...
      function WebAssemblyRecorder(stream, config) {
        ...
        function startRecording(stream, buffer) {
          ...
          worker.postMessage(
            config.webAssemblyPath || 'https://unpkg.com/webm-wasm@latest/dist/webm-wasm.wasm'
          );
