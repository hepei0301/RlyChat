    ...
    var e = {
        ...
        if (document.addEventListener)
          ...
          document.attachEvent('onreadystatechange', function () {
            document.readyState === 'complete' &&
              (document.detachEvent('onreadystatechange', arguments.callee), n());
          }),
      ...
      _drawPosition: function (t, n, r, i, s) {
        ...
        (e.picker.wrap.style.position = i),
          ...
          e.setBoxShadow(
            e.picker.boxS,
            t.shadow ? new e.BoxShadow(0, o, t.shadowBlur, 0, t.shadowColor) : null
          );
      },
        ...
        var n = !!e.getSliderComponent(t),
          r = [
            2 * t.insetWidth +
              2 * t.padding +
              t.width +
              (n ? 2 * t.insetWidth + e.getPadToSliderPadding(t) + t.sliderSize : 0),
            2 * t.insetWidth +
              2 * t.padding +
              t.height +
      ...
      createPalette: function () {
        ...
        if (e.isCanvasSupported) {
          ...
          (o.type = 'gradient'),
            (o.method = 'linear'),
            (o.angle = '90'),
            (o.colors = '16.67% #F0F, 33.33% #00F, 50% #0FF, 66.67% #0F0, 83.33% #FF0');
        ...
        function u() {
          ...
          (t.wrap.style.clear = 'both'),
            ...
            (t.crossBY.style.left = t.crossBX.style.top =
              Math.floor(i / 2) - Math.floor(d.pointerThickness / 2) - d.pointerBorderWidth + 'px'),
        ...
        function f() {
          ...
          if (t) {
            ...
            e.picker.sldPtrOB.style.top =
              r - (2 * d.pointerBorderWidth + d.pointerThickness) - Math.floor(m / 2) + 'px';
          }
        }
        function l() {
        ...
        (this.hide = function () {
          ...
          (this.fromRGB = function (e, t, n, r) {
            ...
            o[0] !== null && (this.hsv[0] = Math.max(0, Math.min(360, o[0]))),
              o[2] !== 0 &&
                (this.hsv[1] =
                  o[1] === null ? null : Math.max(0, this.minS, Math.min(100, this.maxS, o[1]))),
              (this.hsv[2] =
                o[2] === null ? null : Math.max(0, this.minV, Math.min(100, this.maxV, o[2])));
              ...
              n && n.position.toLowerCase() === 'fixed' && (this.fixed = !0),
                t !== this.targetElement &&
                  (t._jscEventsAttached ||
                    (e.attachEvent(t, 'scroll', e.onParentScroll), (t._jscEventsAttached = !0)));
