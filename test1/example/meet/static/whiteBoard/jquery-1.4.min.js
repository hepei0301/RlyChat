      ...
      if (a && typeof a === 'string')
        for (var b = (a || '').split(ca), d = 0, f = this.length; d < f; d++) {
          ...
          if (e.nodeType === 1)
            if (e.className) {
              for (
                var j = ' ' + e.className + ' ', i = e.className, o = 0, k = b.length;
                o < k;
                o++
              )
      ...
      if ((a && typeof a === 'string') || a === w)
        for (var b = (a || '').split(ca), d = 0, f = this.length; d < f; d++) {
          ...
          if (e.nodeType === 1 && e.className)
            if (a) {
              for (
                var j = (' ' + e.className + ' ').replace(Aa, ' '), i = 0, o = b.length;
                i < o;
                i++
              )
                j = j.replace(' ' + b[i] + ' ', ' ');
      ...
      c.ajax({
        ...
        complete: function (i, o) {
          if (o === 'success' || o === 'notmodified')
            j.html(
              e ? c('<div />').append(i.responseText.replace(tb, '')).find(e) : i.responseText
            );
  ...
  c.fx.prototype = {
    ...
    step: function (a) {
      ...
      if (a || b >= this.options.duration + this.startTime) {
        ...
        this.pos = c.easing[
          (this.options.specialEasing && this.options.specialEasing[this.prop]) || a
