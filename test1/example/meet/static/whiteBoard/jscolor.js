  ...
  window.jscolor = (function () {
    var jsc = {
      ...
      hasClass: function (elm, className) {
        ...
        return (
          -1 != (' ' + elm.className.replace(/\s+/g, ' ') + ' ').indexOf(' ' + className + ' ')
        );
      },
      ...
      getPickerDims: function (thisObj) {
        ...
        var dims = [
          2 * thisObj.insetWidth +
            ...
            thisObj.width +
            (displaySlider
              ? 2 * thisObj.insetWidth + jsc.getPadToSliderPadding(thisObj) + thisObj.sliderSize
              : 0),
          2 * thisObj.insetWidth +
            2 * thisObj.padding +
            thisObj.height +
      ...
      jscolor: function (targetElement, options) {
        ...
        this.fromRGB = function (r, g, b, flags) {
          ...
          if (hsv[2] !== 0) {
            this.hsv[1] =
              hsv[1] === null ? null : Math.max(0, this.minS, Math.min(100, this.maxS, hsv[1]));
          }
          this.hsv[2] =
            hsv[2] === null ? null : Math.max(0, this.minV, Math.min(100, this.maxV, hsv[2]));
